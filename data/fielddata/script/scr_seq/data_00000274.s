...
Script_1: @ b6
	...
	If 0x4002, 0x1
	CompareLastResultJump 0x1, Script_branch_108
	If 0x4002, 0x2
	CompareLastResultJump 0x1, Script_branch_112
	If 0x4002, 0x3
...
Script_branch_1ce: @ 1ce
	...
	If 0x4000, 0x1
	CompareLastResultCall 0x1, Script_branch_d36
	If 0x800c, 0x0
	CompareLastResultJump 0x1, Script_branch_26d
...
Script_branch_229: @ 229
	...
	YesNoBox 0x800c
	If 0x800c, 0x0
	CompareLastResultJump 0x1, Script_branch_299
...
Script_branch_2c9: @ 2c9
	AddPeople 0x8002
	If 0x8001, 0x1
	CompareLastResultCall 0x1, Script_branch_32a
	If 0x8001, 0x2
	CompareLastResultCall 0x1, Script_branch_338
	FadeScreen 0x6, 0x1, 0x1, 0x0
	ResetScreen
	SetVar 0x4099, 0x1
	StartAmity
...
Script_branch_41a: @ 41a
	...
	If 0x800c, 0x14
	CompareLastResultJump 0x0, Script_branch_490
	If 0x800c, 0x23
	CompareLastResultJump 0x0, Script_branch_498
	If 0x800c, 0x32
	CompareLastResultJump 0x0, Script_branch_4a0
	If 0x800c, 0x41
	CompareLastResultJump 0x0, Script_branch_4a8
	If 0x800c, 0x48
	CompareLastResultJump 0x0, Script_branch_4b0
	If 0x800c, 0x4f
	CompareLastResultJump 0x0, Script_branch_4b8
	If 0x800c, 0x56
	CompareLastResultJump 0x0, Script_branch_4c0
	If 0x800c, 0x5d
	CompareLastResultJump 0x0, Script_branch_4c8
...
Script_branch_4d8: @ 4d8
	...
	Call Function_3dc
	If 0x8000, 0x0
	CompareLastResultJump 0x1, Script_branch_4fb
...
Script_branch_4fb: @ 4fb
	...
	If 0x800c, 0x0
	CompareLastResultJump 0x1, Script_branch_595
...
Script_branch_56c: @ 56c
	...
	If 0x800c, 0x0
	CompareLastResultJump 0x1, Script_branch_524
...
Script_branch_5dd: @ 5dd
	...
	If 0x800c, 0x0
	CompareLastResultJump 0x1, Script_branch_6ac
	If 0x800c, 0x1
	CompareLastResultJump 0x1, Script_branch_6b7
	If 0x800c, 0x2
	CompareLastResultJump 0x1, Script_branch_6c2
	If 0x800c, 0x3
	CompareLastResultJump 0x1, Script_branch_6cd
	If 0x800c, 0x4
	CompareLastResultJump 0x1, Script_branch_6d8
	If 0x800c, 0x5
	CompareLastResultJump 0x1, Script_branch_6e3
	If 0x800c, 0x6
	CompareLastResultJump 0x1, Script_branch_6ee
	If 0x800c, 0x7
	CompareLastResultJump 0x1, Script_branch_6f9
...
Script_branch_719: @ 719
	CheckIdPlayer 0x800c, 0x9
	If 0x800c, 0x0
	CompareLastResultJump 0x1, Script_branch_78f
	If 0x800c, 0x1
	CompareLastResultJump 0x1, Script_branch_79a
	If 0x800c, 0x2
	CompareLastResultJump 0x1, Script_branch_7a5
	If 0x800c, 0x3
	CompareLastResultJump 0x1, Script_branch_7b0
	If 0x800c, 0x4
	CompareLastResultJump 0x1, Script_branch_7bb
	If 0x800c, 0x5
	CompareLastResultJump 0x1, Script_branch_7c6
	If 0x800c, 0x6
	CompareLastResultJump 0x1, Script_branch_7d1
	If 0x800c, 0x7
	CompareLastResultJump 0x1, Script_branch_7dc
...
Script_branch_80e: @ 80e
	...
	If 0x800c, 0x0
	CompareLastResultCall 0x1, Script_branch_884
	If 0x800c, 0x1
	CompareLastResultCall 0x1, Script_branch_889
	If 0x800c, 0x2
	CompareLastResultCall 0x1, Script_branch_88e
	If 0x800c, 0x3
	CompareLastResultCall 0x1, Script_branch_893
	If 0x800c, 0x4
	CompareLastResultCall 0x1, Script_branch_898
	If 0x800c, 0x5
	CompareLastResultCall 0x1, Script_branch_89d
	If 0x400a, 0x0
	CompareLastResultJump 0x1, Script_branch_8a2
...
Script_branch_c50: @ c50
	CheckPokeEgg 0x400a, 0x800c
	If 0x800c, 0x19
	CompareLastResultJump 0x1, Script_branch_d2e
	If 0x800c, 0x23
	CompareLastResultJump 0x1, Script_branch_d2e
	If 0x800c, 0x36
	CompareLastResultJump 0x1, Script_branch_d2e
...
Script_branch_e48: @ e48
	...
	If 0x8008, 0x19
	CompareLastResultJump 0x1, Script_branch_f5a
	If 0x8008, 0xff
	CompareLastResultJump 0x1, Script_branch_f68
	If 0x8008, 0x23
	CompareLastResultJump 0x1, Script_branch_f76
	If 0x8008, 0x36
	CompareLastResultJump 0x1, Script_branch_f84
	If 0x8008, 0x1a1
	CompareLastResultJump 0x1, Script_branch_f92
	If 0x8008, 0x1a9
	CompareLastResultJump 0x1, Script_branch_fa0
	If 0x8008, 0x1ab
	CompareLastResultJump 0x1, Script_branch_fae
	If 0x8008, 0x1b8
	CompareLastResultJump 0x1, Script_branch_fbc
	If 0x8008, 0x27
	CompareLastResultJump 0x1, Script_branch_fca
	If 0x8008, 0x12c
	CompareLastResultJump 0x1, Script_branch_fd8
	If 0x8008, 0x11d
	CompareLastResultJump 0x1, Script_branch_fe6
	If 0x8008, 0x183
	CompareLastResultJump 0x1, Script_branch_ff4
	If 0x8008, 0x184
	CompareLastResultJump 0x1, Script_branch_1002
	If 0x8008, 0x185
	CompareLastResultJump 0x1, Script_branch_1010
	If 0x8008, 0x186
	CompareLastResultJump 0x1, Script_branch_101e
	If 0x8008, 0x187
	CompareLastResultJump 0x1, Script_branch_102c
	If 0x8008, 0x188
	CompareLastResultJump 0x1, Script_branch_103a
	If 0x8008, 0x189
	CompareLastResultJump 0x1, Script_branch_1048
	If 0x8008, 0x18a
	CompareLastResultJump 0x1, Script_branch_1056
	If 0x8008, 0x18b
	CompareLastResultJump 0x1, Script_branch_1064
...
Script_17: @ 10aa
	...
	FacePlayer
	CheckFlag 0xab5
	CompareLastResultJump 0x1, Script_branch_117c
	Message 0x24
	Cmd_2e1 0x40ab, 0x8004
	Cmd_2e0 0x40ab, 0x800c
	If 0x800c, 0x0
	CompareLastResultJump 0x1, Script_branch_10e1
...
Script_branch_10e1: @ 10e1
	...
	YesNoBox 0x800c
	If 0x800c, 0x1
	CompareLastResultJump 0x1, Script_branch_1161
	SetVar 0x8005, 0x5
	CheckStoreItem 0x8004, 0x8005, 0x800c
	If 0x800c, 0x0
	CompareLastResultJump 0x1, Script_branch_1172
	SetVarHero 0x0
	Cmd_33d 0x1, 0x8004
	Soundfr 0x486
	Message 0x28
...
Script_branch_1305: @ 1305
	...
	PlayFanfare 0x632
	If 0x8003, 0x1
	CompareLastResultCall 0x1, Script_branch_14c2
	If 0x8003, 0x2
	CompareLastResultCall 0x1, Script_branch_14da
	If 0x8003, 0x3
	CompareLastResultCall 0x1, Script_branch_14f2
	If 0x8003, 0x4
	CompareLastResultCall 0x1, Script_branch_150a
	If 0x8003, 0x5
	CompareLastResultCall 0x1, Script_branch_1522
	If 0x8003, 0x6
	CompareLastResultCall 0x1, Script_branch_153a
	If 0x8003, 0x7
	CompareLastResultCall 0x1, Script_branch_1552
	If 0x8003, 0x8
	CompareLastResultCall 0x1, Script_branch_156a
	If 0x8003, 0x9
	CompareLastResultCall 0x1, Script_branch_1582
	If 0x8003, 0xa
	CompareLastResultCall 0x1, Script_branch_159a
	If 0x8003, 0xb
	CompareLastResultCall 0x1, Script_branch_15b2
	If 0x8003, 0xc
	CompareLastResultCall 0x1, Script_branch_15ca
	If 0x8003, 0xd
	CompareLastResultCall 0x1, Script_branch_15e2
	If 0x8003, 0xe
	CompareLastResultCall 0x1, Script_branch_15fa
	If 0x8003, 0xf
	CompareLastResultCall 0x1, Script_branch_1612
	If 0x8003, 0x10
	CompareLastResultCall 0x1, Script_branch_162a
	If 0x8003, 0x11
	CompareLastResultCall 0x1, Script_branch_1642
	If 0x8003, 0x12
	CompareLastResultCall 0x1, Script_branch_165a
	If 0x8003, 0x13
	CompareLastResultCall 0x1, Script_branch_1672
	If 0x8003, 0x14
	CompareLastResultCall 0x1, Script_branch_168a
	If 0x8003, 0x15
	CompareLastResultCall 0x1, Script_branch_16a2
	If 0x8003, 0x16
	CompareLastResultCall 0x1, Script_branch_16ba
	If 0x8003, 0x17
	CompareLastResultCall 0x1, Script_branch_16d2
	If 0x8003, 0x18
	CompareLastResultCall 0x1, Script_branch_16ea
	If 0x8003, 0x19
	CompareLastResultCall 0x1, Script_branch_1702
	If 0x8003, 0x1a
	CompareLastResultCall 0x1, Script_branch_171a
	If 0x8003, 0x1b
	CompareLastResultCall 0x1, Script_branch_1732

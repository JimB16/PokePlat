...
Script_branch_91: @ 91
	Cmd_313 0x0
	If 0x4004, 0x0
	CompareLastResultCall EQUAL, Script_branch_570
	If 0x4004, 0x1
	CompareLastResultCall EQUAL, Script_branch_575
...
Script_branch_b7: @ b7
	...
	If 0x4004, 0x1
	CompareLastResultCall EQUAL, Script_branch_592
	Cmd_42 0x13, 0x2
	Cmd_42 0x14, 0x3
	CloseMulti
	If 0x800c, 0x0
	...
	If 0x800c, 0x1
	CompareLastResultJump EQUAL, Script_branch_160
	If 0x800c, 0x2
...
Script_branch_117: @ 117
	If 0x4004, 0x0
	CompareLastResultCall EQUAL, Script_branch_5a6
	If 0x4004, 0x1
	CompareLastResultCall EQUAL, Script_branch_5ab
	Jump Script_branch_b7
	End
@ 139
...
Script_branch_17c: @ 17c
	...
	CloseMulti
	If 0x800c, 0x0
	CompareLastResultJump EQUAL, Script_branch_1ba
	If 0x800c, 0x1
...
Script_branch_22c: @ 22c
	...
	If 0x8008, 0x1
	CompareLastResultJump EQUAL, Script_branch_2ec
	Jump Script_branch_139
	End
@ 270
...
Script_branch_270: @ 270
	...
	CloseMsgOnKeyPress
	If 0x40b9, 0x0
	CompareLastResultCall EQUAL, Script_branch_2c2
	If 0x40b9, 0x1
	CompareLastResultCall EQUAL, Script_branch_2ce
	If 0x800c, 0x1
	CompareLastResultJump EQUAL, Script_branch_2da
	If 0x800c, 0x3
...
Script_branch_2ec: @ 2ec
	...
	If 0x40b9, 0x1
	CompareLastResultCall EQUAL, Script_branch_34a
	If 0x800c, 0x1
...
Script_branch_38e: @ 38e
	If 0x40b8, 0x0
	CompareLastResultCall EQUAL, Script_branch_42e
	If 0x40b8, 0x1
	CompareLastResultCall EQUAL, Script_branch_449
	If 0x40b8, 0x2
	CompareLastResultCall EQUAL, Script_branch_464
	PlayFanfare 0x603
...
Script_branch_3c1: @ 3c1
	...
	ResetScreen
	If 0x40b8, 0x0
	CompareLastResultCall EQUAL, Script_branch_48a
	If 0x40b8, 0x1
	CompareLastResultCall EQUAL, Script_branch_49e
	If 0x40b8, 0x2
	CompareLastResultCall EQUAL, Script_branch_4b2
	RandomEvent 0x3a
	DeActivateLeader 0x25, 0x0, 0x0, 0x0, 0x0
	PreWfc
	ShowBTowerSome 0x3
	If 0x40b8, 0x2
	CompareLastResultCall EQUAL, Script_branch_42a
	CallEnd
...
Script_4: @ 5fa
	...
	CompareLastResultCall EQUAL, Script_branch_636
	If 0x4050, 0x1
	CompareLastResultCall EQUAL, Script_branch_63c
	If 0x4050, 0x3
	CompareLastResultCall EQUAL, Script_branch_653
	Jump Script_branch_139
	End
@ 636

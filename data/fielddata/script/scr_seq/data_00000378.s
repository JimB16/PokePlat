...
Script_branch_91: @ 91
	Cmd_313 0x0
	If 0x4004, 0x0
	CompareLastResultCall EQUAL, Script_branch_664
	If 0x4004, 0x1
	CompareLastResultCall EQUAL, Script_branch_669
...
Script_branch_b7: @ b7
	...
	If 0x4004, 0x1
	CompareLastResultCall EQUAL, Script_branch_686
	Cmd_42 0x29, 0x2
	Cmd_42 0x2a, 0x3
	CloseMulti
	If 0x800c, 0x0
...
Script_branch_117: @ 117
	...
	If 0x4004, 0x1
	CompareLastResultCall EQUAL, Script_branch_69f
	Jump Script_branch_b7
@ 137
...
Script_branch_1ff: @ 1ff
	...
	If 0x800c, 0xff
	CompareLastResultJump EQUAL, Script_branch_5d5
...
Script_branch_297: @ 297
	If 0x40bd, 0x0
	CompareLastResultCall EQUAL, Script_branch_43c
	If 0x40bd, 0x1
	CompareLastResultCall EQUAL, Script_branch_43c
	SetVar 0x4000, 0x0
	HealPokemon
	...
	CompareLastResultJump EQUAL, Script_branch_139
	If 0x40bd, 0x2
	CompareLastResultJump EQUAL, Script_branch_2e5
...
Script_branch_329: @ 329
	...
	If 0x800c, 0x1
	CompareLastResultJump EQUAL, Script_branch_36b
	If 0x800c, 0x3
...
Script_branch_37d: @ 37d
	...
	If 0x800c, 0x3
	CompareLastResultJump EQUAL, Script_branch_3c7
	Jump Script_branch_3d1
@ 3bd
...
Script_branch_3d1: @ 3d1
	...
	If 0x8008, 0x2
	CompareLastResultJump EQUAL, Script_branch_45a
	If 0x8008, 0x3
...
Script_branch_49d: @ 49d
	If 0x40bd, 0x0
	CompareLastResultCall EQUAL, Script_branch_53d
	If 0x40bd, 0x1
	CompareLastResultCall EQUAL, Script_branch_558
	If 0x40bd, 0x2
	CompareLastResultCall EQUAL, Script_branch_573
	PlayFanfare 0x603
...
Script_branch_4d0: @ 4d0
	...
	ResetScreen
	If 0x40bd, 0x0
	CompareLastResultCall EQUAL, Script_branch_599
	If 0x40bd, 0x1
	CompareLastResultCall EQUAL, Script_branch_5ad
	If 0x40bd, 0x2
	CompareLastResultCall EQUAL, Script_branch_5c1
	RandomEvent 0x3a
	DeActivateLeader 0x26, 0x0, 0x0, 0x0, 0x0
	PreWfc
	ShowBTowerSome 0xb
	If 0x40bd, 0x2
	CompareLastResultCall EQUAL, Script_branch_539
	CallEnd
	FadeScreen 0x6, 0x1, 0x1, 0x0
	ResetScreen
	Cmd_313 0x1
...
Script_4: @ 6ec
	If 0x40bd, 0x0
	CompareLastResultCall EQUAL, Script_branch_728
	If 0x40bd, 0x1
	CompareLastResultCall EQUAL, Script_branch_728
	If 0x4052, 0x1
	CompareLastResultCall EQUAL, Script_branch_72e
	If 0x4052, 0x3
	CompareLastResultCall EQUAL, Script_branch_745
	Jump Script_branch_139
@ 726

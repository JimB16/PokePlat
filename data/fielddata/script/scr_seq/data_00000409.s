...
Script_branch_e8: @ e8
	Return2 0x1, 0x800c
	If 0x8005, 0x0
	CompareLastResultJump 0x1, Script_branch_e8
	Jump Script_branch_66d
@ 101
...
Script_branch_14a: @ 14a
	...
	Call Function_17f
	If 0x800c, 0x0
	CompareLastResultJump 0x1, Script_branch_221
	SetVar 0x40cd, 0x1
	Return
@ 17f
...
Script_2: @ 223
	...
	CopyVar 0x8004, 0x800c
	If 0x800c, 0x6
	CompareLastResultJump 0x1, Script_branch_275
	...
	YesNoBox 0x800c
	If 0x800c, 0x0
	CompareLastResultJump 0x1, Script_branch_284
	CloseMsgOnKeyPress
	Jump Script_branch_66d
@ 273
...
Script_branch_2b2: @ 2b2
	Return2 0x1, 0x800c
	If 0x8005, 0x0
	CompareLastResultJump 0x1, Script_branch_2b2
	Jump Script_branch_66d
@ 2cb
...
Script_3: @ 314
	...
	If 0x800c, 0x1
	CompareLastResultJump 0x1, Script_branch_3bd
	CheckPlaceStored 0x800c, 0x46
	If 0x800c, 0x6
	CompareLastResultJump 0x1, Script_branch_372
...
Script_4: @ 40e
	...
	If 0x800c, 0x6
	CompareLastResultJump 0x1, Script_branch_469
	CheckBadge 0x6, 0x800c
	If 0x800c, 0x0
	CompareLastResultJump 0x1, Script_branch_469
	CheckFollow 0x800c
	If 0x800c, 0x1
	CompareLastResultJump 0x1, Script_branch_478
	Message 0x12
	YesNoBox 0x800c
	If 0x800c, 0x0
	CompareLastResultJump 0x1, Script_branch_487
	CloseMsgOnKeyPress
...
Script_5: @ 4dd
	...
	CheckFollow 0x800c
	If 0x800c, 0x1
	CompareLastResultJump 0x1, Script_branch_512
	Message 0xc
	YesNoBox 0x800c
	If 0x800c, 0x0
	CompareLastResultJump 0x1, Script_branch_51f
	CloseMsgOnKeyPress
	Jump Script_branch_671
@ 510
...
Script_6: @ 57d
	...
	If 0x800c, 0x6
	CompareLastResultJump 0x1, Script_branch_5b4
	Message 0xf
	YesNoBox 0x800c
	If 0x800c, 0x0
	CompareLastResultJump 0x1, Script_branch_5c3
	CloseMsgOnKeyPress
	Jump Script_branch_671
@ 5b2
...
Script_branch_5c3: @ 5c3
	...
	CheckEffectHm 0x8004
	If 0x8004, 0x169
	CompareLastResultCall 0x1, Script_branch_606
	Jump Script_branch_671
@ 604
...
Script_7: @ 679
	...
	If 0x800c, 0x6
	CompareLastResultJump 0x1, Script_branch_6c3
	...
	YesNoBox 0x800c
	If 0x800c, 0x0
	CompareLastResultJump 0x1, Script_branch_6d2
	CloseMsgOnKeyPress
	Jump Script_branch_671
@ 6c1

...
Script_branch_16f: @ 16f
	...
	YesNoBox 0x800c
	If 0x800c, 0x0
	CompareLastResultJump 0x1, Script_branch_298
	If 0x800c, 0x1
...
Script_branch_2b3: @ 2b3
	...
	YesNoBox 0x800c
	If 0x800c, 0x0
	CompareLastResultJump 0x1, Script_branch_30b
	If 0x800c, 0x1
	CompareLastResultJump 0x1, Script_branch_2fd
	End
@ 2fd
...
Script_branch_30b: @ 30b
	...
	CheckGender 0x800c
	If 0x800c, 0x0
	CompareLastResultJump 0x1, Script_branch_36e
...
Script_branch_554: @ 554
	...
	If 0x800c, 0x1
	CompareLastResultJump 0x1, Script_branch_656
	End
@ 57a
...
Script_branch_57a: @ 57a
	...
	StoreStarter 0x800c
	If 0x800c, 0x183
	CompareLastResultJump 0x1, Script_branch_5bb
	If 0x800c, 0x186
...
Script_branch_5c5: @ 5c5
	...
	If 0x800c, 0x0
	CompareLastResultJump 0x1, Script_branch_5f5
	Lock 0x2
	SetVariableRival 0x0
	SetVarHero 0x1
	Message 0x30
...
.incbin "./baserom/data/fielddata/script/scr_seq_narc/data_00000427.bin", 0x714, 0x71c - 0x714
...
.incbin "./baserom/data/fielddata/script/scr_seq_narc/data_00000427.bin", 0x79c, 0x7a8 - 0x79c
...
Script_14: @ 8e8
	...
	If 0x800c, 0x3
	CompareLastResultJump 0x1, Script_branch_903
...
.incbin "./baserom/data/fielddata/script/scr_seq_narc/data_00000427.bin", 0x995, 0x998 - 0x995
...
Script_3: @ 9e0
	...
	CheckSpritePosition 0x8004, 0x8005
	If 0x8004, 0x6e
	CompareLastResultJump 0x1, Script_branch_a3b
	If 0x8004, 0x6f
	CompareLastResultJump 0x1, Script_branch_a3b
	If 0x8004, 0x70
	CompareLastResultJump 0x1, Script_branch_a3b
...
.incbin "./baserom/data/fielddata/script/scr_seq_narc/data_00000427.bin", 0xa65, 0xa68 - 0xa65
...
Script_4: @ a8c
	...
	CheckFacePosition 0x800c
	If 0x800c, 0x3
	CompareLastResultJump 0x1, Script_branch_ab9
...
.incbin "./baserom/data/fielddata/script/scr_seq_narc/data_00000427.bin", 0xae1, 0xae4 - 0xae1
...
.incbin "./baserom/data/fielddata/script/scr_seq_narc/data_00000427.bin", 0xafc, 0xb24 - 0xafc
...
Script_5: @ b24
	...
	CheckSpritePosition 0x8004, 0x8005
	If 0x8005, 0x355
	CompareLastResultJump 0x1, Script_branch_b55
	If 0x8005, 0x356
	CompareLastResultJump 0x1, Script_branch_b89
	If 0x8005, 0x357
	CompareLastResultJump 0x1, Script_branch_bbb
	End
@ b55
...
Script_branch_bf5: @ bf5
	...
	WaitMovement
	If 0x8005, 0x355
	CompareLastResultJump 0x1, Script_branch_c3e
	If 0x8005, 0x356
	CompareLastResultJump 0x1, Script_branch_c56
	If 0x8005, 0x357
	CompareLastResultJump 0x1, Script_branch_c6e
	If 0x8005, 0x358
	CompareLastResultJump 0x1, Script_branch_c6e
	End
@ c3e
...
Script_branch_c86: @ c86
	CheckGender 0x800c
	If 0x800c, 0x0
	CompareLastResultJump 0x1, Script_branch_c9d
...
.incbin "./baserom/data/fielddata/script/scr_seq_narc/data_00000427.bin", 0xd46, 0xd48 - 0xd46
...
.incbin "./baserom/data/fielddata/script/scr_seq_narc/data_00000427.bin", 0xd8c, 0xd94 - 0xd8c
...
Script_12: @ e1a
	...
	FacePlayer
	CheckFlag 0x90
	CompareLastResultJump 0x1, Script_branch_e3e
	Message 0x3a
...
Script_10: @ e47
	...
	FacePlayer
	CheckFlag 0x6c
	CompareLastResultJump 0x1, Script_branch_e8c
	Message 0x37
	SetVar 0x8004, 0x11
	SetVar 0x8005, 0x1
...
Script_16: @ eb4
	...
	CheckSpritePosition 0x8004, 0x8005
	If 0x8004, 0x6e
	CompareLastResultJump 0x1, Script_branch_f07
	If 0x8004, 0x6f
	CompareLastResultJump 0x1, Script_branch_f19
	If 0x8004, 0x70
	CompareLastResultJump 0x1, Script_branch_f2b
	If 0x8004, 0x71
	CompareLastResultJump 0x1, Script_branch_f3d
	End
@ f07
...
.incbin "./baserom/data/fielddata/script/scr_seq_narc/data_00000427.bin", 0xfb9, 0xfbc - 0xfb9

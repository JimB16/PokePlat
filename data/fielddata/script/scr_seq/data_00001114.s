...
Script_branch_f40: @ f40
	Cmd_9b 0x8004, 0x800c
	If 0x800c, 0x0
...
Script_branch_f5b: @ f5b
	Cmd_33
	TrainerBattleStored 0x8000, 0x8001, 0x8002
	EndtrainerBattle 0x8004, 0x8001
	WaitButton
	CloseMsgOnKeyPress
	ReleaseAll
	End
...
Script_branch_fa3: @ fa3
	StoreLeagueTrainer 0x8004
	Cmd_33
	TrainerBattleStored2 0x8000, 0x8001, 0x8002
	EndtrainerBattle 0x8004, 0x8000
...
Script_branch_fcb: @ fcb
	StartBattleAnalysis 0x8004
	Cmd_33
	TrainerBattleStored 0x8000, 0x8001, 0x8002
	EndtrainerBattle 0x8004, 0x8002
	Cmd_30
	CloseMsgOnKeyPress
	ReleaseAll
	End
...
Script_branch_fe7: @ fe7
	ApplyMovement 0x800d, Movement_104c
	WaitMovement
...
Script_branch_102b: @ 102b
	FollowHero 0x800d, 0xf
	Return
@ 1033

Script_branch_1033: @ 1033
	FollowHero 0x800d, 0xe
	Return
@ 103b

Script_branch_103b: @ 103b
	FollowHero 0x800d, 0x11
	Return
@ 1043

Script_branch_1043: @ 1043
	FollowHero 0x800d, 0x10
	Return
@ 104b
...
Script_branch_10f3: @ 10f3
	...
	CopyVar 0x8004, 0x800c
	Cmd_33
	EndtrainerBattle 0x8004, 0x3
	CloseMsgOnKeyPress
	SetVarBattle2 0x1, 0x800c
	CopyVar 0x8005, 0x800c
	Cmd_33
	EndtrainerBattle 0x8005, 0x7
	CloseMsgOnKeyPress
...
Script_branch_11a0: @ 11a0
	...
	SetVarBattle2 0x1, 0x800c
	CopyVar 0x8005, 0x800c
	StoreLeagueTrainer 0x8005
	BattleId 0x1
	Call Function_1250
	SetVarBattle2 0x1, 0x800c
	CopyVar 0x8005, 0x800c
	Cmd_33
	EndtrainerBattle 0x8005, 0x0
	CloseMsgOnKeyPress
	TrainerBattle 0x8004, 0x8005
	CheckTrainerLost 0x800c
	If 0x800c, 0x0

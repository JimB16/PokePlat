...
ScriptCmd_CallStandard: @ 203f99c :thumb
	...
	str     r0, [r7, #0x0]
	ldrb    r0, [r4, #0x0]
	ldr     r1, [pc, #0xc] @ 0x203f9e8, (=Function_203f9ec+1)
	.hword  0x1c40 @ add r0, r0, #0x1
	strb    r0, [r4, #0x0]
	ldr     r0, [sp, #0x0]
	bl      ScriptHandler_AddFunction
...
.word Function_203f9ec+1 @ 0x203f9e8
...
ScriptCmd_Message: @ 203ffe8 :thumb
	...
	ldr     r1, [pc, #0xc] @ 0x2040010, (=MessageLoop+1)
	mov     r0, r4
	bl      ScriptHandler_AddFunction
...
ScriptCmd_WaitButton: @ 20401f4 :thumb
	push    {r3,lr}
	ldr     r1, [pc, #0x8] @ 0x2040200, (=WaitButton+1)
	bl      ScriptHandler_AddFunction
	mov     r0, #0x1
	pop     {r3,pc}
@ 0x2040200

.word WaitButton+1 @ 0x2040200
...
WaitButton: @ 2040204 :thumb
	push    {r4,lr}
	ldr     r1, [pc, #0x78] @ 0x2040280, (=RAM_21bf67c)
	ldr     r2, [r1, #0x48]
	mov     r1, #0x3
	mov     r3, r2
	tst     r3, r1
...
Function_2040294: @ 2040294 :thumb
	ldr     r0, [pc, #0x18] @ 0x20402b0, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_20402a2
...
.thumb
Function_20402fc: @ 20402fc :thumb
	push    {r3-r5,lr}
	add     r0, #0x80
	ldr     r4, [r0, #0x0]
	mov     r1, #0x1
...
.align 2, 0
.thumb
Function_204032c: @ 204032c :thumb
	push    {r3-r5,lr}
	add     r0, #0x80
	ldr     r4, [r0, #0x0]
	mov     r1, #0x1
...
.align 2, 0
.thumb
Function_20404a4: @ 20404a4 :thumb
	push    {r4-r7,lr}
	add     sp, #-0x1c
	mov     r5, r0
	add     r0, #0x80
...
.align 2, 0
.thumb
Function_2040554: @ 2040554 :thumb
	push    {r3-r5,lr}
	mov     r1, r0
	add     r1, #0x80
	ldr     r2, [r0, #0x8]
...
.align 2, 0
.thumb
Function_2040580: @ 2040580 :thumb
	push    {r3,lr}
	mov     r1, r0
	add     r1, #0x80
	ldr     r2, [r0, #0x8]
...
.align 2, 0
.thumb
Function_204059c: @ 204059c :thumb
	push    {r4,lr}
	mov     r4, r0
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
...
.thumb
Function_20405dc: @ 20405dc :thumb
	push    {r3-r7,lr}
	add     sp, #-0x10
	mov     r5, r0
	add     r0, #0x80
...
.thumb
Function_2040714: @ 2040714 :thumb
	push    {r4,lr}
	mov     r4, r0
...
.thumb
Function_20407b4: @ 20407b4 :thumb
	push    {r3,lr}
...
.align 2, 0
.thumb
Function_20408b0: @ 20408b0 :thumb
	push    {r4-r7,lr}
	add     sp, #-0x2c
	mov     r5, r0
	add     r0, #0x80
...
.align 2, 0
.thumb
Function_2040938: @ 2040938 :thumb
	push    {r4-r7,lr}
	add     sp, #-0x2c
	mov     r5, r0
	add     r0, #0x80
...
.align 2, 0
.thumb
Function_2040a2c: @ 2040a2c :thumb
	push    {r4,lr}
	mov     r4, r0
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
...
.thumb
Function_2040ae8: @ 2040ae8 :thumb
	push    {r4-r7,lr}
	add     sp, #-0x2c
	mov     r5, r0
	add     r0, #0x80
...
.align 2, 0
.thumb
Function_2040b70: @ 2040b70 :thumb
	push    {r4-r7,lr}
	add     sp, #-0x2c
	mov     r5, r0
	add     r0, #0x80
...
.align 2, 0
.thumb
Function_2040bf8: @ 2040bf8 :thumb
	push    {r3-r7,lr}
	mov     r5, r0
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
...
.thumb
Function_2040c58: @ 2040c58 :thumb
	push    {r4,lr}
	mov     r4, r0
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
...
.thumb
Function_2040d08: @ 2040d08 :thumb
	push    {r4,lr}
	mov     r4, r0
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
...
.align 2, 0
.thumb
Function_2040dd8: @ 2040dd8 :thumb
	push    {r3-r7,lr}
	add     sp, #-0x8
	mov     r5, r0
	bl      ScriptHandler_LoadHWord
...
.thumb
Function_2040ed4: @ 2040ed4 :thumb
	push    {r3,lr}
	cmp     r1, #0xf2
	bne     branch_2040ee4
	ldr     r0, [r0, #0x38]
...
.align 2, 0
.thumb
Function_2040f28: @ 2040f28 :thumb
	push    {r3-r7,lr}
	mov     r5, r0
	mov     r6, r1
	mov     r0, #0x4
...
branch_2040f42: @ 2040f42 :thumb
	str     r5, [r4, #0xc]
	str     r6, [r4, #0x4]
	ldr     r0, [pc, #0x10] @ 0x2040f58, (=Function_2040f5c+1)
	mov     r1, r4
	mov     r2, #0x0
	str     r7, [r4, #0x8]
	bl      Function_200d9e8
...
.align 2
.word Function_2040f5c+1 @ 0x2040f58



.thumb
Function_2040f5c: @ 2040f5c :thumb
	push    {r3-r5,lr}
	mov     r5, r1
	ldr     r0, [r5, #0xc]
	mov     r1, #0x4
...
.align 2, 0
.thumb
Function_2041d78: @ 2041d78 :thumb
	push    {r3,lr}
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
	ldr     r0, [r0, #0x10]
...
.align 2, 0
.thumb
Function_2041e28: @ 2041e28 :thumb
	push    {r3,lr}
	ldr     r0, [r0, #0x74]
	bl      Function_207ddc0
	mov     r0, #0x1
...
.thumb
Function_20420a0: @ 20420a0 :thumb
	push    {r3,lr}
	ldr     r0, [r0, #0x74]
	bl      Function_209acf4
	mov     r0, #0x1
...
.thumb
Function_20420cc: @ 20420cc :thumb
	push    {r3-r6,lr}
	add     sp, #-0x4
	mov     r5, r0
	bl      ScriptHandler_LoadHWord
...
.align 2, 0
.thumb
Function_2042124: @ 2042124 :thumb
	push    {r3-r7,lr}
	mov     r5, r0
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
...
.thumb
Function_204218c: @ 204218c :thumb
	push    {r3-r7,lr}
	mov     r5, r0
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
...
.thumb
Function_20422d4: @ 20422d4 :thumb
	push    {r3,lr}
	mov     r1, r0
	ldr     r0, [r1, #0x74]
	add     r1, #0x80
...
.thumb
Function_20422e8: @ 20422e8 :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
...
.thumb
Function_2042434: @ 2042434 :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
...
.thumb
Function_2042480: @ 2042480 :thumb
	push    {r4,lr}
	mov     r4, r0
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
...
.thumb
Function_204249c: @ 204249c :thumb
	push    {r3,lr}
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
	bl      Function_2072204
...
.thumb
Function_20424ac: @ 20424ac :thumb
	push    {r3,lr}
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
	ldr     r0, [r0, #0x10]
...
.thumb
Function_20424bc: @ 20424bc :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
...
.thumb
Function_20424e8: @ 20424e8 :thumb
	push    {r3,lr}
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
	ldr     r0, [r0, #0x10]
...
.thumb
Function_20424f8: @ 20424f8 :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
...
.thumb
Function_2042560: @ 2042560 :thumb
	push    {r4-r6,lr}
	mov     r5, r0
	bl      ScriptHandler_LoadHWord
	mov     r1, r0
...
.thumb
Function_20425c0: @ 20425c0 :thumb
	push    {r4,lr}
	mov     r4, r0
	bl      ScriptHandler_LoadHWord
	mov     r1, r0
...
.thumb
Function_20425e0: @ 20425e0 :thumb
	push    {r4-r6,lr}
	mov     r5, r0
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
	...
	ldr     r1, [r4, #0x0]
	bl      Function_203e0c0
	ldr     r1, [pc, #0xc] @ 0x2042624, (=Function_2041d60+1)
	mov     r0, r5
	bl      ScriptHandler_AddFunction
	mov     r0, #0x1
	pop     {r4-r6,pc}
...
.align 2
.word Function_2041d60+1 @ 0x2042624



.thumb
Function_2042628: @ 2042628 :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
...
.align 2, 0
.thumb
Function_2042984: @ 2042984 :thumb
	push    {r3-r7,lr}
	add     sp, #-0x8
	mov     r5, r0
	bl      ScriptHandler_LoadHWord
...
.align 2, 0
.thumb
Function_20431f0: @ 20431f0 :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
...
.align 2, 0
.thumb
Function_2043220: @ 2043220 :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
...
.thumb
Function_20432dc: @ 20432dc :thumb
	push    {r3-r6,lr}
	add     sp, #-0x4
	mov     r5, r0
	add     r0, #0x80
...
.thumb
Function_204342c: @ 204342c :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
...
.thumb
Function_2043460: @ 2043460 :thumb
	push    {r3,lr}
	ldr     r0, [r0, #0x74]
	bl      Function_2051590
	mov     r0, #0x1
...
.thumb
Function_20434a4: @ 20434a4 :thumb
	push    {r4,lr}
	mov     r4, r0
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
...
.thumb
Function_20434c0: @ 20434c0 :thumb
	push    {r3,lr}
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
	bl      0x21efc90
...
.align 2, 0
.thumb
Function_2043bd4: @ 2043bd4 :thumb
	push    {r3,lr}
	ldr     r0, [r0, #0x74]
	bl      Function_2052c5c
	mov     r0, #0x1
...
.thumb
Function_2043be0: @ 2043be0 :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	bl      ScriptHandler_LoadHWord
	mov     r1, r0
...
.thumb
Function_20442b4: @ 20442b4 :thumb
	push    {r3-r5,lr}
	mov     r4, r0
	mov     r1, r4
	add     r1, #0x80
...
.thumb
Function_20442e8: @ 20442e8 :thumb
	push    {r3-r5,lr}
	mov     r4, r0
	mov     r1, r4
	add     r1, #0x80
...
.align 2, 0
.thumb
Function_2044db4: @ 2044db4 :thumb
	push    {r3,lr}
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
	ldr     r0, [r0, #0xc]
...
Function_20456e8: @ 20456e8 :thumb
	...
	ldr     r0, [r4, #0x0]
	bl      ScriptHandler_CheckLoadParameter
	ldr     r1, [pc, #0x8] @ 0x2045704, (=RAM_21bf6dc)
	ldrb    r1, [r1, #0x6]
	strh    r1, [r0, #0x0]
	mov     r0, #0x1
	pop     {r4,pc}
...
.thumb
Function_2046ad4: @ 2046ad4 :thumb
	push    {r4-r7,lr}
	add     sp, #-0x84
	mov     r7, r0
	bl      ScriptHandler_LoadHWord
...
.thumb
Function_2046b9c: @ 2046b9c :thumb
	push    {r3,r4,lr}
	add     sp, #-0x4
	mov     r4, r0
	bl      ScriptHandler_LoadHWord
...
.thumb
Function_2046bf4: @ 2046bf4 :thumb
	push    {r3,r4,lr}
	add     sp, #-0x4
	mov     r4, r0
	bl      ScriptHandler_LoadHWord
...
.thumb
Function_2046c34: @ 2046c34 :thumb
	push    {r3,r4,lr}
	add     sp, #-0x4
	mov     r4, r0
	bl      ScriptHandler_LoadHWord
...
.thumb
Function_20482fc: @ 20482fc :thumb
	push    {r3,lr}
	bl      ScriptHandler_LoadHWord
	bl      Function_200549c
	mov     r0, #0x0
...
.thumb
Function_204830c: @ 204830c :thumb
	push    {r3,lr}
	bl      ScriptHandler_LoadHWord
	bl      Function_20041fc
	mov     r1, #0x0
...
.thumb
Function_2048320: @ 2048320 :thumb
	push    {r3,lr}
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
	ldr     r1, [r0, #0x1c]
...
.thumb
Function_2048350: @ 2048350 :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	bl      ScriptHandler_LoadHWord
	mov     r4, r0
...
.align 2, 0
.thumb
Function_204838c: @ 204838c :thumb
	push    {r4,lr}
	mov     r4, r0
	bl      ScriptHandler_LoadHWord
	mov     r1, r0
...
.thumb
Function_20483cc: @ 20483cc :thumb
	push    {r3,lr}
	bl      ScriptHandler_LoadHWord
	mov     r1, r0
	mov     r0, #0x4
...
.thumb
Function_20483f4: @ 20483f4 :thumb
	push    {r4,lr}
	mov     r4, r0
	bl      ScriptHandler_LoadHWord
	add     r4, #0x80
...
.thumb
Function_2048410: @ 2048410 :thumb
	push    {r4,lr}
	mov     r4, r0
	bl      ScriptHandler_LoadHWord
	add     r4, #0x80
...
.thumb
Function_204842c: @ 204842c :thumb
	push    {r4,lr}
	mov     r4, r0
	bl      ScriptHandler_LoadHWord
	mov     r1, r0
...
.thumb
Function_204846c: @ 204846c :thumb
	push    {r3-r5,lr}
	mov     r4, r0
	bl      ScriptHandler_LoadHWord
	mov     r1, r0
...
.align 2, 0
.thumb
Function_20484a0: @ 20484a0 :thumb
	push    {r3,lr}
...
.align 2, 0
.thumb
Function_20484c4: @ 20484c4 :thumb
	push    {r3,lr}
	bl      ScriptHandler_LoadHWord
	bl      Function_2006150
	mov     r0, #0x0
...
.align 2, 0
.thumb
Function_20484f8: @ 20484f8 :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	bl      ScriptHandler_LoadHWord
	mov     r1, r0
...
.thumb
Function_2048530: @ 2048530 :thumb
	push    {r4,lr}
	mov     r4, r0
	bl      ScriptHandler_LoadHWord
	add     r4, #0x80
...
.thumb
Function_204855c: @ 204855c :thumb
	push    {r3,lr}
	bl      Function_20063b8
	mov     r0, #0x1
	pop     {r3,pc}
...
.thumb
Function_2048568: @ 2048568 :thumb
	push    {r3,lr}
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
	ldr     r0, [r0, #0xc]
...
.word MI_CpuCopy8 @ =0x20c4db0, 0x204b0d0
...
branch_204bd72: @ 204bd72 :thumb
	...
	ldr     r1, [pc, #0x50] @ 0x204bde8, (=NrOfPkmn)
	cmp     r0, r1
	bne     branch_204bdba
...
.thumb
Function_204c6c8: @ 204c6c8 :thumb
	push    {r3-r7,lr}
	mov     r4, r0
	mov     r1, r4
	add     r1, #0x80
...
.thumb
Function_204c718: @ 204c718 :thumb
	push    {r3,lr}
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
	mov     r1, #0x26
...
.thumb
Function_204c730: @ 204c730 :thumb
	push    {r4,lr}
	mov     r4, r0
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
...
.thumb
Function_204c750: @ 204c750 :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
...
.thumb
Function_204c780: @ 204c780 :thumb
	push    {r3-r5,lr}
	mov     r4, r0
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
...
.thumb
Function_204c7ac: @ 204c7ac :thumb
	push    {r3-r5,lr}
	mov     r4, r0
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
...
.thumb
ScriptCmd_CheckPokemonPoisoned: @ 204d398 :thumb
	push    {r4-r6,lr}
	mov     r5, r0
...
.thumb
Function_204e3fc: @ 204e3fc :thumb
	push    {r3,lr}
	add     r0, #0x80
	ldr     r0, [r0, #0x0]
	ldr     r0, [r0, #0xc]
...
.thumb
Function_204e900: @ 204e900 :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	bl      ScriptHandler_LoadHWord
	mov     r1, r0
...
.thumb
Function_204e934: @ 204e934 :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	bl      ScriptHandler_LoadHWord
	mov     r1, r0
...
.thumb
Function_204e974: @ 204e974 :thumb
	push    {r4-r6,lr}
	mov     r4, r0
	mov     r1, r4
	add     r1, #0x80
...
.thumb
Function_204ea04: @ 204ea04 :thumb
	push    {r4-r6,lr}
	mov     r4, r0
	mov     r1, r4
	add     r1, #0x80
...
.thumb
Function_204ea94: @ 204ea94 :thumb
	push    {r4-r6,lr}
	mov     r4, r0
	mov     r1, r4
	add     r1, #0x80
...
.thumb
Function_204ec98: @ 204ec98 :thumb
	push    {r3-r7,lr}
	mov     r4, r0
	mov     r1, r4
	add     r1, #0x80

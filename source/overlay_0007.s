...
branch_2249ac4: @ 2249ac4 :thumb
	...
	add     r0, #0x97
	strb    r2, [r0, #0x0]
	ldr     r2, [pc, #0xa0] @ 0x2249b94, (=0x161) PlMsg_Narc_353
	mov     r0, #0x1
	bl      LoadFromNARC_9
...
branch_224a2b4: @ 224a2b4 :thumb
	...
	mov     r1, #0x0
	bl      Function_2249960
	ldr     r0, [pc, #0x74] @ 0x224a344, (=Function_224ab64+1)
	bl      Function_224a530
	b       branch_224a33e
...
.align 2
.word Function_224ab64+1 @ 0x224a344
...
Function_224a34c: @ 224a34c :thumb
	...
	ldr     r0, [pc, #0x1c] @ 0x224a38c, (=RAM_21bf67c)
	...
	mov     r1, #0x0
	bl      Function_2249960
	ldr     r0, [pc, #0xc] @ 0x224a390, (=Function_224a394+1)
	bl      Function_224a530
...
.word RAM_21bf67c @ 0x224a38c
.word Function_224a394+1 @ 0x224a390
...
Function_224a528: @ 224a528 :thumb
	ldr     r3, [pc, #0x0] @ 0x224a52c, (=Function_205987c+1)
	bx      r3
@ 0x224a52c

.word Function_205987c+1 @ 0x224a52c
...
branch_224aa52: @ 224aa52 :thumb
	...
	mov     r1, #0x0
	bl      Function_2249960
	ldr     r0, [pc, #0xe0] @ 0x224ab58, (=Function_224ab64+1)
	bl      Function_224a530
	add     r4, #0x95
	ldrb    r1, [r4, #0x0]
	mov     r0, #0x4
...
.word Function_224ab64+1 @ 0x224ab58
...
Function_224ab64: @ 224ab64 :thumb
	...
	ldr     r0, [pc, #0x24] @ 0x224aba0, (=RAM_21bf67c)
	ldr     r1, [r0, #RAM_21bf67c_48_KeyNewPressed2]
	mov     r0, #KEY_A|KEY_B
	tst     r0, r1
	beq     branch_224ab9a
...
Function_224aba4: @ 224aba4 :thumb
	...
	ldr     r0, [pc, #0x18] @ 0x224abd8, (=RAM_21bf67c)
	ldr     r1, [r0, #RAM_21bf67c_48_KeyNewPressed2]
	mov     r0, #KEY_A|KEY_B
	tst     r0, r1
	beq     branch_224abd0
...
Function_224add8: @ 224add8 :thumb
	...
	cmp     r0, #0x0
	beq     branch_224ae06
	ldr     r0, [pc, #0x1c] @ 0x224ae0c, (=RAM_21bf67c)
	ldr     r1, [r0, #RAM_21bf67c_48_KeyNewPressed2]
	mov     r0, #KEY_A|KEY_B
	tst     r0, r1
	beq     branch_224ae06
...
Function_224b2a0: @ 224b2a0 :thumb
	...
	cmp     r0, #0x0
	beq     branch_224b2d2
	ldr     r0, [pc, #0x20] @ 0x224b2d8, (=RAM_21bf67c)
	ldr     r1, [r0, #RAM_21bf67c_48_KeyNewPressed2]
	mov     r0, #KEY_A|KEY_B
	tst     r0, r1
	beq     branch_224b2d2
...
Function_224b370: @ 224b370 :thumb
	...
	ldr     r0, [pc, #0x1c] @ 0x224b3a4, (=RAM_21bf67c)
	ldr     r1, [r0, #RAM_21bf67c_48_KeyNewPressed2]
	mov     r0, #KEY_A|KEY_B
	tst     r0, r1
	beq     branch_224b39c
...
Function_224b3d4: @ 224b3d4 :thumb
	...
	ldr     r3, [pc, #0xc] @ 0x224b3e4, (=Function_2036158+1)
	ldr     r0, [r0, #0x0]
	add     r0, #0x91
	ldrb    r0, [r0, #0x0]
	bx      r3
...
.word Function_2036158+1 @ 0x224b3e4
...
Function_224b3e8: @ 224b3e8 :thumb
	...
	ldr     r3, [pc, #0xc] @ 0x224b3f8, (=Function_2036148+1)
	ldr     r0, [r0, #0x0]
	add     r0, #0x91
	ldrb    r0, [r0, #0x0]
	bx      r3
...
.word Function_2036148+1 @ 0x224b3f8
...
.thumb
.globl Function_7_224b414
Function_7_224b414: @ 224b414 :thumb
	push    {r3-r7,lr}
	mov     r5, r0
	mov     r4, r1
	mov     r6, r2
...
.thumb
.globl Function_7_224b460
Function_7_224b460: @ 224b460 :thumb
	push    {r4,lr}
...
.thumb
.globl Function_7_224b47c
Function_7_224b47c: @ 224b47c :thumb
	push    {r3-r7,lr}
	mov     r5, r0
	mov     r4, r1
	mov     r6, r2
...
.thumb
.globl Function_7_224b4c8
Function_7_224b4c8: @ 224b4c8 :thumb
	push    {r4,lr}
...
branch_224b522: @ 224b522 :thumb
	mov     r0, r5
	add     r0, #0x54
	bl      Call_Function_201ada4_ClearTextBox
.thumb
...
Function_224b8dc: @ 224b8dc :thumb
	...
	ldr     r2, [pc, #0x29c] @ 0x224bb80, (=0x161) PlMsg_Narc_353
	str     r0, [sp, #0x14]
	ldr     r5, [r0, #0x64]
	mov     r0, #0x0
	mov     r1, #PlMsg_Narc
...
branch_224bd5a: @ 224bd5a :thumb
	...
	ldr     r0, [pc, #0xa0] @ 0x224be0c, (=RAM_21bf67c)
	ldr     r1, [r0, #RAM_21bf67c_48_KeyNewPressed2]
	mov     r0, #KEY_A|KEY_B
	tst     r0, r1
	beq     branch_224be06
...
branch_224bd8c: @ 224bd8c :thumb
	ldr     r1, [pc, #0x7c] @ 0x224be0c, (=RAM_21bf67c)
...
.align 2, 0
.thumb
.globl Function_7_224be7c
Function_7_224be7c: @ 224be7c :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	mov     r4, r1
	bl      LoadOverWorldDataAdress
...
branch_224c2ce: @ 224c2ce :thumb
	...
	cmp     r0, #0x0
	beq     branch_224c32a
	ldr     r0, [pc, #0x18] @ 0x224c2f8, (=RAM_21bf67c)
	ldr     r1, [r0, #RAM_21bf67c_48_KeyNewPressed2]
	mov     r0, #KEY_A|KEY_B
	tst     r0, r1
	beq     branch_224c32a
...
Function_224c3e0: @ 224c3e0 :thumb
	ldr     r3, [pc, #0x4] @ 0x224c3e8, (=Function_2021964+1)
	ldr     r0, [r0, #0x1c]
	bx      r3
@ 0x224c3e6

.align 2
.word Function_2021964+1 @ 0x224c3e8
...
Function_224cc78: @ 224cc78 :thumb
	ldr     r3, [pc, #0x8] @ 0x224cc84, (=Function_2002114+1)
	mov     r1, r0
	ldr     r0, [r1, #0x4]
	ldr     r1, [r1, #0x8]
	bx      r3
...
.align 2
.word Function_2002114+1 @ 0x224cc84
...
Function_224cce4: @ 224cce4 :thumb
	...
	mul     r3, r2
	ldr     r1, [r1, r3]
	ldr     r3, [pc, #0x4] @ 0x224ccf0, (=Function_2029d50+1)
	mov     r2, #0x1
	bx      r3
@ 0x224ccf0

.word Function_2029d50+1 @ 0x224ccf0
...
.thumb
.globl Function_7_224cda4
Function_7_224cda4: @ 224cda4 :thumb
	push    {r3-r7,lr}
	mov     r5, r1
	mov     r7, r0
	str     r2, [sp, #0x0]
...
Function_224d018: @ 224d018 :thumb
	push    {r4,lr}
	ldr     r2, [pc, #0x20] @ 0x224d03c, (=0x21f) PlMsg_Narc_543
	mov     r4, r0
	mov     r0, #0x0
	mov     r1, #PlMsg_Narc
	mov     r3, #0xb
...
branch_224d268: @ 224d268 :thumb
	ldr     r0, [pc, #0x110] @ 0x224d37c, (=RAM_21bf67c)
	ldr     r1, [r0, #RAM_21bf67c_48_KeyNewPressed2]
	mov     r0, #KEY_A|KEY_B
	tst     r0, r1
	bne     branch_224d274
...
branch_224d6d2: @ 224d6d2 :thumb
	...
	ldr     r2, [pc, #0x170] @ 0x224d854, (=0x287) PlMsg_Narc_647
	mov     r0, #0x0
	mov     r1, #PlMsg_Narc
	mov     r3, #0xb
	bl      LoadFromNARC_9
...
branch_224dfd8: @ 224dfd8 :thumb
	ldr     r0, [pc, #0xb4] @ 0x224e090, (=RAM_21bf67c)
	mov     r1, #KEY_A
...
branch_224e6ce: @ 224e6ce :thumb
	ldr     r0, [pc, #0xec] @ 0x224e7bc, (=RAM_21bf67c)
	ldr     r1, [r0, #RAM_21bf67c_48_KeyNewPressed2]
	mov     r0, #KEY_A|KEY_B
	tst     r0, r1
	beq     branch_224e7b6
...
Function_224ec10: @ 224ec10 :thumb
	mov     r2, #0x2
	lsl     r2, r2, #8
	ldr     r3, [pc, #0x4] @ 0x224ec1c, (=Function_200d414+1)
	ldr     r0, [r0, r2]
	bx      r3
@ 0x224ec1a

.align 2
.word Function_200d414+1 @ 0x224ec1c
...
Function_224ec38: @ 224ec38 :thumb
	...
	mov     r0, r5
	bl      Function_203d1e4
	ldr     r1, [pc, #0x14] @ 0x224ec94, (=Function_209ac14+1)
	mov     r0, r6
	mov     r2, r4
	bl      Function_2050924
...
.word Function_209ac14+1 @ 0x224ec94

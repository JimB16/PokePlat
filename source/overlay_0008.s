...
.align 2, 0
.thumb
.globl Function_8_224997c
Function_8_224997c: @ 224997c :thumb
	push    {r4,r5,lr}
	add     sp, #-0x2c
...
.thumb
.globl Function_8_2249a40
Function_8_2249a40: @ 2249a40 :thumb
	push    {r4-r6,lr}
	mov     r5, r3
	ldr     r4, [sp, #0x10]
	bl      Function_2054f94
...
branch_2249e4e: @ 2249e4e :thumb
	...
	mov     r5, r0
	mov     r1, #0x1
	bl      Function_5_21d3f0c
	mov     r0, r5
	mov     r1, r6
	bl      Function_5_21d3f04
	mov     r0, r5
	mov     r1, #0x1
...
branch_2249f40: @ 2249f40 :thumb
	...
	bl      Function_5_21d3f04
	mov     r0, r6
	bl      Function_5_21d3e7c
	mov     r0, r6
	mov     r1, #0x0
	bl      Function_5_21d3e40
	mov     r0, r6
	bl      Function_5_21d3e44
	mov     r0, r4
	mov     r1, r7
	bl      Function_5_21d3da0
	mov     r4, r0
...
.thumb
.globl Function_8_2249fb8
Function_8_2249fb8: @ 2249fb8 :thumb
	push    {r3-r6,lr}
	add     sp, #-0xc
	mov     r5, r0
	mov     r0, #0xb
...
branch_224a1be: @ 224a1be :thumb
	...
	ldrb    r1, [r1, #0x0]
	ldr     r0, [r0, #0x0]
	bl      Function_5_21e18c4
	mov     r1, r7
	bl      Function_5_21e18b4
...
.thumb
.globl Function_8_224aafc
Function_8_224aafc: @ 224aafc :thumb
	push    {r4-r6,lr}
	asr     r0, r3, #15
	lsr     r0, r0, #16
	add     r0, r3, r0
...
.thumb
.globl Function_8_224acc0
Function_8_224acc0: @ 224acc0 :thumb
	push    {r4-r7}
	ldr     r0, [r0, #0x4]
	mov     r3, r1
	mov     r1, r2
...
.thumb
.globl Function_8_224ad34
Function_8_224ad34: @ 224ad34 :thumb
	push    {r3-r7,lr}
	mov     r7, r0
	mov     r5, r1
	bl      GetOverWorldData_VariableAreaAdresses
...
.thumb
.globl Function_8_224b110
Function_8_224b110: @ 224b110 :thumb
	push    {r3-r7,lr}
	mov     r5, r1
	mov     r4, r2
	ldr     r6, [sp, #0x18]
...
branch_224b628: @ 224b628 :thumb
	ldr     r0, [pc, #0x4c] @ 0x224b678, (=RAM_21bf67c)
...
.word RAM_21bf67c @ 0x224b678



.thumb
.globl Function_8_224b67c
Function_8_224b67c: @ 224b67c :thumb
	push    {r4-r7,lr}
	add     sp, #-0x14
	mov     r5, r0
	str     r1, [sp, #0x0]
...
Function_224b764: @ 224b764 :thumb
	...
	str     r5, [r4, #0x0]
	ldr     r0, [r5, #0x40]
	bl      Function_5_21df4a8
	ldr     r0, [r5, #0x40]
	mov     r1, #0xb
	mov     r2, #0x9
	bl      Function_5_21f42d8
	ldr     r0, [r6, #0x0]
	cmp     r0, #0x1
	bne     branch_224b7b4
	mov     r0, r4
...
.thumb
.globl Function_8_224b7d4
Function_8_224b7d4: @ 224b7d4 :thumb
	mov     r0, #0x0
	bx      lr
@ 0x224b7d8
...
*/
.thumb
.globl Function_8_224bf4c
Function_8_224bf4c: @ 224bf4c :thumb
	push    {r3-r7,lr}
	add     sp, #-0x10
	mov     r5, r0
	bl      GetOverWorldData_VariableAreaAdresses
...
branch_224bf68: @ 224bf68 :thumb
	...
	mov     r6, r0
	ldr     r0, [r5, #OverWorldData_4]
	mov     r1, r6
	ldr     r4, [r0, #OverWorldData_4_24]
	ldr     r0, [r5, #OverWorldData_SpriteStruct]
	add     r2, sp, #0xc
	add     r3, sp, #0x8
	bl      CalcNewSpritePositionXY @ ToDo

	ldr     r1, [sp, #0xc]      @ PosX
	ldr     r2, [sp, #0x8]      @ PosY
	mov     r0, r4              @ [OverWorldData_4_24]
	bl      Function_224b854
	mov     r7, r0
	bne     branch_224bf94
...
branch_224c228: @ 224c228 :thumb
	...
	beq     branch_224c302
	lsl     r1, r0, #2
	ldr     r0, [pc, #0x138] @ 0x224c37c, (=Unknown_224c6f8)
	ldr     r0, [r0, r1]
	str     r0, [sp, #0x0]
	bl      Function_201d35c
	ldr     r1, [r5, #0x8]
...
.word Unknown_224c6f8 @ 0x224c37c
...
.word Function_224c518_Dummy+1 @ =0x224c519, 0x224c4f4
.thumb
...
.thumb
Function_224c518_Dummy: @ 224c518 :thumb
	bx      lr
@ 0x224c51a
...
.align 2, 0
.thumb
.globl Function_8_224c51c
Function_8_224c51c: @ 224c51c :thumb
	push    {r3-r7,lr}
	add     sp, #-0x20
	mov     r5, r0
	bl      GetOverWorldData_VariableAreaAdresses
...
.thumb
.globl Function_8_224c5dc
Function_8_224c5dc: @ 224c5dc :thumb
	push    {r4,lr}
	mov     r4, r1
	bl      GetOverWorldData_VariableAreaAdresses
	bl      Function_2027860
...
.thumb
.globl Function_8_224c62c
Function_8_224c62c: @ 224c62c :thumb
	push    {r3-r7,lr}
	add     sp, #-0x8
	mov     r5, r1
	ldr     r1, [r3, #0x0]
...
.incbin "./baserom/overlay/overlay_0008.bin", 0x2d78, 0x224c6f8 - 0x224c6d8

Unknown_224c6f8: @ 0x224c6f8
.incbin "./baserom/overlay/overlay_0008.bin", 0x2d98, 0x224e780 - 0x224c6f8

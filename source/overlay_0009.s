...
.thumb
Function_2249e50: @ 2249e50 :thumb
	push    {r4-r6,lr}
	ldr     r0, [r0, #0x4]
	mov     r5, r1
	ldr     r0, [r0, #0x24]
...
Function_2249f88: @ 2249f88 :thumb
	ldr     r0, [r0, #0x0]
	ldr     r3, [pc, #0x8] @ 0x2249f94, (=#0x2062ccd)
	ldr     r0, [r0, #0x38]
	mov     r1, #0x0
	bx      r3
@ 0x2249f92
...
.word 0x2062ccd @ 0x2249f94
.thumb
Function_2249f98: @ 2249f98 :thumb
	bx      lr
@ 0x2249f9a
...
.thumb
Function_2249f9c: @ 2249f9c :thumb
	push    {r4,lr}
	add     sp, #-0x8
	ldr     r0, [r0, #0x4]
	ldr     r1, [r0, #0x24]
...
.thumb
Function_2249fd0: @ 2249fd0 :thumb
	push    {r4,lr}
	mov     r4, r0
	bne     branch_2249fda
	bl      ErrorHandling
...
.thumb
Function_224a520: @ 224a520 :thumb
	push    {r3,r4}
	ldr     r0, [r0, #0x4]
	mov     r3, #0x0
	ldr     r2, [r0, #0x24]
...
.thumb
Function_224a558: @ 224a558 :thumb
	ldr     r0, [r0, #0x4]
...
.thumb
Function_224a564: @ 224a564 :thumb
	ldr     r0, [r0, #0x4]
...
.thumb
Function_224a59c: @ 224a59c :thumb
	push    {r4-r6,lr}
	add     sp, #-0x10
	mov     r6, r0
	mov     r5, r1
...
.thumb
Function_224a67c: @ 224a67c :thumb
	push    {r4-r6,lr}
	add     sp, #-0x18
	mov     r5, r0
	ldr     r0, [r5, #0x4]
...
.thumb
Function_224a71c: @ 224a71c :thumb
	push    {r4-r7,lr}
	add     sp, #-0xc
	mov     r5, r0
	bl      Function_203d174
...
.thumb
Function_224a800: @ 224a800 :thumb
	push    {r4-r6,lr}
	add     sp, #-0x18
	mov     r5, r0
	ldr     r0, [r5, #0x4]
...
Function_224aa00: @ 224aa00 :thumb
	...
	mov     r1, r4
	lsl     r3, r2, #2
	ldr     r2, [pc, #0xc] @ 0x224aa30, (=#0x2251224)
	ldr     r2, [r2, r3]
	blx     r2
	mov     r0, #0x1
	pop     {r3-r5,pc}
...
branch_224adf8: @ 224adf8 :thumb
	...
	mov     r0, r5
	bl      Function_20181c4
	ldr     r0, [pc, #0x4c] @ 0x224aed4, (=#0x4000008)
	mov     r2, #0x3
	ldrh    r3, [r0, #0x0]
	mov     r1, #0x2
	bic     r3, r2
...
.word 0x4000008 @ 0x224aed4
.thumb
Function_224aed8: @ 224aed8 :thumb
	ldr     r0, [pc, #0x4] @ 0x224aee0, (=#0x4000050)
	mov     r1, #0x0
	strh    r1, [r0, #0x0]
	bx      lr
@ 0x224aee0

.word 0x4000050 @ 0x224aee0
.thumb
...
Function_224b124: @ 224b124 :thumb
	ldr     r3, [pc, #0x4] @ 0x224b12c, (=#0x20219f9)
	ldr     r0, [r1, #0x0]
	bx      r3
@ 0x224b12a
...
Function_224b2c0: @ 224b2c0 :thumb
	ldr     r3, [pc, #0x4] @ 0x224b2c8, (=#0x2021bd5)
	ldr     r0, [r1, #0x40]
	bx      r3
@ 0x224b2c6
...
.thumb
Function_224ca50: @ 224ca50 :thumb
	ldr     r0, [r0, #0x4]
	ldr     r3, [pc, #0x4] @ 0x224ca58, (=#0x224ca31)
	ldr     r0, [r0, #0x24]
	bx      r3
@ 0x224ca58

.word 0x224ca31 @ 0x224ca58
.thumb
Function_224ca5c: @ 224ca5c :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	ldr     r0, [r5, #0x4]
...
Function_224cbf8: @ 224cbf8 :thumb
	...
	ldr     r3, [pc, #0x8] @ 0x224cc04, (=#0x200da59)
	ldr     r0, [r0, r1]
	bx      r3
@ 0x224cc00

.word 0x1ca8 @ 0x224cc00
.word 0x200da59 @ 0x224cc04
.thumb
...
Function_224dc34: @ 224dc34 :thumb
	...
	mov     r2, #0x12
	add     r0, r0, r1
	ldr     r3, [pc, #0xc] @ 0x224dc48, (=#0x20d5124)
	mov     r1, #0x0
	lsl     r2, r2, #6
	bx      r3
@ 0x224dc42
...
Function_224e33c: @ 224e33c :thumb
	ldr     r3, [pc, #0x8] @ 0x224e348, (=#0x20d5124)
	add     r0, #0xd8
	mov     r1, #0x0
	mov     r2, #0xac
	bx      r3
...
.thumb
Function_224e884: @ 224e884 :thumb
	push    {r3-r5,lr}
	mov     r4, r1
	mov     r5, r0
	cmp     r4, #0x1
...
.thumb
Function_224e8a8: @ 224e8a8 :thumb
	ldr     r0, [r0, #0x4]
...
Function_224ea88: @ 224ea88 :thumb
	ldr     r0, [r1, #0x4]
	ldr     r3, [pc, #0x4] @ 0x224ea90, (=#0x2073a91)
	add     r0, #0x58
	bx      r3
@ 0x224ea90

.word 0x2073a91 @ 0x224ea90
.thumb
...
.thumb
Function_224f158: @ 224f158 :thumb
	mov     r3, r0
	mov     r2, r1
	ldr     r0, [r3, #0x4]
	ldr     r1, [r3, #0x1c]
...
.thumb
Function_224f16c: @ 224f16c :thumb
	push    {r4-r7,lr}
	add     sp, #-0xc
	mov     r6, r1
	mov     r1, #0x0
...
.thumb
Function_224f240: @ 224f240 :thumb
	push    {r3-r7,lr}
	add     sp, #-0x8
	mov     r4, r0
	mov     r5, r1
...
.thumb
Function_224f2b0: @ 224f2b0 :thumb
	push    {r3,lr}
	add     r1, sp, #0x0
	bl      Function_224f284
	pop     {r3,pc}
...
.thumb
Function_224f2bc: @ 224f2bc :thumb
	push    {r3-r7,lr}
	mov     r5, r0
	mov     r6, r1
	mov     r0, #0x4
...
.thumb
Function_224f6ec: @ 224f6ec :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	ldrh    r1, [r5, #0x12]
	cmp     r1, #0x0
...
.thumb
Function_2250780: @ 2250780 :thumb
	push    {r3-r5,lr}
	ldr     r0, [r0, #0x4]
	ldr     r5, [r0, #0x24]
...
.thumb
Function_2250f74: @ 2250f74 :thumb
	push    {r3,lr}
	bl      Function_203d174
	bl      Function_2027860
	bl      Function_2027f80
...
.thumb
Function_2250f90: @ 2250f90 :thumb
	push    {r3,lr}
	ldr     r0, [r0, #0x4]
	ldr     r0, [r0, #0x24]
	bl      Function_224c55c
...
.thumb
Function_2250fbc: @ 2250fbc :thumb
	push    {r3,lr}
	ldr     r0, [r0, #0x4]
	ldr     r0, [r0, #0x24]
	bl      Function_224c55c
...
.thumb
Function_2250fd8: @ 2250fd8 :thumb
	push    {r3-r7,lr}
	ldr     r0, [r0, #0x4]
	mov     r5, r1
	ldr     r7, [r0, #0x24]
...
.thumb
Function_2251000: @ 2251000 :thumb
	push    {r3-r7,lr}
	add     sp, #-0x8
	ldr     r0, [r0, #0x4]
	mov     r5, r1
...
.thumb
Function_2251044: @ 2251044 :thumb
	push    {r3-r7,lr}
	mov     r5, r0
	mov     r6, r1
	mov     r7, r2
...
.thumb
Function_2251094: @ 2251094 :thumb
	push    {r4-r7,lr}
	add     sp, #-0x14
	mov     r5, r0
	mov     r6, r1
...
.thumb
Function_22511a0: @ 22511a0 :thumb
	push    {r3-r7,lr}
	ldr     r0, [r0, #0x4]
	mov     r5, r1
	ldr     r7, [r0, #0x24]
...
.incbin "./baserom/overlay/overlay_0009.bin", 0x78ae, 0x2253ce0 - 0x225120e

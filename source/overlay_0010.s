...
branch_221f8e6: @ 221f8e6 :thumb
	...
	cmp     r0, #0x0
	beq     branch_221f8f6
	ldr     r0, [pc, #0x8] @ 0x221f8fc, (=GFX_FLUSH)
	mov     r1, #0x1
	str     r1, [r0, #0x0]
.thumb
...
branch_221f9a6: @ 221f9a6 :thumb
	...
	ldr     r0, [pc, #0x168] @ 0x221fb1c, (=RAM_21bf67c)
...
Function_221fb28: @ 221fb28 :thumb
	push    {r4,lr}
	ldr     r1, [pc, #0xb0] @ 0x221fbdc, (=REG_BLDCNT)
	mov     r4, r0
	mov     r0, #0x0
	strh    r0, [r1, #0x0]
	mov     r1, r0
	...
	ldr     r3, [pc, #0x94] @ 0x221fbe4, (=REG_DISPCNT_SUB)
	and     r2, r1
	str     r2, [r0, #0x0]
	ldr     r2, [r3, #0x0]
	add     r0, #0x50
...
.word REG_BLDCNT @ 0x221fbdc
.word 0xffffe0ff @ 0x221fbe0
.word REG_DISPCNT_SUB @ 0x221fbe4
...
branch_221fd8a: @ 221fd8a :thumb
	...
	str     r1, [r5, r2]
	ldr     r3, [r5, #0x0]
	ldr     r2, [pc, #0x4c] @ 0x221fe04, (=0x25d) PlMsg_Narc_605
	ldr     r3, [r3, #0x24]
	mov     r1, #PlMsg_Narc
	bl      LoadFromNARC_9
...
branch_2220668: @ 2220668 :thumb
	...
	lsl     r1, r1, #24
	mov     r6, #0xff
	ldr     r0, [pc, #0x20] @ 0x2220694, (=WIN0_X1)
	lsl     r5, r2, #8
	lsl     r2, r6, #8
	and     r2, r5
	lsr     r1, r1, #24
...
Function_2221004: @ 2221004 :thumb
	push    {r3,lr}
	ldr     r0, [pc, #0x10] @ 0x2221018, (=REG_BLDCNT)
	mov     r3, #0x8
	mov     r1, #0x2
	mov     r2, #0x1c
	str     r3, [sp, #0x0]
...
Function_2221188: @ 2221188 :thumb
	push    {r4-r7,lr}
	add     sp, #-0xc
	ldr     r4, [pc, #0x54] @ 0x22211e4, (=Unknown_2222a64)
	str     r2, [sp, #0x0]
	ldrb    r5, [r4, #0x0]
	str     r3, [sp, #0x4]
	add     r3, sp, #0x8
...
.word Unknown_2222a64 @ 0x22211e4
...
Function_2222720: @ 2222720 :thumb
	...
	mov     r6, r0
	ldr     r3, [r6, #0x0]
	ldr     r2, [pc, #0x74] @ 0x22227a0, (=0x1c5) PlMsg_Narc_453
	ldr     r3, [r3, #0x24]
	mov     r0, #0x0
	mov     r1, #PlMsg_Narc
	bl      LoadFromNARC_9

...
Function_221f800: @ 221f800 :thumb
	...
	beq     branch_221f810
	lsl     r1, r0, #2
	ldr     r0, [pc, #0x8] @ 0x221f814, (=#0x221fbd0)
	ldr     r0, [r0, r1]
	bx      lr

branch_221f810: @ 221f810 :thumb
	ldr     r0, [pc, #0x4] @ 0x221f818, (=#0x221f96c)
	bx      lr
@ 0x221f814

.word 0x221fbd0 @ 0x221f814
.word 0x221f96c @ 0x221f818
.thumb
...
Function_221f840: @ 221f840 :thumb
	...
	str     r0, [sp, #0x0]
	mov     r3, #0x12
	ldr     r0, [pc, #0x28] @ 0x221f880, (=#0x221f915)
	ldr     r1, [pc, #0x28] @ 0x221f884, (=#0x221f931)
	lsl     r3, r3, #10
	str     r4, [sp, #0x4]
	bl      0x2014014
	mov     r4, r0
...
.word 0x221f915 @ 0x221f880
.word 0x221f931 @ 0x221f884
.thumb
...
branch_221f8a0: @ 221f8a0 :thumb
	...
	str     r0, [sp, #0x0]
	mov     r3, #0x42
	ldr     r0, [pc, #0x28] @ 0x221f8d0, (=#0x221f915)
	ldr     r1, [pc, #0x28] @ 0x221f8d4, (=#0x221f931)
	lsl     r3, r3, #8
	str     r4, [sp, #0x4]
	bl      0x2014014
	mov     r4, r0
...
.word 0x221f915 @ 0x221f8d0
.word 0x221f931 @ 0x221f8d4
.thumb
...
.incbin "./baserom/overlay/overlay_0011.bin", 0x14c, 0x221fc20 - 0x221f94c

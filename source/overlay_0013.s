...
Function_221fe5c: @ 221fe5c :thumb
	...
	add     sp, #-0xc
	mov     r5, r0
	ldr     r0, [pc, #0xec] @ 0x221ff50, (=0x4001050)
	mov     r1, #0x0
	strh    r1, [r0, #0x0]
	ldr     r0, [r5, #0x0]
	add     r0, #0x35
...
Function_2220864: @ 2220864 :thumb
	push    {r4,lr}
	mov     r4, r0
	ldr     r0, [pc, #0x18] @ 0x2220884, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	bne     branch_222087a
...
Function_22213e4: @ 22213e4 :thumb
	ldr     r3, [pc, #0x4] @ 0x22213ec, (=0x2022665)
	mov     r0, r1
	bx      r3
@ 0x22213ea
...
branch_22219fa: @ 22219fa :thumb
	ldr     r3, [pc, #0x4] @ 0x2221a00, (=0x207d28d)
	bx      r3
@ 0x22219fe
...
Function_2221bb0: @ 2221bb0 :thumb
	...
	ldr     r0, [r2, r1]
	.hword  0x1d09 @ add r1, r1, #0x4
	ldr     r3, [pc, #0x8] @ 0x2221bc4, (=0x201a929)
	ldrb    r1, [r2, r1]
	bx      r3
@ 0x2221bbe
...
Function_2222dcc: @ 2222dcc :thumb
	...
	ldr     r3, [r3, #0x0]
	lsl     r4, r1, #4
	ldr     r2, [pc, #0x44] @ 0x2222e24, (=0x286)
	ldr     r3, [r3, #0xc]
	mov     r0, #0x1
	mov     r1, #0x1a
	bl      0x200b144
...
Function_222668c: @ 222668c :thumb
	...
	add     sp, #-0xc
	mov     r4, r0
	ldr     r0, [pc, #0xbc] @ 0x2226750, (=0x4001050)
	mov     r1, #0x0
	strh    r1, [r0, #0x0]
	ldr     r0, [r4, #0x0]
	ldr     r0, [r0, #0xc]
...
Function_2226c94: @ 2226c94 :thumb
	push    {r4,lr}
	mov     r4, r0
	ldr     r0, [pc, #0x18] @ 0x2226cb4, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	bne     branch_2226caa
...
Function_2227238: @ 2227238 :thumb
	ldr     r3, [pc, #0x4] @ 0x2227240, (=0x2022665)
	mov     r0, r1
	bx      r3
@ 0x222723e
...
Function_2227324: @ 2227324 :thumb
	...
	ldr     r0, [r1, #0x2c]
	add     r1, #0x30
	ldr     r3, [pc, #0x4] @ 0x2227330, (=0x201a929)
	ldrb    r1, [r1, #0x0]
	bx      r3
@ 0x2227330

.word 0x201a929 @ 0x2227330
.thumb
...
Function_2228a50: @ 2228a50 :thumb
	ldr     r3, [pc, #0x0] @ 0x2228a54, (=0x20181c5)
	bx      r3
@ 0x2228a54

.word 0x20181c5 @ 0x2228a54
.thumb
...
branch_2228adc: @ 2228adc :thumb
	ldr     r1, [pc, #0x30] @ 0x2228b10, (=0x21bf67c)
	ldr     r2, [r1, #0x48]
	mov     r1, #0xf3
	tst     r1, r2
	beq     branch_2228b08
...
branch_2228b7a: @ 2228b7a :thumb
	ldr     r0, [pc, #0x174] @ 0x2228cf0, (=0x21bf67c)
	mov     r1, #0x40
	ldr     r0, [r0, #0x48]
	tst     r1, r0
	beq     branch_2228b9e
...
branch_2228cc6: @ 2228cc6 :thumb
	ldr     r0, [pc, #0x28] @ 0x2228cf0, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	tst     r0, r1
	beq     branch_2228cd6

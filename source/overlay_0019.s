...
.thumb
Function_21d0dec: @ 21d0dec :thumb
	push    {r4,lr}
	bl      0x200682c
	mov     r1, #0x6b
	mov     r4, r0
...
branch_21d0e08: @ 21d0e08 :thumb
	...
	cmp     r0, #0x0
	beq     branch_21d0e4a
	ldr     r0, [pc, #0x40] @ 0x21d0e54, (=0x21bf67c)
	ldr     r2, [r0, #0x48]
	mov     r0, #0x2
	lsl     r0, r0, #10
	tst     r0, r2
...
.word 0x21bf67c @ 0x21d0e54
.thumb
Function_21d0e58: @ 21d0e58 :thumb
	push    {r4,lr}
	bl      0x200682c
	mov     r1, #0x49
	mov     r4, r0
...
branch_21d100c: @ 21d100c :thumb
	ldr     r1, [pc, #0x204] @ 0x21d1214, (=0x21bf67c)
	ldr     r2, [r1, #0x48]
	mov     r1, #0x1
	tst     r1, r2
	beq     branch_21d103c
...
branch_21d103c: @ 21d103c :thumb
	ldr     r0, [pc, #0x1d4] @ 0x21d1214, (=0x21bf67c)
	mov     r2, #0x2
	ldr     r1, [r0, #0x48]
	tst     r1, r2
	beq     branch_21d1050
...
branch_21d129a: @ 21d129a :thumb
	ldr     r1, [pc, #0x2e8] @ 0x21d1584, (=0x21bf67c)
	mov     r2, #0x1
	ldr     r1, [r1, #0x48]
	tst     r2, r1
	beq     branch_21d12e0
...
branch_21d12f6: @ 21d12f6 :thumb
	ldr     r0, [pc, #0x28c] @ 0x21d1584, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x10
	tst     r0, r1
	beq     branch_21d1314
...
branch_21d1314: @ 21d1314 :thumb
	ldr     r0, [pc, #0x26c] @ 0x21d1584, (=0x21bf67c)
	mov     r1, r4
	ldr     r0, [r0, #0x44]
	bl      Function_21d4f74
	cmp     r0, #0x0
...
branch_21d1556: @ 21d1556 :thumb
	...
	cmp     r0, #0x0
	beq     branch_21d15b8
	ldr     r0, [pc, #0x1c] @ 0x21d1584, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_21d15b8
...
branch_21d15d6: @ 21d15d6 :thumb
	ldr     r5, [pc, #0x1b4] @ 0x21d178c, (=0x21bf67c)
	mov     r2, r3
	ldr     r1, [r5, #0x44]
	add     r2, #0x70
	tst     r2, r1
...
branch_21d17c8: @ 21d17c8 :thumb
	ldr     r3, [pc, #0x1cc] @ 0x21d1998, (=0x21bf67c)
	mov     r1, #0x1
	ldr     r5, [r3, #0x48]
	tst     r1, r5
	beq     branch_21d17da
...
branch_21d19de: @ 21d19de :thumb
	ldr     r3, [pc, #0x288] @ 0x21d1c68, (=0x21bf67c)
	mov     r1, #0x1
	ldr     r5, [r3, #0x48]
	tst     r1, r5
	beq     branch_21d1a2a
...
branch_21d1c48: @ 21d1c48 :thumb
	ldr     r0, [pc, #0x1c] @ 0x21d1c68, (=0x21bf67c)
	ldr     r2, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r2
	beq     branch_21d1c64
...
branch_21d1f14: @ 21d1f14 :thumb
	ldr     r0, [pc, #0x40] @ 0x21d1f58, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_21d1f46
...
branch_21d205a: @ 21d205a :thumb
	ldr     r0, [pc, #0x44] @ 0x21d20a0, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_21d208c
...
branch_21d2658: @ 21d2658 :thumb
	ldr     r0, [pc, #0x34] @ 0x21d2690, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_21d2672
...
branch_21d2b7a: @ 21d2b7a :thumb
	ldr     r1, [pc, #0x23c] @ 0x21d2db8, (=0x21bf67c)
	ldr     r2, [r1, #0x44]
	mov     r1, #0x1
	tst     r1, r2
	beq     branch_21d2ba2
...
branch_21d2baa: @ 21d2baa :thumb
	ldr     r1, [pc, #0x20c] @ 0x21d2db8, (=0x21bf67c)
	ldr     r2, [r1, #0x44]
	mov     r1, #0x1
	tst     r1, r2
	beq     branch_21d2c0e
	...
	cmp     r0, #0x2
	bne     branch_21d2cae
	ldr     r1, [pc, #0x1f0] @ 0x21d2db8, (=0x21bf67c)
	mov     r0, #0xf0
	ldr     r2, [r1, #0x44]
	ldr     r1, [r1, #0x48]
	and     r2, r0
...
branch_21d2c4c: @ 21d2c4c :thumb
	...
	cmp     r0, #0x0
	beq     branch_21d2cae
	ldr     r0, [pc, #0x15c] @ 0x21d2db8, (=0x21bf67c)
	mov     r1, r4
	ldr     r0, [r0, #0x44]
	bl      Function_21d5150
	cmp     r0, #0x4
...
branch_21d2c7e: @ 21d2c7e :thumb
	ldr     r1, [pc, #0x138] @ 0x21d2db8, (=0x21bf67c)
	mov     r0, #0xf0
	ldr     r2, [r1, #0x44]
	ldr     r1, [r1, #0x48]
	and     r2, r0
...
branch_21d2d10: @ 21d2d10 :thumb
	ldr     r0, [pc, #0xa4] @ 0x21d2db8, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	tst     r0, r1
	beq     branch_21d2d4c
...
branch_21d2ed4: @ 21d2ed4 :thumb
	ldr     r0, [pc, #0x38] @ 0x21d2f10, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_21d2f04
...
branch_21d307c: @ 21d307c :thumb
	...
	cmp     r0, #0x0
	beq     branch_21d30c2
	ldr     r0, [pc, #0x3c] @ 0x21d30cc, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_21d30c2
...
branch_21d3248: @ 21d3248 :thumb
	...
	cmp     r0, #0x0
	beq     branch_21d3288
	ldr     r0, [pc, #0x34] @ 0x21d3290, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_21d3288
...
branch_21d3412: @ 21d3412 :thumb
	...
	cmp     r0, #0x0
	beq     branch_21d34d4
	ldr     r0, [pc, #0xbc] @ 0x21d34e0, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_21d34d4
...
branch_21d3438: @ 21d3438 :thumb
	...
	cmp     r0, #0x0
	beq     branch_21d34d4
	ldr     r0, [pc, #0x94] @ 0x21d34e0, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_21d34d4
...
branch_21d37d2: @ 21d37d2 :thumb
	ldr     r0, [pc, #0x108] @ 0x21d38dc, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_21d38d6
...
branch_21d37f6: @ 21d37f6 :thumb
	...
	cmp     r0, #0x0
	beq     branch_21d38d6
	ldr     r0, [pc, #0xd4] @ 0x21d38dc, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_21d38d6
...
branch_21d3828: @ 21d3828 :thumb
	...
	cmp     r0, #0x0
	beq     branch_21d38d6
	ldr     r0, [pc, #0xa4] @ 0x21d38dc, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_21d38d6
...
branch_21d3896: @ 21d3896 :thumb
	...
	cmp     r0, #0x0
	beq     branch_21d38d6
	ldr     r0, [pc, #0x34] @ 0x21d38dc, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_21d38d6
...
branch_21d3b5e: @ 21d3b5e :thumb
	...
	mov     r1, #0x4a
	lsl     r1, r1, #2
	ldr     r0, [pc, #0x80] @ 0x21d3c20, (=0x20f2dac)
	ldr     r1, [r4, r1]
	mov     r2, #0x9
	bl      0x20067e8
	mov     r1, #0x21
...
branch_21d3c52: @ 21d3c52 :thumb
	...
	mov     r1, #0x4b
	lsl     r1, r1, #2
	ldr     r0, [pc, #0x74] @ 0x21d3cf4, (=0x20f410c)
	add     r1, r5, r1
	mov     r2, #0x9
	bl      0x20067e8
	mov     r1, #0x21
...
branch_21d3f48: @ 21d3f48 :thumb
	...
	cmp     r0, #0x0
	beq     branch_21d3f90
	ldr     r0, [pc, #0x4c] @ 0x21d3fa8, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_21d3f90
...
branch_21d412c: @ 21d412c :thumb
	...
	cmp     r0, #0x0
	beq     branch_21d4172
	ldr     r0, [pc, #0x3c] @ 0x21d417c, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_21d4172
...
branch_21d4338: @ 21d4338 :thumb
	...
	cmp     r0, #0x0
	beq     branch_21d437e
	ldr     r0, [pc, #0x3c] @ 0x21d4388, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_21d437e
...
branch_21d4402: @ 21d4402 :thumb
	ldr     r0, [pc, #0x34] @ 0x21d4438, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0xf3
	tst     r1, r0
	beq     branch_21d4434
...
branch_21d44fe: @ 21d44fe :thumb
	...
	cmp     r0, #0x0
	beq     branch_21d459c
	ldr     r0, [pc, #0x90] @ 0x21d45a0, (=0x21bf67c)
	mov     r1, #0x22
	ldr     r0, [r0, #0x48]
	lsl     r1, r1, #4
	mov     r2, r0
...
branch_21d46f4: @ 21d46f4 :thumb
	ldr     r0, [pc, #0x234] @ 0x21d492c, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0xf3
	tst     r0, r1
	beq     branch_21d472c
...
branch_21d49de: @ 21d49de :thumb
	ldr     r0, [pc, #0x19c] @ 0x21d4b7c, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0xf3
	tst     r0, r1
	beq     branch_21d4a06
...
Function_21d4e50: @ 21d4e50 :thumb
	ldr     r3, [pc, #0x4] @ 0x21d4e58, (=0x20181c5)
	ldr     r0, [r0, #0x0]
	bx      r3
@ 0x21d4e56
...
Function_21d4e7c: @ 21d4e7c :thumb
	ldr     r3, [pc, #0x4] @ 0x21d4e84, (=0x20237bd)
	ldr     r0, [r0, #0x4]
	bx      r3
@ 0x21d4e82
...
Function_21d5df8: @ 21d5df8 :thumb
	mov     r1, #0x69
	lsl     r1, r1, #2
	ldr     r3, [pc, #0x4] @ 0x21d5e04, (=0x2027b51)
	ldr     r0, [r0, r1]
	bx      r3
@ 0x21d5e02
...
Function_21d6164: @ 21d6164 :thumb
	...
	sub     r0, r2, r0
	ldr     r2, [r3, #0xc]
	ldr     r3, [pc, #0x8] @ 0x21d6178, (=0x20bda20)
	sub     r1, r1, r2
	lsl     r0, r0, #12
	lsl     r1, r1, #12
	bx      r3
...
Function_21d6474: @ 21d6474 :thumb
	...
	ldr     r0, [r4, r0]
	bl      0x2007768
	ldr     r0, [pc, #0x8] @ 0x21d649c, (=0x4000540)
	mov     r1, #0x0
	str     r1, [r0, #0x0]
	pop     {r4,pc}
@ 0x21d649a
...
branch_21d6730: @ 21d6730 :thumb
	...
	mov     r0, #0xa
	str     r0, [sp, #0x0]
	ldr     r0, [pc, #0x40] @ 0x21d677c, (=0x4000050)
	mov     r1, #0x0
	mov     r2, #0x3f
	mov     r3, #0x6
	blx 0x20bf55c
...
branch_21d6794: @ 21d6794 :thumb
	mov     r0, #0xa
	str     r0, [sp, #0x0]
	ldr     r0, [pc, #0x3c] @ 0x21d67d8, (=0x4000050)
	mov     r1, #0x0
	mov     r2, #0x3f
	mov     r3, #0x6
	blx 0x20bf55c
...
Function_21d76fc: @ 21d76fc :thumb
	...
	str     r0, [sp, #0x0]
	blx 0x20bfd58
	ldr     r1, [pc, #0x14] @ 0x21d776c, (=0x4000540)
	mov     r0, #0x2
	str     r0, [r1, #0x0]
...
Function_21d77c8: @ 21d77c8 :thumb
	ldr     r3, [pc, #0x0] @ 0x21d77cc, (=0x200da05)
	bx      r3
@ 0x21d77cc

.word 0x200da05 @ 0x21d77cc
.thumb
...
Function_21d9b10: @ 21d9b10 :thumb
	ldr     r3, [pc, #0x4] @ 0x21d9b18, (=0x2021d6d)
	ldr     r0, [r0, #0x4]
	mov     r1, #0x1
	bx      r3
@ 0x21d9b18

.word 0x2021d6d @ 0x21d9b18
.thumb
...
Function_21da418: @ 21da418 :thumb
	...
	mul     r3, r2
	mov     r2, r3
	ldr     r3, [pc, #0x4] @ 0x21da424, (=0x20c4b68)
	bx      r3
@ 0x21da422
...
branch_21da7fe: @ 21da7fe :thumb
	ldr     r0, [r1, #0x0]
	ldrh    r1, [r1, #0x2c]
	ldr     r3, [pc, #0x4] @ 0x21da808, (=0x2021e91)
	add     r1, r1, r2
	bx      r3
@ 0x21da808

.word 0x2021e91 @ 0x21da808
.thumb
...
branch_21dd4c0: @ 21dd4c0 :thumb
	...
	mov     r0, #0x10
	str     r0, [sp, #0x0]
	ldr     r0, [pc, #0x64] @ 0x21dd538, (=0x4001050)
	mov     r1, #0x4
	mov     r2, #0x8
	mov     r3, #0x0
	blx 0x20bf55c
...
branch_21dd568: @ 21dd568 :thumb
	...
	mov     r0, #0x0
	str     r0, [sp, #0x0]
	ldr     r0, [pc, #0xec] @ 0x21dd664, (=0x4001050)
	mov     r1, #0x4
	mov     r2, #0x8
	mov     r3, #0x10
	blx 0x20bf55c
...
branch_21dd5ee: @ 21dd5ee :thumb
	...
	mov     r0, #0x10
	str     r0, [sp, #0x0]
	ldr     r0, [pc, #0x64] @ 0x21dd664, (=0x4001050)
	mov     r1, #0x4
	mov     r2, #0x8
	mov     r3, #0x0
	blx 0x20bf55c
...
Function_21de324: @ 21de324 :thumb
	ldr     r3, [pc, #0x4] @ 0x21de32c, (=0x2019121)
	mov     r0, #0x4
	mov     r1, #0x0
	bx      r3
@ 0x21de32c

.word 0x2019121 @ 0x21de32c
.thumb
Function_21de330: @ 21de330 :thumb
	push    {r3,lr}
	mov     r0, #0x2
	str     r0, [sp, #0x0]
	ldr     r0, [pc, #0x14] @ 0x21de34c, (=0x4001050)
	mov     r1, #0x1
	mov     r2, #0x3f
	mov     r3, #0xe
	blx 0x20bf55c
...
Function_21dfd2c: @ 21dfd2c :thumb
	push    {r3-r5,lr}
	mov     r4, r0
	ldr     r0, [pc, #0xa0] @ 0x21dfdd4, (=0x21bf67c)
	add     r4, #0x74
	ldr     r1, [r0, #0x48]
	mov     r0, #0x40
	mov     r2, r1

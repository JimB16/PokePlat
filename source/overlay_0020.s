...
Function_21d0df8: @ 21d0df8 :thumb
	...
	bl      0x200682c
	mov     r4, r0
	ldr     r0, [pc, #0x30] @ 0x21d0e34, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	strh    r1, [r4, #0x30]
	ldr     r1, [r0, #0x44]
	strh    r1, [r4, #0x32]
...
Function_21d1f88: @ 21d1f88 :thumb
	ldr     r3, [pc, #0x4] @ 0x21d1f90, (=0x2097555)
	ldr     r0, [r0, #0x0]
	bx      r3
@ 0x21d1f8e
...
Function_21d1f9c: @ 21d1f9c :thumb
	ldr     r3, [pc, #0x4] @ 0x21d1fa4, (=0x2014c81)
	add     r0, #0x8
	bx      r3
@ 0x21d1fa2
...
Function_21d1fc0: @ 21d1fc0 :thumb
	ldr     r3, [pc, #0x4] @ 0x21d1fc8, (=0x2014ba1)
	add     r0, #0x8
	bx      r3
@ 0x21d1fc6
...
Function_21d2080: @ 21d2080 :thumb
	ldr     r3, [pc, #0x4] @ 0x21d2088, (=0x2097559)
	ldr     r0, [r0, #0x0]
	bx      r3
@ 0x21d2086
...
Function_21d2170: @ 21d2170 :thumb
	ldr     r3, [pc, #0x0] @ 0x21d2174, (=0x200da05)
	bx      r3
@ 0x21d2174

.word 0x200da05 @ 0x21d2174
.thumb
...
Function_21d2ea4: @ 21d2ea4 :thumb
	...
	bl      0x2023790
	str     r0, [r4, #0x4c]
	ldr     r2, [pc, #0x18] @ 0x21d2eec, (=0x1b5)
	mov     r0, #0x0
	mov     r1, #0x1a
	mov     r3, #0x23
	bl      0x200b144
...
Function_21d33f4: @ 21d33f4 :thumb
	ldr     r3, [pc, #0x4] @ 0x21d33fc, (=0x20237bd)
	ldr     r0, [r0, #0x0]
	bx      r3
@ 0x21d33fa
...
Function_21d39bc: @ 21d39bc :thumb
	ldr     r3, [pc, #0x4] @ 0x21d39c4, (=0x2021d6d)
	ldr     r0, [r0, #0xc]
	mov     r1, #0x3
	bx      r3
@ 0x21d39c4

.word 0x2021d6d @ 0x21d39c4
.thumb
Function_21d39c8: @ 21d39c8 :thumb
	ldr     r3, [pc, #0x4] @ 0x21d39d0, (=0x2021d6d)
	ldr     r0, [r0, #0xc]
	mov     r1, #0x2
	bx      r3
@ 0x21d39d0

.word 0x2021d6d @ 0x21d39d0
.thumb
Function_21d39d4: @ 21d39d4 :thumb
	ldr     r3, [pc, #0x4] @ 0x21d39dc, (=0x2021cad)
	ldr     r0, [r0, #0xc]
	bx      r3
@ 0x21d39da
...
.word 0x2021cad @ 0x21d39dc
.thumb
Function_21d39e0: @ 21d39e0 :thumb
	ldr     r3, [pc, #0x4] @ 0x21d39e8, (=0x2021d35)
	ldr     r0, [r0, #0xc]
	bx      r3
@ 0x21d39e6
...
Function_21d3a98: @ 21d3a98 :thumb
	...
	mov     r1, #0x2
	mov     r2, r1
	ldr     r0, [pc, #0x4c] @ 0x21d3b68, (=0x4000050)
	sub     r2, #0xc
	blx 0x20bf578
	ldr     r0, [pc, #0x48] @ 0x21d3b6c, (=0x4000048)
	mov     r2, #0x3f
	ldrh    r3, [r0, #0x0]
	mov     r1, #0x1f
	bic     r3, r2
...
.word 0x4000050 @ 0x21d3b68
.word 0x4000048 @ 0x21d3b6c
...
Function_21d403c: @ 21d403c :thumb
	...
	mov     r0, #0x10
	str     r0, [sp, #0x0]
	ldr     r0, [pc, #0x2c] @ 0x21d4074, (=0x4000050)
	mov     r1, #0x2
	mov     r2, #0x3f
	mov     r3, #0x0
	blx 0x20bf55c
...
Function_21d42e4: @ 21d42e4 :thumb
	...
	mov     r0, #0x10
	str     r0, [sp, #0x0]
	ldr     r0, [pc, #0x8c] @ 0x21d437c, (=0x4000050)
	mov     r1, #0x4
	mov     r2, #0x3f
	mov     r3, #0x0
	blx 0x20bf55c
	...
	mov     r1, #0x1
	bl      0x2019120
	ldr     r1, [pc, #0x7c] @ 0x21d4380, (=0x4000048)
...
.word 0x4000050 @ 0x21d437c
.word 0x4000048 @ 0x21d4380
...
Function_21d43d8: @ 21d43d8 :thumb
	...
	mov     r1, #0x0
	bl      0x2019120
	ldr     r0, [pc, #0x3c] @ 0x21d4438, (=0x400004a)
	ldrh    r2, [r0, #0x0]
	mov     r0, #0x3f
	bic     r2, r0
	mov     r0, r4
...
branch_21d4416: @ 21d4416 :thumb
	ldr     r2, [pc, #0x20] @ 0x21d4438, (=0x400004a)
...
branch_21d4f9a: @ 21d4f9a :thumb
	...
	sub     r0, r0, r3
	str     r0, [sp, #0x0]
	ldr     r0, [pc, #0x8] @ 0x21d4fac, (=0x4000050)
	ldmia   r2!, {r1,r2}
	blx 0x20bf55c
	pop     {r3,pc}
@ 0x21d4faa
...
.word 0x4000050 @ 0x21d4fac
.thumb
Function_21d4fb0: @ 21d4fb0 :thumb
	push    {r3-r7,lr}
	mov     r5, r0
	ldr     r0, [pc, #0x30] @ 0x21d4fe8, (=0x4000050)
	mov     r4, r1
	mov     r6, r2
	mov     r7, r3
	blx 0x20bf578
...
branch_21d5034: @ 21d5034 :thumb
	ldr     r3, [pc, #0x4] @ 0x21d503c, (=0x20bf578)
	ldr     r0, [pc, #0x8] @ 0x21d5040, (=0x4000050)
	ldr     r1, [r1, #0x0]
	bx      r3
@ 0x21d503c

.word 0x20bf578 @ 0x21d503c
.word 0x4000050 @ 0x21d5040
.thumb

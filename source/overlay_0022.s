...
branch_2254e6e: @ 2254e6e :thumb
	...
	add     r2, sp, #0x4
	bl      Function_2254f00
	ldr     r0, [pc, #0x5c] @ 0x2254ed8, (=RAM_21bf6bc)
	ldr     r1, [sp, #0x8]
	ldrh    r2, [r0, #0x1c]
	sub     r1, r2, r1
	str     r1, [r6, #0x0]
...
Function_2255094: @ 2255094 :thumb
	...
	bl      Function_2255654
	bl      Function_22556dc
	ldr     r0, [pc, #0xc] @ 0x22550b0, (=RAM_21bf6dc)
	mov     r1, #0x1
	strb    r1, [r0, #0x5]
	bl      Function_201ffe8
	pop     {r3,pc}
...
.word RAM_21bf6dc @ 0x22550b0
.thumb
Function_22550b4: @ 22550b4 :thumb
	push    {r3,lr}
	ldr     r0, [pc, #0x18] @ 0x22550d0, (=RAM_21bf6dc)
	mov     r1, #0x0
	strb    r1, [r0, #0x5]
	bl      Function_201ffe8
	bl      Function_2255738
...
Function_225553c: @ 225553c :thumb
	...
	str     r0, [r1, #0x0]
	ldr     r0, [sp, #0x0]
	ldr     r1, [pc, #0x60] @ 0x22555c8, (=Unknown_20f983c)
	asr     r0, r0, #4
	lsl     r2, r0, #1
	lsl     r0, r2, #1
...
.word Unknown_20f983c @ 0x22555c8
...
Function_2255654: @ 2255654 :thumb
	...
	ldr     r2, [pc, #0x24] @ 0x22556d4, (=GFX_FLUSH)
	mov     r0, #0x2
...
.align 2, 0
.thumb
.globl Function_22_2255d44
Function_22_2255d44: @ 2255d44 :thumb
	push    {r3-r5,lr}
	add     sp, #-0x8
	mov     r2, #0x2
	mov     r4, r0
...
.thumb
.globl Function_22_2255e50
Function_22_2255e50: @ 2255e50 :thumb
	push    {r4-r7,lr}
	add     sp, #-0xc
	mov     r7, r0
	mov     r5, r1
...
branch_2255f0e: @ 2255f0e :thumb
	ldr     r0, [pc, #0x170] @ 0x2256080, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	and     r1, r0
	ldr     r0, [pc, #0x16c] @ 0x2256084, (=RAM_21bf6bc)
	ldrh    r0, [r0, #0x20]
	orr     r0, r1
	bne     branch_2255f20
.thumb
...
.word RAM_21bf67c @ 0x2256080
.word RAM_21bf6bc @ 0x2256084
...
.thumb
.globl Function_22_2256098
Function_22_2256098: @ 2256098 :thumb
	push    {r4-r6,lr}
	mov     r6, r0
	bl      LoadOverlayData1c
	mov     r4, r0
...
.thumb
.globl Function_22_2256174
Function_22_2256174: @ 2256174 :thumb
	push    {r3-r5,lr}
	add     sp, #-0x8
	mov     r2, #0x2
	mov     r5, r0
...
.thumb
.globl Function_22_22562ec
Function_22_22562ec: @ 22562ec :thumb
	push    {r3-r6,lr}
	add     sp, #-0xc
	mov     r4, r1
	bl      LoadOverlayData1c
...
.thumb
.globl Function_22_2256600
Function_22_2256600: @ 2256600 :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	bl      LoadOverlayData1c
	mov     r4, r0
...
Function_225890c: @ 225890c :thumb
	push    {r4,lr}
	ldr     r1, [pc, #0x34] @ 0x2258944, (=RAM_21bf6bc)
	mov     r4, r0
	ldrh    r2, [r1, #0x20]
	cmp     r2, #0x0
	beq     branch_225891e
...
branch_2258934: @ 2258934 :thumb
	ldr     r0, [pc, #0xc] @ 0x2258944, (=RAM_21bf6bc)
	ldrh    r1, [r0, #0x1c]
	strh    r1, [r4, #0x14]
	ldrh    r1, [r0, #0x1e]
	strh    r1, [r4, #0x16]
...
Function_2258d4c: @ 2258d4c :thumb
	...
	cmp     r0, #0x0
	beq     branch_2258d70
	ldr     r3, [pc, #0x1c] @ 0x2258d74, (=RAM_21bf6bc)
...
Function_2258dac: @ 2258dac :thumb
	...
	cmp     r0, #0x0
	beq     branch_2258e50
	ldr     r1, [pc, #0x98] @ 0x2258e54, (=RAM_21bf6bc)
	ldrh    r2, [r1, #0x1c]
	...
	add     r2, sp, #0x18
	bl      Function_2259698
	ldr     r0, [pc, #0x74] @ 0x2258e54, (=RAM_21bf6bc)
	ldr     r1, [r4, #0x14]
	ldrh    r2, [r0, #0x1c]
	ldr     r3, [sp, #0x18]
	sub     r5, r2, r1
...
.thumb
.globl Function_22_22591e0
Function_22_22591e0: @ 22591e0 :thumb
...
.thumb
.globl Function_22_2259250
Function_22_2259250: @ 2259250 :thumb
	push    {r4-r6,lr}
	mov     r5, r0
	ldr     r0, [r5, #0x0]
	mov     r4, r1
...
branch_2259292: @ 2259292 :thumb
	...
	sub     r0, r0, r2
	str     r0, [sp, #0x0]
	ldr     r0, [pc, #0x28] @ 0x22592ec, (=RAM_21bf6bc)
	str     r1, [sp, #0x4]
	ldrh    r2, [r0, #0x1c]
	mov     r3, #0x0
	sub     r1, r2, r1
...
.align 2, 0
.thumb
.globl Function_22_225b660
Function_22_225b660: @ 225b660 :thumb
	push    {r3-r5,lr}
	add     sp, #-0x10
	mov     r2, #0x2
	mov     r5, r0
...
branch_225b6c4: @ 225b6c4 :thumb
	...
	str     r0, [r4, #0xc]
	bl      Function_2255094
	ldr     r0, [pc, #0x60] @ 0x225b734, (=RAM_21bf6dc)
	mov     r1, #0x0
	strb    r1, [r0, #0x5]
	bl      Function_201ffe8
	mov     r0, r4
...
.word RAM_21bf6dc @ 0x225b734



.thumb
.globl Function_22_225b738
Function_22_225b738: @ 225b738 :thumb
	push    {r4,r5,lr}
	add     sp, #-0xc
	mov     r4, r1
	bl      LoadOverlayData1c
...
branch_225b7b4: @ 225b7b4 :thumb
	ldr     r1, [pc, #0x40] @ 0x225b7f8, (=RAM_21bf67c)
	ldr     r2, [r1, #0x48]
	mov     r1, #0x3
	tst     r1, r2
	beq     branch_225b7f2
...
.word RAM_21bf67c @ 0x225b7f8



.thumb
.globl Function_22_225b7fc
Function_22_225b7fc: @ 225b7fc :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	bl      LoadOverlayData1c
	mov     r4, r0

...
Function_21d1864: @ 21d1864 :thumb
	...
	add     sp, #-0x4
	mov     r4, r0
	ldr     r0, [pc, #0x114] @ 0x21d1980, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	tst     r0, r1
	beq     branch_21d18ca
...
Function_21d1a44: @ 21d1a44 :thumb
	...
	cmp     r0, #0x0
	beq     branch_21d1a9c
	ldr     r0, [pc, #0x104] @ 0x21d1b64, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0xc3
	tst     r0, r1
	beq     branch_21d1a6c
...
branch_21d1a78: @ 21d1a78 :thumb
	...
	cmp     r0, #0x0
	beq     branch_21d1a9c
	ldr     r0, [pc, #0xe0] @ 0x21d1b64, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0xc3
	tst     r0, r1
	beq     branch_21d1a90
...
branch_21d1c7e: @ 21d1c7e :thumb
	ldr     r0, [pc, #0x88] @ 0x21d1d08, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0xc3
	tst     r0, r1
	beq     branch_21d1c8e
...
Function_21d1dc8: @ 21d1dc8 :thumb
	...
	mov     r5, r0
	mov     r4, r1
	ldr     r0, [pc, #0x38] @ 0x21d1e08, (=0x21bf6dc)
	mov     r1, #0x1
	strb    r1, [r0, #0x8]
	mov     r0, #0x33
	bl      0x202c1b4
...
branch_21d1e1e: @ 21d1e1e :thumb
	...
	lsl     r0, r0, #4
	str     r1, [r5, r0]
	ldr     r0, [pc, #0x10] @ 0x21d1e74, (=0x21bf6dc)
	strb    r1, [r0, #0x8]
...
branch_21d1f3e: @ 21d1f3e :thumb
	ldr     r0, [pc, #0x88] @ 0x21d1fc8, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0xc3
	tst     r0, r1
	beq     branch_21d1f4e
...
Function_21d26d8: @ 21d26d8 :thumb
	...
	lsl     r1, r1, #2
	add     r0, r0, r1
	ldr     r3, [pc, #0x4] @ 0x21d26e4, (=0x200e085)
	mov     r1, #0x0
	bx      r3
@ 0x21d26e4

.word 0x200e085 @ 0x21d26e4
.thumb
...
Function_21d3088: @ 21d3088 :thumb
	ldr     r3, [pc, #0x0] @ 0x21d308c, (=0x202e9fd)
	bx      r3
@ 0x21d308c

.word 0x202e9fd @ 0x21d308c
.thumb

...
Function_222ae80: @ 222ae80 :thumb
	ldr     r3, [pc, #0x0] @ 0x222ae84, (=Function_202a824+1)
	bx      r3
@ 0x222ae84

.word Function_202a824+1 @ 0x222ae84
...
Function_222b190: @ 222b190 :thumb
	push    {r3,lr}
	ldr     r1, [pc, #0x1c] @ 0x222b1b0, (=RAM_21bf67c)
	ldr     r2, [r1, #0x48]
	mov     r1, #0x1
	tst     r1, r2
	bne     branch_222b1a2
...
Function_222bc40: @ 222bc40 :thumb
	ldr     r3, [pc, #0x4] @ 0x222bc48, (=Function_20c345c)
	mov     r0, #0x0
	bx      r3
@ 0x222bc46

.align 2
.word Function_20c345c @ 0x222bc48
...
Function_222bf44: @ 222bf44 :thumb
	...
	mov     r1, #0x1
	bl      Function_201ff74
	ldr     r0, [pc, #0x70] @ 0x222c0f0, (=RAM_21bf6dc)
	mov     r1, #0x0
	strb    r1, [r0, #0x5]
	bl      Function_201ffe8
	mov     r0, #0x1
...
Function_222cc64: @ 222cc64 :thumb
	push    {r4,lr}
	mov     r4, r0
	ldr     r0, [pc, #0x3c] @ 0x222cca8, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	tst     r0, r1
	bne     branch_222cc78
...
Function_222d498: @ 222d498 :arm
	ldr     r12, [pc, #0x8] @ [0x222d4a8] (=Function_4_21d7780)
	mov     r1, r0
	mov     r0, #0x0
	bx      r12
@ 0x222d4a8

.word Function_4_21d7780 @ 0x222d4a8

...
.thumb
.globl Function_64_222dce0
Function_64_222dce0: @ 222dce0 :thumb
	push    {r3-r5,lr}
	mov     r5, r0
...
.thumb
.globl Function_64_222ddac
Function_64_222ddac: @ 222ddac :thumb
	push    {r3-r6,lr}
	add     sp, #-0x4
	mov     r5, r1
...
.thumb
.globl Function_64_222dea4
Function_64_222dea4: @ 222dea4 :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	bl      LoadOverlayData1c
	mov     r4, r0
...
Function_222e1a4: @ 222e1a4 :thumb
	...
	mov     r5, r0
	mov     r6, r1
	ldr     r0, [pc, #0x6c] @ 0x222e218, (=RAM_21bf6dc)
	mov     r1, #0x0
	mov     r4, r2
	strb    r1, [r0, #0x5]
	bl      Function_201ffe8

	mov     r0, #PlWifinote_Narc
	mov     r1, r4
	bl      LoadFromNARC_8
	mov     r1, #0x19
	lsl     r1, r1, #4
...
.word RAM_21bf6dc @ 0x222e218
.thumb
Function_222e21c: @ 222e21c :thumb
	ldr     r3, [pc, #0x4] @ 0x222e224, (=Function_20219f8+1)
	ldr     r0, [r0, #0x4]
	bx      r3
@ 0x222e222

.align 2
.word Function_20219f8+1 @ 0x222e224
...
Function_222e990: @ 222e990 :thumb
	...
	lsl     r1, r1, #2
	ldr     r0, [r0, r1]
	ldr     r3, [pc, #0x4] @ 0x222e9a0, (=Function_200c0b0+1)
	mov     r1, #0x0
	bx      r3
@ 0x222e99e

.align 2
.word Function_200c0b0+1 @ 0x222e9a0
...
branch_222ec5e: @ 222ec5e :thumb
	...
	cmp     r0, #0x0
	beq     branch_222ec7a
	ldr     r0, [pc, #0x20] @ 0x222ec88, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	tst     r0, r1
	beq     branch_222ec7a
...
Function_222ee84: @ 222ee84 :thumb
	push    {r4-r6,lr}
	ldr     r6, [pc, #0x74] @ 0x222eefc, (=RAM_21bf67c)
	mov     r5, r0
	ldr     r1, [r6, #0x48]
	mov     r4, r2
	mov     r0, #0x1
...
branch_222f3c8: @ 222f3c8 :thumb
	...
	cmp     r0, #0x0
	beq     branch_222f400
	ldr     r0, [pc, #0x34] @ 0x222f408, (=RAM_21bf67c)
	ldr     r0, [r0, #0x48]
	cmp     r0, #0x0
	beq     branch_222f400
	ldr     r0, [sp, #0xc]
...
Function_222f798: @ 222f798 :thumb
	...
	add     sp, #-0x8
	mov     r5, r0
	ldr     r0, [pc, #0x14c] @ 0x222f8ec, (=RAM_21bf67c)
	mov     r6, r2
	ldr     r2, [r0, #0x48]
	mov     r3, #0x1
	tst     r3, r2
...
Function_222ff5c: @ 222ff5c :thumb
	...
	add     r1, sp, #0x0
	bl      Function_2021c50
	ldr     r1, [pc, #0x40] @ 0x222fffc, (=WIN_OUT)
...
Function_22300d8: @ 22300d8 :thumb
	ldr     r3, [pc, #0x4] @ 0x22300e0, (=Function_201a8fc+1)
	add     r0, #0x8
	bx      r3
@ 0x22300de

.align 2
.word Function_201a8fc+1 @ 0x22300e0
...
branch_223047a: @ 223047a :thumb
	...
	mov     r0, r7
	bl      Function_222dfd0
	ldr     r0, [pc, #0x110] @ 0x22305c4, (=JumpTable_20f2dac)
	ldr     r1, [r4, #0x4]
	mov     r2, r6
...
branch_22304c2: @ 22304c2 :thumb
	...
	cmp     r0, #0x0
	bne     branch_22304ec
	ldr     r0, [pc, #0xec] @ 0x22305c8, (=Unknown_20f2dbc)
	ldr     r1, [r4, #0x8]
	mov     r2, r6
	bl      AllocAndInitOverlayData
	str     r0, [r4, #0x0]
...
branch_2230544: @ 2230544 :thumb
	...
	mov     r0, r7
	bl      Function_222dfd0
	ldr     r0, [pc, #0x6c] @ 0x22305c4, (=JumpTable_20f2dac)
	ldr     r1, [r4, #0x4]
	mov     r2, r6
	bl      AllocAndInitOverlayData
	str     r0, [r4, #0x0]
...
.word JumpTable_20f2dac @ 0x22305c4
.word Unknown_20f2dbc @ 0x22305c8
...
branch_2230646: @ 2230646 :thumb
	ldr     r0, [pc, #0x28] @ 0x2230670, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_223066c
...
branch_2230948: @ 2230948 :thumb
	ldr     r2, [pc, #0xf8] @ 0x2230a44, (=RAM_21bf67c)
	mov     r1, #0x3
	ldr     r3, [r2, #0x48]
	tst     r1, r3
	beq     branch_223095e
...
branch_22309b4: @ 22309b4 :thumb
	ldr     r0, [pc, #0x8c] @ 0x2230a44, (=RAM_21bf67c)
	ldr     r1, [r0, #0x44]
	mov     r0, #0xc0
	tst     r0, r1
	bne     branch_2230a3e

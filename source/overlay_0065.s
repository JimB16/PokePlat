...
.thumb
.globl Function_65_222e2a8
Function_65_222e2a8: @ 222e2a8 :thumb
	push    {r3-r6,lr}
	add     sp, #-0xc
	mov     r6, r1
	ldr     r1, [r6, #0x0]
...
.thumb
.globl Function_65_222e3fc
Function_65_222e3fc: @ 222e3fc :thumb
	push    {r4-r6,lr}
	mov     r5, r1
	bl      LoadOverlayData1c
	ldr     r1, [r5, #0x0]
...
.thumb
.globl Function_65_222e548
Function_65_222e548: @ 222e548 :thumb
	push    {r4-r6,lr}
	mov     r5, r0
	bl      LoadOverlayData1c
	mov     r4, r0
...
Function_222ee8c: @ 222ee8c :thumb
	ldr     r3, [pc, #0x4] @ 0x222ee94, (=Function_201ff0c+1)
	mov     r0, #0x10
	mov     r1, #0x1
	bx      r3
@ 0x222ee94

.word Function_201ff0c+1 @ 0x222ee94
...
Function_222f21c: @ 222f21c :thumb
	...
	add     sp, #-0x8
	mov     r4, r1
	ldr     r1, [pc, #0x5c] @ 0x222f280, (=RAM_21bf67c)
	mov     r5, r0
	ldr     r2, [r1, #0x48]
	mov     r1, #0x3
	tst     r1, r2
...
Function_222f7ac: @ 222f7ac :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	ldr     r0, [pc, #0x38] @ 0x222f7ec, (=RAM_21bf67c)
	mov     r4, r1
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
...
branch_222f820: @ 222f820 :thumb
	ldr     r0, [pc, #0x40] @ 0x222f864, (=RAM_21bf67c)
	ldr     r2, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r2
	beq     branch_222f85e
...
Function_222fcdc: @ 222fcdc :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	ldr     r0, [pc, #0x88] @ 0x222fd6c, (=RAM_21bf67c)
	mov     r4, r1
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
...
branch_222ffd8: @ 222ffd8 :thumb
	ldr     r0, [pc, #0x140] @ 0x223011c, (=Function_2021cac+1)
	bl      0x21d113c
...
.word Function_207dfac+1 @ 0x223011c
...
branch_2230320: @ 2230320 :thumb
	...
	cmp     r0, r1
	bne     branch_223039c
	ldr     r0, [pc, #0x28c] @ 0x22305e0, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	lsl     r0, r0, #10
	tst     r0, r1
...
branch_22304ae: @ 22304ae :thumb
	...
	cmp     r2, r1
	bne     branch_2230508
	ldr     r1, [pc, #0x118] @ 0x22305e0, (=RAM_21bf67c)
	ldr     r2, [r1, #0x48]
	mov     r1, #0x2
	tst     r1, r2
	beq     branch_22304f2
...
branch_2230824: @ 2230824 :thumb
	...
	cmp     r0, #0x0
	bne     branch_2230858
	ldr     r0, [pc, #0x24] @ 0x223085c, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_2230850
...
branch_2230964: @ 2230964 :thumb
	ldr     r0, [pc, #0x60] @ 0x22309c8, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_2230982
...
branch_2230b42: @ 2230b42 :thumb
	...
	.hword  0x1e49 @ sub r1, r1, #0x1
	str     r1, [r5, r0]
	ldr     r1, [pc, #0x60] @ 0x2230bb0, (=RAM_21bf67c)
	ldr     r2, [r1, #0x48]
	mov     r1, #0x3
	tst     r1, r2
	bne     branch_2230b5c
...
branch_2230bd0: @ 2230bd0 :thumb
	ldr     r0, [pc, #0x2c] @ 0x2230c00, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_2230bfa
...
branch_2230c3a: @ 2230c3a :thumb
	...
	.hword  0x1e49 @ sub r1, r1, #0x1
	str     r1, [r5, r0]
	ldr     r1, [pc, #0x60] @ 0x2230ca8, (=RAM_21bf67c)
	ldr     r2, [r1, #0x48]
	mov     r1, #0x3
	tst     r1, r2
	bne     branch_2230c54
...
branch_2230cd0: @ 2230cd0 :thumb
	ldr     r1, [pc, #0x20] @ 0x2230cf4, (=RAM_21bf67c)
	ldr     r2, [r1, #0x48]
	mov     r1, #0x3
	tst     r1, r2
	beq     branch_2230cf0
...
branch_2232592: @ 2232592 :thumb
	ldr     r0, [pc, #0x14] @ 0x22325a8, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_22325a4
...
branch_2233214: @ 2233214 :thumb
	ldr     r2, [pc, #0x20] @ 0x2233238, (=RAM_21bf67c)
	mov     r0, #0xf0
	ldr     r3, [r2, #0x44]
	tst     r0, r3
	bne     branch_223322a
...
Function_2235198: @ 2235198 :thumb
	...
	mov     r0, r4
	bl      Function_2235b30
	ldr     r0, [pc, #0x44] @ 0x2235240, (=RAM_21bf67c)
	ldr     r1, [r0, #0x44]
	mov     r0, #0x80
	tst     r0, r1
	beq     branch_2235208
...
branch_2235208: @ 2235208 :thumb
	ldr     r0, [pc, #0x34] @ 0x2235240, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	tst     r0, r1
	beq     branch_223522e
...
Function_2235b78: @ 2235b78 :thumb
	...
	lsl     r1, r1, #2
	ldr     r0, [r0, r1]
	ldr     r3, [pc, #0x4] @ 0x2235b84, (=Function_2021cac+1)
	mov     r1, #0x0
	bx      r3
@ 0x2235b84

.word Function_2021cac+1 @ 0x2235b84
...
Function_2235bd8: @ 2235bd8 :thumb
	...
	lsl     r1, r1, #2
	ldr     r0, [r0, r1]
	ldr     r3, [pc, #0x4] @ 0x2235be4, (=Function_2021cac+1)
	mov     r1, #0x0
	bx      r3
@ 0x2235be4

.word Function_2021cac+1 @ 0x2235be4
...
branch_223606e: @ 223606e :thumb
	ldr     r0, [pc, #0xe4] @ 0x2236154, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	tst     r0, r1
	beq     branch_22360a8
...
branch_22360b2: @ 22360b2 :thumb
	ldr     r0, [pc, #0xa0] @ 0x2236154, (=RAM_21bf67c)
	mov     r1, #0x2
	ldr     r0, [r0, #0x44]
	mov     r2, r0
	tst     r2, r1
...
.thumb
.globl Function_65_223648c
Function_65_223648c: @ 223648c :thumb
	push    {r3-r5,lr}
	mov     r4, r0
	bl      LoadPtrToOverWorldDataIn18
	mov     r5, r0
...
.thumb
.globl Function_65_2236548
Function_65_2236548: @ 2236548 :thumb
	push    {r4-r7,lr}
	add     sp, #-0xc
	mov     r6, r0
	mov     r5, r1
...
.thumb
.globl Function_65_223668c
Function_65_223668c: @ 223668c :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	bl      LoadOverlayData1c
	mov     r4, r0
...
.thumb
.globl Function_65_22366e4
Function_65_22366e4: @ 22366e4 :thumb
	push    {r4-r6,lr}
	mov     r5, r0
	ldrb    r0, [r5, #0x4]
	mov     r4, r1
...
Function_2237548: @ 2237548 :thumb
	ldr     r3, [pc, #0x0] @ 0x223754c, (=Function_2032e64+1)
	bx      r3
@ 0x223754c

.word Function_2032e64+1 @ 0x223754c
...
branch_2237b1e: @ 2237b1e :thumb
	ldr     r0, [pc, #0x74] @ 0x2237b94, (=RAM_21bf67c)
	mov     r1, #0x1
	ldr     r0, [r0, #0x48]
	tst     r1, r0
	beq     branch_2237b56
...
branch_2238448: @ 2238448 :thumb
	ldr     r0, [pc, #0x1c] @ 0x2238468, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	lsl     r0, r0, #10
	tst     r0, r1

...
Function_225c980: @ 225c980 :thumb
	ldr     r3, [pc, #0x4] @ 0x225c988, (=Function_20219f8+1)
	ldr     r0, [r0, #0x4]
	bx      r3
@ 0x225c986
...
.word Function_20219f8+1 @ 0x225c988
.thumb
...
Function_225c9a0: @ 225c9a0 :thumb
	...
	bl      Function_2018340
	str     r0, [r5, #0x0]
	ldr     r0, [pc, #0xc4] @ 0x225ca80, (=RAM_21bf6dc)
	mov     r1, #0x0
	strb    r1, [r0, #0x5]
	bl      Function_201ffe8
	mov     r0, #0x0
...
branch_225cf16: @ 225cf16 :thumb
	ldr     r0, [pc, #0x104] @ 0x225d01c, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	tst     r0, r1
	beq     branch_225cf2e
...
Function_225d11c: @ 225d11c :thumb
	ldr     r3, [pc, #0x4] @ 0x225d124, (=Function_2021cc8+1)
	ldr     r0, [r0, #0x14]
	mov     r1, #0x1
	bx      r3
@ 0x225d124

.word Function_2021cc8+1 @ 0x225d124
...
branch_225d51c: @ 225d51c :thumb
	ldr     r0, [pc, #0x328] @ 0x225d848, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	tst     r0, r1
	bne     branch_225d528
...
branch_225d5e2: @ 225d5e2 :thumb
	ldr     r0, [pc, #0x264] @ 0x225d848, (=RAM_21bf67c)
	mov     r1, #0x1
	ldr     r0, [r0, #0x48]
	tst     r0, r1
	beq     branch_225d65a
...
branch_225d722: @ 225d722 :thumb
	ldr     r0, [pc, #0x124] @ 0x225d848, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	tst     r0, r1
	bne     branch_225d72e
...
branch_225d7f2: @ 225d7f2 :thumb
	ldr     r0, [pc, #0x54] @ 0x225d848, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	tst     r0, r1
	beq     branch_225d860

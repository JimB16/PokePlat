...
Function_225caf4: @ 225caf4 :thumb
	...
	mov     r4, r1
	ldr     r1, [r4, #0x4]
	ldr     r3, [pc, #0x68] @ 0x225cb68, (=Unknown_20f983c)
	lsl     r1, r1, #16
	lsr     r1, r1, #16
	asr     r1, r1, #4
	lsl     r2, r1, #1
	...
	bl      MTX_RotY33_
	ldr     r0, [r4, #0x0]
	ldr     r3, [pc, #0x4c] @ 0x225cb68, (=Unknown_20f983c)
	lsl     r0, r0, #16
	lsr     r0, r0, #16
	asr     r0, r0, #4
	lsl     r2, r0, #1
	...
	blx     MTX_Concat33
	ldr     r0, [r4, #0x8]
	ldr     r3, [pc, #0x28] @ 0x225cb68, (=Unknown_20f983c)
	lsl     r0, r0, #16
	lsr     r0, r0, #16
	asr     r0, r0, #4
	lsl     r2, r0, #1
...
.word Unknown_20f983c @ 0x225cb68
.thumb
Function_225cb6c: @ 225cb6c :thumb
	...
	mov     r4, r1
	ldr     r1, [r4, #0x0]
	ldr     r3, [pc, #0x68] @ 0x225cbe0, (=Unknown_20f983c)
	lsl     r1, r1, #16
	lsr     r1, r1, #16
	asr     r1, r1, #4
	lsl     r2, r1, #1
	...
	bl      MTX_RotY33_
	ldr     r0, [r4, #0x4]
	ldr     r3, [pc, #0x4c] @ 0x225cbe0, (=Unknown_20f983c)
	neg     r0, r0
	lsl     r0, r0, #16
	lsr     r0, r0, #16
	asr     r0, r0, #4
	...
	blx     MTX_Concat33
	ldr     r0, [r4, #0x8]
	ldr     r3, [pc, #0x24] @ 0x225cbe0, (=Unknown_20f983c)
	lsl     r0, r0, #16
	lsr     r0, r0, #16
	asr     r0, r0, #4
	lsl     r2, r0, #1
...
.word Unknown_20f983c @ 0x225cbe0
.thumb
Function_225cbe4: @ 225cbe4 :thumb
	push    {r3-r7,lr}
	mov     lr, r0
	ldr     r0, [pc, #0x60] @ 0x225cc4c, (=RAM_21bf6bc)
	mov     r12, r1
	ldrh    r5, [r0, #0x1c]
	mov     r1, #0x0
	mov     r7, r2
...
branch_225cc14: @ 225cc14 :thumb
	...
	and     r0, r1
	str     r0, [r6, #0x0]
	ldr     r0, [pc, #0x2c] @ 0x225cc4c, (=RAM_21bf6bc)
	ldrh    r3, [r0, #0x1e]
...
branch_225cfc0: @ 225cfc0 :thumb
	ldr     r2, [pc, #0x60] @ 0x225d024, (=RAM_21bf67c)
	lsl     r0, r0, #9
	ldr     r1, [r2, #0x48]
	tst     r0, r1
	beq     branch_225d00c
...
Function_225d2a8: @ 225d2a8 :thumb
	...
	mov     r3, #0x1
	bic     r4, r3
	ldr     r3, [pc, #0x5c] @ 0x225d314, (=CountryOfOriginValue)
	str     r4, [r0, #0x4]
	ldrb    r3, [r3, #0x0]
	cmp     r3, #0x1
	ldr     r3, [r0, #0x4]
...
.word CountryOfOriginValue @ 0x225d314
...
Function_225d384: @ 225d384 :thumb
	ldr     r3, [pc, #0x4] @ 0x225d38c, (=Function_20219f8+1)
	ldr     r0, [r0, #0x4]
	bx      r3
@ 0x225d38a
...
.word Function_20219f8+1 @ 0x225d38c
.thumb
...
Function_225d3a4: @ 225d3a4 :thumb
	...
	bl      Function_2018340
	str     r0, [r5, #0x0]
	ldr     r0, [pc, #0x134] @ 0x225d4f4, (=RAM_21bf6dc)
	mov     r1, #0x1
	strb    r1, [r0, #0x5]
	bl      Function_201ffe8
	mov     r0, #0x0
...
branch_225d50c: @ 225d50c :thumb
	...
	ldr     r0, [r6, #0x0]
	bl      free
	ldr     r0, [pc, #0x10] @ 0x225d538, (=RAM_21bf6dc)
	mov     r1, #0x0
	strb    r1, [r0, #0x5]
	bl      Function_201ffe8
	pop     {r4-r6,pc}
...
Function_225d63c: @ 225d63c :thumb
	mov     r1, #0x5
	lsl     r1, r1, #6
	ldr     r3, [pc, #0x4] @ 0x225d648, (=Function_20242c4+1)
	ldr     r0, [r0, r1]
	bx      r3
@ 0x225d646

.align 2
.word Function_20242c4+1 @ 0x225d648
...
Function_225d71c: @ 225d71c :thumb
	ldr     r3, [pc, #0x4] @ 0x225d724, (=Function_2017110+1)
	add     r0, #0x9c
	bx      r3
@ 0x225d722
...
.word Function_2017110+1 @ 0x225d724
.thumb
...
Function_225daec: @ 225daec :thumb
	ldr     r3, [pc, #0x4] @ 0x225daf4, (=Call_free5+1)
	ldr     r0, [r0, #0x0]
	bx      r3
@ 0x225daf2

.align 2
.word Call_free5+1 @ 0x225daf4



.thumb
Function_225daf8: @ 225daf8 :thumb
	ldr     r3, [pc, #0x0] @ 0x225dafc, (=Function_20203ec+1)
	bx      r3
@ 0x225dafc

.word Function_20203ec+1 @ 0x225dafc
...
Function_225dc48: @ 225dc48 :thumb
	ldr     r3, [pc, #0x4] @ 0x225dc50, (=Function_201a8fc+1)
	add     r0, #0x1c
	bx      r3
@ 0x225dc4e
...
.word Function_201a8fc+1 @ 0x225dc50
.thumb
Function_225dc54: @ 225dc54 :thumb
	...
	mov     r0, #0x0
	str     r0, [r4, #0x0]
	ldr     r0, [pc, #0xac] @ 0x225dd0c, (=RAM_21bf6bc)
	ldrh    r1, [r0, #0x20]
	cmp     r1, #0x0
	beq     branch_225dc9c
	ldrh    r1, [r0, #0x1c]
...
branch_225dc82: @ 225dc82 :thumb
	...
	str     r0, [r4, #0x18]
	str     r0, [r4, #0x0]
	ldr     r0, [pc, #0x7c] @ 0x225dd0c, (=RAM_21bf6bc)
	ldrh    r1, [r0, #0x1c]
	str     r1, [r4, #0x8]
	ldrh    r0, [r0, #0x1e]
	str     r0, [r4, #0xc]
...
branch_225dc9c: @ 225dc9c :thumb
	ldr     r0, [pc, #0x6c] @ 0x225dd0c, (=RAM_21bf6bc)
	ldrh    r0, [r0, #0x22]
	cmp     r0, #0x0
	beq     branch_225dcf4
	ldr     r1, [r4, #0x4]
...
branch_225dcc2: @ 225dcc2 :thumb
	...
	add     sp, #0x18
	str     r0, [r4, #0x14]
	ldr     r0, [pc, #0x20] @ 0x225dd0c, (=RAM_21bf6bc)
	ldrh    r1, [r0, #0x1c]
	str     r1, [r4, #0x8]
	ldrh    r0, [r0, #0x1e]
	str     r0, [r4, #0xc]
...
Function_225e534: @ 225e534 :thumb
	...
	mov     r0, #0x4
	ldsh    r5, [r1, r0]
	ldr     r0, [pc, #0x40] @ 0x225e588, (=SUB_WIN0_X1)
	mov     r3, #0xff
	strh    r3, [r0, #0x0]
	lsl     r2, r2, #24
	lsl     r5, r5, #8
...
branch_225e55c: @ 225e55c :thumb
	...
	mov     r0, #0x8
	ldsh    r4, [r1, r0]
	ldr     r0, [pc, #0x1c] @ 0x225e58c, (=SUB_WIN1_X1)
	mov     r3, #0xff
	strh    r3, [r0, #0x0]
	lsl     r2, r2, #24
	lsl     r4, r4, #8
...
.word SUB_WIN0_X1 @ 0x225e588
.word SUB_WIN1_X1 @ 0x225e58c
.thumb
...
branch_225edc2: @ 225edc2 :thumb
	...
	asr     r0, r0, #4
	lsl     r1, r0, #2
	ldr     r0, [pc, #0x54] @ 0x225ee64, (=Unknown_20f983c)
	ldsh    r6, [r0, r1]
	mov     r0, #0xa
	ldsh    r0, [r4, r0]
	cmp     r0, #0x0
...
.word Unknown_20f983c @ 0x225ee64
.thumb
...
Function_225ef84: @ 225ef84 :thumb
	ldr     r3, [pc, #0x4] @ 0x225ef8c, (=Function_200b1b8_CallMsgDecrypt+1)
	ldr     r0, [r0, #0x0]
	bx      r3
@ 0x225ef8a

.align 2
.word Function_200b1b8_CallMsgDecrypt+1 @ 0x225ef8c

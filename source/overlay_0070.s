...
Function_225d310: @ 225d310 :thumb
	...
	cmp     r0, #0x0
	bne     branch_225d3d2
	ldr     r0, [pc, #0x9c] @ 0x225d3d4, (=RAM_21bf67c)
	mov     r1, #0x2
	ldr     r0, [r0, #0x44]
	mov     r2, r0
	tst     r2, r1
...
branch_225dcf8: @ 225dcf8 :thumb
	ldr     r0, [pc, #0xf8] @ 0x225ddf4, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	tst     r0, r1
	beq     branch_225dde2
...
branch_2263146: @ 2263146 :thumb
	ldr     r0, [pc, #0x10] @ 0x2263158, (=RAM_21bf67c)
	ldr     r0, [r0, #0x44]
	tst     r0, r1
	beq     branch_2263152
	mov     r0, #0x1
...
branch_22637fe: @ 22637fe :thumb
	...
	cmp     r0, #0x0
	bne     branch_22638f6
	ldr     r0, [pc, #0xfc] @ 0x2263908, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_22638f6
...
branch_2263f32: @ 2263f32 :thumb
	ldr     r0, [pc, #0x1e4] @ 0x2264118, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	tst     r0, r1
	beq     branch_226401c
...
branch_22640bc: @ 22640bc :thumb
	ldr     r0, [pc, #0x58] @ 0x2264118, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	lsl     r0, r0, #10
	tst     r0, r1
...
branch_2264e5e: @ 2264e5e :thumb
	ldr     r0, [pc, #0x278] @ 0x22650d8, (=RAM_21bf67c)
	mov     r1, #0x2
	ldr     r0, [r0, #0x48]
	tst     r1, r0
	bne     branch_2264e6e
...
branch_226637e: @ 226637e :thumb
	...
	cmp     r0, #0x0
	bne     branch_22663d4
	ldr     r0, [pc, #0x44] @ 0x22663cc, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x2
	tst     r0, r1
	beq     branch_22663d4
...
branch_2266a90: @ 2266a90 :thumb
	ldr     r0, [pc, #0x58] @ 0x2266aec, (=RAM_21bf67c)
	mov     r1, #0x1
	ldr     r0, [r0, #0x48]
	tst     r1, r0
	bne     branch_2266aac
...
branch_226aca4: @ 226aca4 :thumb
	...
	cmp     r7, r0
	bne     branch_226ad06
	ldr     r0, [pc, #0x68] @ 0x226ad1c, (=RAM_21bf67c)
	mov     r1, #0x40
	ldr     r0, [r0, #0x48]
	mov     r4, #0x4
	tst     r1, r0

...
Function_225c7a0: @ 225c7a0 :thumb
	...
	lsl     r3, r0, #1
	lsl     r1, r3, #1
	ldr     r2, [pc, #0x68] @ 0x225c854, (=0x20f983c)
	...
	lsl     r2, r0, #1
	lsl     r1, r2, #1
	ldr     r3, [pc, #0x48] @ 0x225c854, (=0x20f983c)
	...
	lsl     r2, r0, #1
	lsl     r1, r2, #1
	ldr     r3, [pc, #0x28] @ 0x225c854, (=0x20f983c)
	.hword  0x1c52 @ add r2, r2, #0x1
	lsl     r2, r2, #1
	ldsh    r1, [r3, r1]
	ldsh    r2, [r3, r2]
...
Function_225e2ac: @ 225e2ac :thumb
	...
	lsl     r3, r3, #2
	ldr     r0, [r0, r3]
	ldr     r3, [pc, #0x4] @ 0x225e2b8, (=0x200c159)
	bx      r3
@ 0x225e2b6
...
.word 0x200c159 @ 0x225e2b8
.thumb
Function_225e2bc: @ 225e2bc :thumb
	mov     r3, #0xb7
	lsl     r3, r3, #2
	ldr     r0, [r0, r3]
	ldr     r3, [pc, #0x4] @ 0x225e2c8, (=0x200c191)
	bx      r3
@ 0x225e2c6
...
.word 0x200c191 @ 0x225e2c8
.thumb
Function_225e2cc: @ 225e2cc :thumb
	mov     r3, #0xb7
	lsl     r3, r3, #2
	ldr     r0, [r0, r3]
	ldr     r3, [pc, #0x4] @ 0x225e2d8, (=0x200c1c9)
	bx      r3
@ 0x225e2d6
...
.word 0x200c1c9 @ 0x225e2d8
.thumb
Function_225e2dc: @ 225e2dc :thumb
	mov     r3, #0xb7
	lsl     r3, r3, #2
	ldr     r0, [r0, r3]
	ldr     r3, [pc, #0x4] @ 0x225e2e8, (=0x200c201)
	bx      r3
@ 0x225e2e6
...
.word 0x200c201 @ 0x225e2e8
.thumb
Function_225e2ec: @ 225e2ec :thumb
	mov     r3, #0xb7
	lsl     r3, r3, #2
	ldr     r0, [r0, r3]
	ldr     r3, [pc, #0x4] @ 0x225e2f8, (=0x200c239)
	bx      r3
@ 0x225e2f6
...
.word 0x200c239 @ 0x225e2f8
.thumb
Function_225e2fc: @ 225e2fc :thumb
	mov     r3, #0xb7
	lsl     r3, r3, #2
	ldr     r0, [r0, r3]
	ldr     r3, [pc, #0x4] @ 0x225e308, (=0x200c271)
	bx      r3
@ 0x225e306
...
Function_225e4ec: @ 225e4ec :thumb
	...
	bl      0x201fe94
	ldr     r0, [pc, #0x194] @ 0x225e6a4, (=0x21bf6dc)
	mov     r1, #0x0
	strb    r1, [r0, #0x5]
	bl      0x201ffe8
	mov     r0, #0x0
...
Function_225edf8: @ 225edf8 :thumb
	ldr     r3, [pc, #0x4] @ 0x225ee00, (=0x2013a6d)
	ldr     r0, [r0, #0x34]
	bx      r3
@ 0x225edfe
...
Function_225f144: @ 225f144 :thumb
	ldr     r3, [pc, #0x0] @ 0x225f148, (=0x201a8fd)
	bx      r3
@ 0x225f148

.word 0x201a8fd @ 0x225f148
.thumb
...
Function_225f2c8: @ 225f2c8 :thumb
	...
	mov     r1, r2
	mov     r2, r3
	ldr     r3, [pc, #0x4] @ 0x225f2d4, (=0x200b499)
	ldr     r0, [r0, #0x0]
	bx      r3
@ 0x225f2d4

.word 0x200b499 @ 0x225f2d4
.thumb
Function_225f2d8: @ 225f2d8 :thumb
	mov     r3, r1
	mov     r1, r2
	mov     r2, r3
	ldr     r3, [pc, #0x4] @ 0x225f2e4, (=0x200c0b1)
	ldr     r0, [r0, #0x0]
	bx      r3
@ 0x225f2e4

.word 0x200c0b1 @ 0x225f2e4
.thumb
Function_225f2e8: @ 225f2e8 :thumb
	mov     r3, r1
	mov     r1, r2
	mov     r2, r3
	ldr     r3, [pc, #0x4] @ 0x225f2f4, (=0x200c0e9)
	ldr     r0, [r0, #0x0]
	bx      r3
@ 0x225f2f4

.word 0x200c0e9 @ 0x225f2f4
.thumb
Function_225f2f8: @ 225f2f8 :thumb
	mov     r3, r1
	mov     r1, r2
	mov     r2, r3
	ldr     r3, [pc, #0x4] @ 0x225f304, (=0x200c121)
	ldr     r0, [r0, #0x0]
	bx      r3
@ 0x225f304

.word 0x200c121 @ 0x225f304
.thumb
Function_225f308: @ 225f308 :thumb
	mov     r3, r1
	mov     r1, r2
	mov     r2, r3
	ldr     r3, [pc, #0x4] @ 0x225f314, (=0x200bdd1)
	ldr     r0, [r0, #0x0]
	bx      r3
@ 0x225f314

.word 0x200bdd1 @ 0x225f314
.thumb
...
Function_225f32c: @ 225f32c :thumb
	ldr     r3, [pc, #0x4] @ 0x225f334, (=0x200be49)
	ldr     r0, [r0, #0x0]
	bx      r3
@ 0x225f332
...
.word 0x200be49 @ 0x225f334
.thumb
Function_225f338: @ 225f338 :thumb
	ldr     r3, [pc, #0x4] @ 0x225f340, (=0x200c41d)
	ldr     r0, [r0, #0x0]
	bx      r3
@ 0x225f33e
...
Function_225f940: @ 225f940 :thumb
	...
	.hword  0x1c80 @ add r0, r0, #0x2
	strh    r3, [r1, r0]
	ldr     r3, [pc, #0x4] @ 0x225f954, (=0x200da3d)
	ldr     r0, [pc, #0x8] @ 0x225f958, (=0x225f95d)
	mov     r2, #0x0
	bx      r3
@ 0x225f954

.word 0x200da3d @ 0x225f954
...
Function_2260360: @ 2260360 :thumb
	ldr     r3, [pc, #0x8] @ 0x226036c, (=0x201a9a5)
	add     r2, r0, #0x4
	lsl     r0, r1, #4
	add     r0, r2, r0
	bx      r3
...
Function_2260f38: @ 2260f38 :thumb
	ldr     r3, [pc, #0x4] @ 0x2260f40, (=0x2017349)
	.hword  0x1d00 @ add r0, r0, #0x4
	bx      r3
@ 0x2260f3e
...
Function_2260f74: @ 2260f74 :thumb
	ldr     r3, [pc, #0x4] @ 0x2260f7c, (=0x2017389)
	.hword  0x1d00 @ add r0, r0, #0x4
	mov     r2, #0x0
	bx      r3
@ 0x2260f7c

.word 0x2017389 @ 0x2260f7c
.thumb
...
Function_226138c: @ 226138c :thumb
	ldr     r3, [pc, #0x4] @ 0x2261394, (=0x2017349)
	.hword  0x1d00 @ add r0, r0, #0x4
	bx      r3
@ 0x2261392
...
Function_2261418: @ 2261418 :thumb
	ldr     r3, [pc, #0x0] @ 0x226141c, (=0x20181c5)
	bx      r3
@ 0x226141c

.word 0x20181c5 @ 0x226141c
.thumb
...
Function_226146c: @ 226146c :thumb
	ldr     r3, [pc, #0x0] @ 0x2261470, (=0x2017111)
	bx      r3
@ 0x2261470

.word 0x2017111 @ 0x2261470
.thumb
...
branch_22632bc: @ 22632bc :thumb
	...
	asr     r0, r0, #4
	lsl     r1, r0, #2
	ldr     r0, [pc, #0x48] @ 0x2263328, (=0x20f983c)
	mov     r2, #0x6
	ldsh    r0, [r0, r1]
	lsl     r2, r2, #12
	asr     r1, r0, #31
...
branch_2265256: @ 2265256 :thumb
	...
	asr     r0, r0, #4
	lsl     r2, r0, #2
	ldr     r0, [pc, #0x34] @ 0x22652b8, (=0x20f983c)
	ldr     r1, [sp, #0x14]
	ldsh    r3, [r0, r2]
	asr     r0, r3, #31
	lsr     r2, r3, #16
...
branch_22652da: @ 22652da :thumb
	...
	asr     r0, r0, #4
	lsl     r1, r0, #2
	ldr     r0, [pc, #0x3c] @ 0x2265340, (=0x20f983c)
	mov     r2, #0x3
	ldsh    r0, [r0, r1]
	lsl     r2, r2, #12
	asr     r1, r0, #31
...
Function_226949c: @ 226949c :thumb
	...
	asr     r0, r1, #4
	lsl     r1, r0, #2
	ldr     r0, [pc, #0x24] @ 0x22694cc, (=0x20f983c)
	strh    r2, [r4, #0x2]
	ldsh    r0, [r0, r1]
	mov     r2, r3
	str     r3, [r4, #0x4]
...
Function_22694d0: @ 22694d0 :thumb
	...
	asr     r0, r0, #4
	lsl     r1, r0, #2
	ldr     r0, [pc, #0x1c] @ 0x2269504, (=0x20f983c)
	asr     r3, r2, #31
	ldsh    r0, [r0, r1]
	asr     r1, r0, #31
	blx     0x20e1f1c
...
Function_22697f0: @ 22697f0 :thumb
	ldr     r3, [pc, #0x8] @ 0x22697fc, (=0x20d5124)
	mov     r2, #0xd1
	mov     r0, r1
	mov     r1, #0x0
	lsl     r2, r2, #4
...
branch_226b05e: @ 226b05e :thumb
	...
	asr     r0, r0, #4
	lsl     r1, r0, #2
	ldr     r0, [pc, #0x144] @ 0x226b1bc, (=0x20f983c)
	ldsh    r2, [r0, r1]
	asr     r0, r2, #31
	lsr     r1, r2, #17
	lsl     r0, r0, #15
...
Function_226c39c: @ 226c39c :thumb
	ldr     r3, [pc, #0x0] @ 0x226c3a0, (=0x20181c5)
	bx      r3
@ 0x226c3a0

.word 0x20181c5 @ 0x226c3a0
.thumb
...
Function_226c8a8: @ 226c8a8 :thumb
	ldr     r3, [pc, #0x4] @ 0x226c8b0, (=0x20af558)
	mov     r0, #0x2
	mov     r1, #0x0
	bx      r3
@ 0x226c8b0

.word 0x20af558 @ 0x226c8b0
.thumb
...
Function_226cf38: @ 226cf38 :thumb
	ldr     r3, [pc, #0x0] @ 0x226cf3c, (=0x20181c5)
	bx      r3
@ 0x226cf3c

.word 0x20181c5 @ 0x226cf3c
.thumb
...
branch_226d3ce: @ 226d3ce :thumb
	...
	asr     r0, r6, #4
	lsl     r1, r0, #2
	ldr     r0, [pc, #0x8c] @ 0x226d468, (=0x20f983c)
	asr     r3, r2, #31
	ldsh    r0, [r0, r1]
	str     r0, [sp, #0x8]
	asr     r0, r0, #31

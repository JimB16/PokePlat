...
.thumb
.globl Function_71_223b140
Function_71_223b140: @ 223b140 :thumb
	push    {r3-r7,lr}
	add     sp, #-0x18
	mov     r5, r0
	mov     r0, #0x0
...
.thumb
.globl Function_71_223b388
Function_71_223b388: @ 223b388 :thumb
	push    {r3-r6,lr}
	add     sp, #-0xc
	mov     r5, r1
...
.thumb
.globl Function_71_223b5b8
Function_71_223b5b8: @ 223b5b8 :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	bl      LoadOverlayData1c
	mov     r4, r0
...
branch_223beae: @ 223beae :thumb
	...
	mov     r3, #0x0
	str     r3, [sp, #0x0]
	ldr     r0, [pc, #0x20] @ 0x223bef4, (=REG_BG3PA)
	add     r1, sp, #0x8
	mov     r2, #0x80
	str     r3, [sp, #0x4]
	blx     G2x_SetBGyAffine_
...
Function_223bef8: @ 223bef8 :thumb
	...
	str     r1, [r5, r0]
	ldr     r1, [pc, #0xa4] @ 0x223bfac, (=RAM_21bf6bc)
	mov     r4, r6
	ldrh    r1, [r1, #0x20]
	cmp     r1, #0x0
	beq     branch_223bf14
...
branch_223bf48: @ 223bf48 :thumb
	ldr     r0, [pc, #0x60] @ 0x223bfac, (=RAM_21bf6bc)
	ldrh    r0, [r0, #0x22]
	cmp     r0, #0x0
	beq     branch_223bf82
	mov     r1, r5
...
branch_223bf88: @ 223bf88 :thumb
	cmp     r6, #0x0
	bne     branch_223bfa2
	ldr     r0, [pc, #0x28] @ 0x223bfb8, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	tst     r0, r1
	beq     branch_223bf9a
...
.word RAM_21bf6bc @ 0x223bfac
.word 0x223d4d0 @ 0x223bfb0
.word 0x3318 @ 0x223bfb4
.word RAM_21bf67c @ 0x223bfb8
.thumb
Function_223bfbc: @ 223bfbc :thumb
	push    {r4-r6,lr}
	mov     r5, r0
	ldr     r0, [pc, #0xf8] @ 0x223c0bc, (=RAM_21bf6bc)
...
branch_223c012: @ 223c012 :thumb
	...
	cmp     r2, #0x28
	bgt     branch_223c058
	ldr     r0, [pc, #0x9c] @ 0x223c0bc, (=RAM_21bf6bc)
	ldrh    r1, [r0, #0x1e]
...
branch_223c058: @ 223c058 :thumb
	cmp     r2, #0x28
	bgt     branch_223c098
	ldr     r0, [pc, #0x5c] @ 0x223c0bc, (=RAM_21bf6bc)
	ldrh    r1, [r0, #0x1e]
...
branch_223c0ac: @ 223c0ac :thumb
	ldr     r1, [pc, #0xc] @ 0x223c0bc, (=RAM_21bf6bc)
...
Function_223c288: @ 223c288 :thumb
	...
	mov     r3, #0x0
	str     r3, [sp, #0x0]
	ldr     r0, [pc, #0x14] @ 0x223c2f0, (=REG_BG3PA)
	add     r1, sp, #0x8
	mov     r2, #0x80
	str     r3, [sp, #0x4]
	blx     G2x_SetBGyAffine_
...
Function_223c594: @ 223c594 :thumb
	ldr     r3, [pc, #0x4] @ 0x223c59c, (=Function_2005748+1)
	ldr     r0, [pc, #0x8] @ 0x223c5a0, (=0x699)
	bx      r3
@ 0x223c59a

.align 2
.word Function_2005748+1 @ 0x223c59c
...
Function_223c60c: @ 223c60c :thumb
	...
	add     r0, sp, #0x4
	str     r0, [sp, #0x0]
	ldr     r3, [pc, #0x1c] @ 0x223c650, (=RAM_21bf6bc)
	mov     r0, r5
	ldrh    r2, [r3, #0x1c]
	ldrh    r3, [r3, #0x1e]
	mov     r1, #0x2
...
Function_223c654: @ 223c654 :thumb
	...
	add     r0, sp, #0x4
	str     r0, [sp, #0x0]
	ldr     r3, [pc, #0x1c] @ 0x223c698, (=RAM_21bf6bc)
	mov     r0, r5
	ldrh    r2, [r3, #0x1c]
	ldrh    r3, [r3, #0x1e]
	mov     r1, #0x2

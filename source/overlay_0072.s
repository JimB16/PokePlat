...
.thumb
.globl Function_72_223d7a0
Function_72_223d7a0: @ 223d7a0 :thumb
	push    {r4-r7,lr}
	add     sp, #-0xc
	mov     r5, r1
	ldr     r1, [r5, #0x0]
...
.thumb
.globl Function_72_223d920
Function_72_223d920: @ 223d920 :thumb
	push    {r3-r5,lr}
	mov     r5, r1
	bl      LoadOverlayData1c
	ldr     r1, [r5, #0x0]
...
.thumb
.globl Function_72_223d984
Function_72_223d984: @ 223d984 :thumb
	push    {r3-r7,lr}
	str     r0, [sp, #0x0]
	bl      LoadOverlayData1c
	mov     r6, r0
...
Function_223ea18: @ 223ea18 :thumb
	push    {r3-r5,lr}
	ldr     r1, [pc, #0xa8] @ 0x223eac4, (=RAM_21bf6bc)
	mov     r4, r0
	ldrh    r0, [r1, #0x1c]
...
branch_223ea4c: @ 223ea4c :thumb
	...
	cmp     r3, #0x28
	bgt     branch_223ea82
	ldr     r0, [pc, #0x68] @ 0x223eac4, (=RAM_21bf6bc)
	ldrh    r2, [r0, #0x1e]
...
branch_223ea82: @ 223ea82 :thumb
	cmp     r3, #0x28
	bgt     branch_223eab2
	ldr     r0, [pc, #0x3c] @ 0x223eac4, (=RAM_21bf6bc)
	ldrh    r2, [r0, #0x1e]
...
branch_223eab2: @ 223eab2 :thumb
	ldr     r1, [pc, #0x10] @ 0x223eac4, (=RAM_21bf6bc)

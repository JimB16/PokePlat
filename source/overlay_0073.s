...
.thumb
.globl Function_73_21d0d80
Function_73_21d0d80: @ 21d0d80 :thumb
	push    {r3-r5,lr}
	mov     r2, #0x1
	mov     r5, r0
	mov     r0, #0x3
...
.thumb
.globl Function_73_21d0e20
Function_73_21d0e20: @ 21d0e20 :thumb
	push    {r3-r6,lr}
	add     sp, #-0xc
	mov     r5, r1
...
.thumb
.globl Function_73_21d0f7c
Function_73_21d0f7c: @ 21d0f7c :thumb
	push    {r4-r6,lr}
	mov     r6, r0
	bl      LoadOverlayData1c
	mov     r4, r0

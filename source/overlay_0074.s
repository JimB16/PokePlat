...
branch_21d0fc4: @ 21d0fc4 :thumb
	ldr     r0, [pc, #0x124] @ 0x21d10ec, (=0x21bf67c)
	mov     r1, #0x1
	ldr     r0, [r0, #0x48]
	tst     r1, r0
	beq     branch_21d0fd8
...
Function_21d14e8: @ 21d14e8 :thumb
	ldr     r3, [pc, #0x4] @ 0x21d14f0, (=0x20181c5)
	ldr     r0, [r0, #0x24]
	bx      r3
@ 0x21d14ee
...
Function_21d1a24: @ 21d1a24 :thumb
	...
	cmp     r2, #0x6
	beq     branch_21d1a94
	ldr     r0, [pc, #0xfc] @ 0x21d1b3c, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x10
	tst     r0, r1
	beq     branch_21d1a6a
...
branch_21d1a94: @ 21d1a94 :thumb
	ldr     r0, [pc, #0xa4] @ 0x21d1b3c, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x40
	tst     r0, r1
	beq     branch_21d1aea
...
Function_21d1bd0: @ 21d1bd0 :thumb
	...
	lsl     r0, r0, #2
	ldr     r0, [r1, r0]
	ldr     r3, [pc, #0x4] @ 0x21d1be0, (=0x2002115)
	ldr     r1, [r1, #0x0]
	bx      r3
@ 0x21d1bde

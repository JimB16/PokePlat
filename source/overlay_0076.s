...
Function_223d338: @ 223d338 :thumb
	...
	lsl     r0, r0, #2
	ldr     r0, [r1, r0]
	ldr     r3, [pc, #0x8] @ 0x223d34c, (=0x202ca11)
	lsl     r0, r0, #3
	add     r0, r1, r0
	ldr     r0, [r0, #0x8]
	add     r1, #0x68
...
Function_223d350: @ 223d350 :thumb
	...
	lsl     r1, r1, #2
	ldr     r1, [r2, r1]
	ldr     r3, [pc, #0x8] @ 0x223d364, (=0x202ca11)
	lsl     r1, r1, #3
	add     r1, r2, r1
	add     r0, #0x68
	ldr     r1, [r1, #0x8]
...
Function_223df70: @ 223df70 :thumb
	...
	lsl     r1, r1, #2
	ldr     r0, [r0, r1]
	ldr     r3, [pc, #0x4] @ 0x223df80, (=0x2007ded)
	mov     r1, #0x6
	bx      r3
@ 0x223df7e
...
.word 0x2007ded @ 0x223df80
.thumb
Function_223df84: @ 223df84 :thumb
	mov     r1, #0x6a
	lsl     r1, r1, #2
	ldr     r3, [pc, #0x4] @ 0x223df90, (=0x2007dc9)
	ldr     r0, [r0, r1]
	bx      r3
@ 0x223df8e

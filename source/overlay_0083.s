...
branch_223c06e: @ 223c06e :thumb
	...
	str     r0, [r4, #0x1c]
	bmi     branch_223c088
	ldr     r0, [pc, #0x1bc] @ 0x223c234, (=RAM_21bf6bc)
	ldrh    r0, [r0, #0x20]
	cmp     r0, #0x0
	bne     branch_223c088
	ldr     r0, [pc, #0x1b8] @ 0x223c238, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_223c090
...
branch_223c0ce: @ 223c0ce :thumb
	...
	.hword  0x1e40 @ sub r0, r0, #0x1
	str     r0, [r4, #0x1c]
	ldr     r0, [pc, #0x15c] @ 0x223c234, (=RAM_21bf6bc)
	ldrh    r0, [r0, #0x20]
	cmp     r0, #0x0
	bne     branch_223c0ec
	ldr     r0, [r4, #0x1c]
	cmp     r0, #0x0
	blt     branch_223c0ec
	ldr     r0, [pc, #0x154] @ 0x223c238, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_223c11c
...
branch_223c1b4: @ 223c1b4 :thumb
	...
	.hword  0x1e40 @ sub r0, r0, #0x1
	str     r0, [r4, #0x1c]
	ldr     r0, [pc, #0x78] @ 0x223c234, (=RAM_21bf6bc)
	ldrh    r0, [r0, #0x20]
	cmp     r0, #0x0
	bne     branch_223c1d2
	ldr     r0, [r4, #0x1c]
	cmp     r0, #0x0
	blt     branch_223c1d2
	ldr     r0, [pc, #0x6c] @ 0x223c238, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_223c220
...
.word RAM_21bf6bc @ 0x223c234
.word RAM_21bf67c @ 0x223c238
...
Function_223c958: @ 223c958 :thumb
	...
	ldr     r0, [pc, #0x30] @ 0x223caa0, (=RAM_21bf6dc)
	mov     r1, #0x1
	strb    r1, [r0, #0x5]
	bl      Function_201ffe8
	add     sp, #0x8
...
Function_223caa4: @ 223caa4 :thumb
	...
	mov     r0, r4
	bl      Function_223d068
	ldr     r0, [pc, #0x30] @ 0x223cb58, (=RAM_21bf6dc)
	mov     r1, #0x0
	strb    r1, [r0, #0x5]
	bl      Function_201ffe8
	pop     {r4,pc}
...
Function_223cd54: @ 223cd54 :thumb
	mov     r1, #0xaf
	lsl     r1, r1, #2
	ldr     r3, [pc, #0x4] @ 0x223cd60, (=Function_20150a8+1)
	ldr     r0, [r0, r1]
	bx      r3
@ 0x223cd5e

.align 2
.word Function_20150a8+1 @ 0x223cd60
...
Function_223ce9c: @ 223ce9c :thumb
	...
	ldr     r2, [pc, #0x2c] @ 0x223cf18, (=GFX_FLUSH)
	mov     r0, #0x2
...
branch_223ee2c: @ 223ee2c :thumb
	...
	asr     r0, r0, #31
	lsl     r3, r2, #1
	ldr     r1, [pc, #0x15c] @ 0x223efc4, (=Unknown_20f983c)
	str     r0, [sp, #0x70]
	ldr     r0, [sp, #0xa8]
	ldsh    r6, [r1, r3]
	lsl     r3, r4, #12
...
.word Unknown_20f983c @ 0x223efc4
...
branch_223f120: @ 223f120 :thumb
	...
	add     r0, r4, #0x1
	lsl     r1, r0, #1
	ldr     r0, [pc, #0x5c] @ 0x223f1bc, (=Unknown_20f983c)
	mov     r2, r6
	ldsh    r0, [r0, r1]
	mov     r3, r7
	asr     r1, r0, #31
	...
	orr     r0, r1
	str     r0, [sp, #0x0]
	ldr     r0, [pc, #0x3c] @ 0x223f1bc, (=Unknown_20f983c)
	lsl     r1, r4, #1
	ldsh    r0, [r0, r1]
	mov     r2, r6
	mov     r3, r7
...
.word Unknown_20f983c @ 0x223f1bc
.thumb
...
Function_223f544: @ 223f544 :thumb
	...
	lsl     r1, r0, #1
	add     r0, r1, #0x1
	ldr     r7, [pc, #0xe4] @ 0x223f648, (=Unknown_20f983c)
	lsl     r0, r0, #1
	ldsh    r3, [r7, r0]
	asr     r6, r3, #31
	lsr     r2, r3, #16
...
.word Unknown_20f983c @ 0x223f648
.word 0x0 @ 0x223f64c
.thumb
...
Function_223f784: @ 223f784 :thumb
	ldr     r3, [pc, #0x4] @ 0x223f78c, (=Function_2099160+1)
	ldr     r0, [r0, #0x0]
	bx      r3
@ 0x223f78a

.align 2
.word Function_2099160+1 @ 0x223f78c
...
Function_223f7a4: @ 223f7a4 :thumb
	ldr     r3, [pc, #0x4] @ 0x223f7ac, (=Function_2015938+1)
	ldr     r0, [r0, #0x0]
	bx      r3
@ 0x223f7aa
...
.word Function_2015938+1 @ 0x223f7ac
.thumb
...
Function_223f83c: @ 223f83c :thumb
	...
	add     sp, #-0x8
	mov     r4, r0
	ldr     r0, [pc, #0x44] @ 0x223f888, (=RAM_21bf6bc)
	ldrh    r1, [r0, #0x22]
	cmp     r1, #0x0
	beq     branch_223f860
	ldrh    r1, [r0, #0x1c]
...
branch_223f860: @ 223f860 :thumb
	...
	ldr     r0, [r4, #0x4]
	str     r0, [r4, #0xc]
	ldr     r0, [pc, #0x8] @ 0x223f888, (=RAM_21bf6bc)
	ldrh    r0, [r0, #0x22]
	str     r0, [r4, #0x14]
	add     sp, #0x8
	pop     {r4,pc}
...
.word Function_202a910+1 @ 0x22403dc
.word 0x0 @ 0x22403e0

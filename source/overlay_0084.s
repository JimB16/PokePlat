...
.thumb
Function_223b9e4_LoadVariableAreaAdress_19: @ 223b9e4 :thumb
	add     r0, #0xc4
	ldr     r0, [r0, #0x0]
	ldr     r3, =LoadVariableAreaAdress_19+1
	ldr     r0, [r0, #0x0]
	bx      r3
@ 0x223b9ee
...
Function_223b9f4: @ 223b9f4 :thumb
	push    {r4,lr}
	mov     r4, r1
	bl      Function_223b9e4_LoadVariableAreaAdress_19
	bl      Function_202d9cc
	strb    r4, [r0, #0x0]
	pop     {r4,pc}
@ 0x223ba04
...
Function_223c5b8: @ 223c5b8 :thumb
	...
	add     r2, r4, #0x4
	bl      Function_20014dc
	ldr     r0, [pc, #0x134] @ 0x223c714, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x4
	tst     r0, r1
	beq     branch_223c5fc
...
Function_223c750: @ 223c750 :thumb
	push    {r4,lr}
	mov     r4, r0
	ldr     r0, [pc, #0xdc] @ 0x223c834, (=RAM_21bf67c)
	ldr     r1, [r0, #0x4c]
	mov     r0, #0x20
	tst     r0, r1
	beq     branch_223c7c4
...
Function_223ca5c: @ 223ca5c :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	ldr     r0, [pc, #0x160] @ 0x223cbc4, (=RAM_21bf67c)
...
Function_223cdb0: @ 223cdb0 :thumb
	...
	add     r0, sp, #0x4
	str     r0, [sp, #0x0]
	ldr     r3, [pc, #0x28] @ 0x223ce04, (=RAM_21bf6bc)
	ldr     r0, [r5, #0x0]
	ldrh    r2, [r3, #0x1c]
	ldrh    r3, [r3, #0x1e]
	mov     r1, #0x4
...
Function_223ce08: @ 223ce08 :thumb
	...
	add     r0, sp, #0x4
	str     r0, [sp, #0x0]
	ldr     r3, [pc, #0x28] @ 0x223ce5c, (=RAM_21bf6bc)
	ldr     r0, [r5, #0x0]
	ldrh    r2, [r3, #0x1c]
	ldrh    r3, [r3, #0x1e]
	mov     r1, #0x4
...
Function_223d1f4: @ 223d1f4 :thumb
	...
	add     r0, sp, #0x4
	str     r0, [sp, #0x0]
	ldr     r3, [pc, #0x2c] @ 0x223d240, (=RAM_21bf6bc)
	ldr     r0, [r4, #0x0]
	ldrh    r2, [r3, #0x1c]
	ldrh    r3, [r3, #0x1e]
	mov     r1, #0x4
...
branch_223d34e: @ 223d34e :thumb
	ldr     r0, [pc, #0xd8] @ 0x223d428, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x4
	tst     r0, r1
	beq     branch_223d36a
...
branch_223d3e6: @ 223d3e6 :thumb
	...
	bl      Function_2005748
	ldr     r0, [pc, #0x38] @ 0x223d428, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	tst     r0, r1
	beq     branch_223d3fe
...
Function_223d8ec: @ 223d8ec :thumb
	...
	cmp     r0, #0x0
	bne     branch_223d93c
	ldr     r0, [pc, #0x44] @ 0x223d944, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	bne     branch_223d90e
	ldr     r0, [pc, #0x40] @ 0x223d948, (=RAM_21bf6bc)
	ldrh    r0, [r0, #0x20]
	cmp     r0, #0x0
	beq     branch_223d93c
.thumb
...
branch_223daac: @ 223daac :thumb
	...
	cmp     r0, #0x0
	bne     branch_223db6e
	ldr     r0, [pc, #0x130] @ 0x223dbec, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	bne     branch_223daca
	ldr     r0, [pc, #0x12c] @ 0x223dbf0, (=RAM_21bf6bc)
	ldrh    r0, [r0, #0x20]
	cmp     r0, #0x0
	beq     branch_223db6e
.thumb
...
.word RAM_21bf67c @ 0x223dbec
.word RAM_21bf6bc @ 0x223dbf0
.thumb
...
branch_223de0e: @ 223de0e :thumb
	...
	cmp     r0, #0x0
	bne     branch_223de5e
	ldr     r0, [pc, #0x54] @ 0x223de70, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	bne     branch_223de2c
	ldr     r0, [pc, #0x4c] @ 0x223de74, (=RAM_21bf6bc)
	ldrh    r0, [r0, #0x20]
	cmp     r0, #0x0
	beq     branch_223de5e
.thumb
...
.word RAM_21bf67c @ 0x223de70
.word RAM_21bf6bc @ 0x223de74
.thumb
...
branch_223df9a: @ 223df9a :thumb
	ldr     r0, [pc, #0x54] @ 0x223dff0, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	tst     r0, r1
	beq     branch_223dfbc
...
Function_223e18c: @ 223e18c :thumb
	...
	cmp     r0, #0x0
	bne     branch_223e1d0
	ldr     r0, [pc, #0x38] @ 0x223e1d8, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	bne     branch_223e1ae
	ldr     r0, [pc, #0x34] @ 0x223e1dc, (=RAM_21bf6bc)
	ldrh    r0, [r0, #0x20]
	cmp     r0, #0x0
	beq     branch_223e1d0
.thumb
...
.word RAM_21bf67c @ 0x223e1d8
.word RAM_21bf6bc @ 0x223e1dc
...
Function_223e36c: @ 223e36c :thumb
	...
	cmp     r0, #0x0
	bne     branch_223e3ac
	ldr     r0, [pc, #0x34] @ 0x223e3b4, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	bne     branch_223e38e
	ldr     r0, [pc, #0x30] @ 0x223e3b8, (=RAM_21bf6bc)
	ldrh    r0, [r0, #0x20]
	cmp     r0, #0x0
	beq     branch_223e3ac
.thumb
...
.word RAM_21bf67c @ 0x223e3b4
.word RAM_21bf6bc @ 0x223e3b8
.thumb
...
branch_223e6bc: @ 223e6bc :thumb
	ldr     r0, [pc, #0xdc] @ 0x223e79c, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	tst     r0, r1
	beq     branch_223e73c
...
Function_223e9b0: @ 223e9b0 :thumb
	...
	cmp     r0, #0x0
	bne     branch_223ea04
	ldr     r0, [pc, #0x48] @ 0x223ea0c, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	bne     branch_223e9d2
	ldr     r0, [pc, #0x44] @ 0x223ea10, (=RAM_21bf6bc)
	ldrh    r0, [r0, #0x20]
	cmp     r0, #0x0
	beq     branch_223ea04
.thumb
...
.word RAM_21bf67c @ 0x223ea0c
.word RAM_21bf6bc @ 0x223ea10
...
Function_223eb84: @ 223eb84 :thumb
	...
	str     r2, [r5, r0]
	mov     r0, r1
	ldr     r2, [pc, #0x154] @ 0x223ecfc, (=RAM_21bf6bc)
	add     r0, #0xc
	ldrh    r3, [r2, #0x1c]
	add     r1, #0xe
	strh    r3, [r5, r0]
...
branch_223ebc6: @ 223ebc6 :thumb
	...
	str     r3, [sp, #0x0]
	ldr     r4, [pc, #0x12c] @ 0x223ecfc, (=RAM_21bf6bc)
	ldrh    r0, [r5, r1]
	.hword  0x1c89 @ add r1, r1, #0x2
	ldrh    r1, [r5, r1]
	ldrh    r2, [r4, #0x1c]
...
branch_223ecd4: @ 223ecd4 :thumb
	ldr     r1, [pc, #0x24] @ 0x223ecfc, (=RAM_21bf6bc)

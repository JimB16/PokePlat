...
.thumb
.globl Function_85_2241440
Function_85_2241440: @ 2241440 :thumb
	push    {r3-r5,lr}
	mov     r4, r0
	mov     r0, #0x0
	mov     r1, r0
...
.thumb
.globl Function_85_224154c
Function_85_224154c: @ 224154c :thumb
	push    {r3-r5,lr}
	mov     r4, r1
...
.align 2, 0
.thumb
.globl Function_85_22415a0
Function_85_22415a0: @ 22415a0 :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	bl      LoadOverlayData1c
	mov     r4, r0
...
branch_2241e42: @ 2241e42 :thumb
	...
	lsl     r0, r2, #8
	orr     r1, r0
	ldr     r0, [pc, #0xc] @ 0x2241e5c, (=REG_BLDALPHA)
	strh    r1, [r0, #0x0]
	mov     r0, r4
	pop     {r3-r5,pc}
@ 0x2241e56
...
Function_2241f5c: @ 2241f5c :thumb
	...
	ldr     r1, [pc, #0x2c] @ 0x2241fe4, (=GFX_FLUSH)
	mov     r0, #0x0
	str     r0, [r1, #0x0]
...
Function_2241ff0: @ 2241ff0 :thumb
	...
	mov     r0, r4
	bl      Function_2242144
	ldr     r0, [pc, #0x8] @ 0x2242028, (=GFX_FLUSH)
	mov     r1, #0x1
	str     r1, [r0, #0x0]
	pop     {r4,pc}
@ 0x2242024
...
.word GFX_FLUSH @ 0x2242028
.thumb
Function_224202c: @ 224202c :thumb
	ldr     r3, [pc, #0x4] @ 0x2242034, (=Call_free5+1)
	add     r0, #0xd0
	ldr     r0, [r0, #0x0]
	bx      r3
@ 0x2242034

.word Call_free5+1 @ 0x2242034

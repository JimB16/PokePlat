...
.thumb
.globl Function_86_223b140
Function_86_223b140: @ 223b140 :thumb
	push    {r3-r7,lr}
	mov     r5, r0
	mov     r0, #0x0
	mov     r1, r0
...
.thumb
.globl Function_86_223b2e4
Function_86_223b2e4: @ 223b2e4 :thumb
	push    {r4-r6,lr}
	mov     r5, r1
	ldr     r1, [r5, #0x0]
	mov     r6, r0
...
.thumb
.globl Function_86_223b394
Function_86_223b394: @ 223b394 :thumb
	push    {r3-r5,lr}
	mov     r5, r1
	bl      LoadOverlayData1c
	ldr     r1, [r5, #0x0]
...
branch_223b664: @ 223b664 :thumb
	ldr     r0, [pc, #0x18] @ 0x223b680, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_223b674
...
Function_223b6cc: @ 223b6cc :thumb
	...
	str     r2, [sp, #0x0]
	blx     Function_20b275c
	ldr     r0, [pc, #0x20] @ 0x223b740, (=GFX_FLUSH)
	mov     r1, #0x1
	str     r1, [r0, #0x0]
	ldr     r0, [r4, #0x24]
	bl      Function_20219f8
...
.word GFX_FLUSH @ 0x223b740



.thumb
Function_223b744: @ 223b744 :thumb
	ldr     r3, [pc, #0x0] @ 0x223b748, (=AddTaskToTaskList2+1)
	bx      r3
@ 0x223b748

.word AddTaskToTaskList2+1 @ 0x223b748
...
Function_223b74c: @ 223b74c :thumb
	...
	mov     r1, #0x1
	bl      Function_2019448
	ldr     r0, [pc, #0x5c] @ 0x223b8bc, (=WIN0_X1)
	mov     r1, #0x0
	strh    r1, [r0, #0x0]
	mov     r5, r0
	strh    r1, [r0, #0x4]
...
Function_223b900: @ 223b900 :thumb
	...
	ldr     r1, [pc, #0x54] @ 0x223b99c, (=GFX_FLUSH)
	mov     r0, #0x2
	str     r0, [r1, #0x0]
...
Function_223ba34: @ 223ba34 :thumb
	...
	ldr     r3, [pc, #0x8] @ 0x223ba40, (=Call_free5+1)
	ldr     r0, [r0, r1]
	bx      r3
@ 0x223ba3c

.word 0x1bac @ 0x223ba3c
.word Call_free5+1 @ 0x223ba40
...
Function_223bdcc: @ 223bdcc :thumb
	ldr     r3, [pc, #0x8] @ 0x223bdd8, (=AddTaskToTaskList3+1)
	mov     r1, r0
...
.align 2
.word AddTaskToTaskList3+1 @ 0x223bdd8
...
branch_223bf72: @ 223bf72 :thumb
	...
	lsr     r0, r0, #24
	orr     r0, r1
	ldr     r1, [pc, #0x20] @ 0x223bfa4, (=WIN0_X1)
	strh    r0, [r1, #0x0]
...
branch_223bfda: @ 223bfda :thumb
	...
	lsr     r6, r6, #24
	orr     r6, r1
	ldr     r1, [pc, #0x28] @ 0x223c018, (=WIN0_X1)
	and     r2, r0
	lsl     r0, r3, #24
	lsr     r0, r0, #24
	strh    r6, [r1, #0x0]
...
branch_223c050: @ 223c050 :thumb
	...
	lsl     r0, r0, #8
	orr     r4, r2
	ldr     r2, [pc, #0x24] @ 0x223c08c, (=WIN0_X1)
	and     r3, r0
	lsl     r0, r1, #24
	lsr     r0, r0, #24
	strh    r4, [r2, #0x0]
...
branch_223c0c4: @ 223c0c4 :thumb
	...
	lsr     r3, r3, #24
	orr     r3, r1
	ldr     r1, [pc, #0x28] @ 0x223c100, (=WIN0_X1)
	strh    r3, [r1, #0x0]
	lsl     r3, r4, #8
	and     r3, r0
	lsl     r0, r2, #24
...
branch_223cbc8: @ 223cbc8 :thumb
	...
	ldr     r0, [r5, #0x0]
	mov     r3, #0x2
	blx     Function_20bf790
	ldr     r0, [r5, #0x0]
	mov     r1, #0x1
	blx     Function_20bf8f0
	mov     r1, #0x81
	lsl     r1, r1, #4
	ldr     r1, [r5, r1]
	ldr     r0, [r5, #0x0]
...
branch_223cfec: @ 223cfec :thumb
	...
	blx     Function_20bf864
	ldrh    r0, [r4, #0x28]
	ldr     r3, [pc, #0x160] @ 0x223d210, (=Unknown_20f983c)
	asr     r0, r0, #4
	lsl     r1, r0, #2
	ldr     r0, [pc, #0x15c] @ 0x223d210, (=Unknown_20f983c)
	add     r2, r0, r1
	ldsh    r1, [r3, r1]
	mov     r3, #0x2
	ldsh    r2, [r2, r3]
	...
	blx     MTX_Concat44
	ldrh    r0, [r4, #0x2a]
	ldr     r3, [pc, #0x140] @ 0x223d210, (=Unknown_20f983c)
	asr     r0, r0, #4
	lsl     r1, r0, #2
	ldr     r0, [pc, #0x138] @ 0x223d210, (=Unknown_20f983c)
	add     r2, r0, r1
	ldsh    r1, [r3, r1]
	mov     r3, #0x2
	ldsh    r2, [r2, r3]
	...
	blx     MTX_Concat44
	ldrh    r0, [r4, #0x2c]
	ldr     r3, [pc, #0x11c] @ 0x223d210, (=Unknown_20f983c)
	asr     r0, r0, #4
	lsl     r1, r0, #2
	ldr     r0, [pc, #0x118] @ 0x223d210, (=Unknown_20f983c)
	add     r2, r0, r1
	ldsh    r1, [r3, r1]
	mov     r3, #0x2
	ldsh    r2, [r2, r3]
	...
	add     r0, r7, r0
	blx     Function_20bf650
	ldr     r0, [pc, #0xc8] @ 0x223d1f4, (=0x1508)
	mov     r1, r5
	add     r0, r7, r0
	blx     Function_20bf69c
...
.word Unknown_20f983c @ 0x223d210

...
.thumb
.globl Function_87_21d0d80
Function_87_21d0d80: @ 21d0d80 :thumb
	push    {r3-r5,lr}
	mov     r2, #0x1
	mov     r5, r0
	mov     r0, #0x3
...
.thumb
.globl Function_87_21d0dfc
Function_87_21d0dfc: @ 21d0dfc :thumb
	push    {r3-r5,lr}
	mov     r5, r0
...
.align 2, 0
.thumb
.globl Function_87_21d0e2c
Function_87_21d0e2c: @ 21d0e2c :thumb
	push    {r3-r5,lr}
	mov     r5, r1
	bl      LoadOverlayData1c
	mov     r4, r0

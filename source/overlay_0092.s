...
.thumb
.globl Function_92_21d0d80
Function_92_21d0d80: @ 21d0d80 :thumb
	push    {r3-r5,lr}
	mov     r4, r0
	mov     r0, #0x0
	mov     r1, r0
	...
	mov     r0, #0x32
	str     r0, [r5, #0x0]
	ldr     r0, [pc, #0xc0] @ 0x21d0e94, (=CountryOfOriginValue)
	ldrb    r0, [r0, #0x0]
	cmp     r0, #0x1
	bne     branch_21d0dde
	mov     r1, #0x1
...
branch_21d0de0: @ 21d0de0 :thumb
	...
	add     r1, #0x1c
	str     r0, [r5, r1]
	ldr     r0, [pc, #0x58] @ 0x21d0eb4, (=RAM_21bf6dc)
	mov     r1, #0x1
	strb    r1, [r0, #0x5]
	bl      Function_201ffe8
	mov     r0, #0x4
...
.word CountryOfOriginValue @ 0x21d0e94
...
.word RAM_21bf6dc @ 0x21d0eb4



.thumb
.globl Function_92_21d0eb8
Function_92_21d0eb8: @ 21d0eb8 :thumb
	push    {r4-r7,lr}
	add     sp, #-0x14
	mov     r5, r1
...
branch_21d12f8: @ 21d12f8 :thumb
	...
	ldrh    r6, [r4, r1]
	bl      Function_21d1700
	ldr     r0, [pc, #0x154] @ 0x21d1458, (=RAM_21bf67c)
	mov     r3, #0x2
	ldr     r1, [r0, #0x48]
	mov     r0, r1
	tst     r0, r3
...
branch_21d13a0: @ 21d13a0 :thumb
	ldr     r2, [pc, #0xb4] @ 0x21d1458, (=RAM_21bf67c)
	mov     r0, r4
	ldr     r2, [r2, #0x44]
	bl      Function_21d2460
	cmp     r0, #0x1
...
.thumb
.globl Function_92_21d1478
Function_92_21d1478: @ 21d1478 :thumb
	push    {r4-r6,lr}
	mov     r6, r0
	bl      LoadOverlayData1c
	mov     r4, r0
	...
	mov     r0, r5
	bl      Function_201807c
	ldr     r0, [pc, #0x14] @ 0x21d14ec, (=RAM_21bf6dc)
	mov     r1, #0x0
	strb    r1, [r0, #0x5]
	mov     r0, #0x1
	pop     {r4-r6,pc}
...
Function_21d16f8: @ 21d16f8 :thumb
	ldr     r3, [pc, #0x0] @ 0x21d16fc, (=Function_20996d4+1)
	bx      r3
@ 0x21d16fc

.word Function_20996d4+1 @ 0x21d16fc
...
Function_21d1700: @ 21d1700 :thumb
	...
	mov     r1, #0x0
	str     r1, [r4, r0]
	ldr     r1, [pc, #0xfc] @ 0x21d180c, (=RAM_21bf6bc)
	ldrh    r2, [r1, #0x20]
	cmp     r2, #0x0
	beq     branch_21d1762
	ldrh    r2, [r1, #0x1c]
...
branch_21d1730: @ 21d1730 :thumb
	...
	str     r2, [r4, r1]
	ldr     r2, [pc, #0xbc] @ 0x21d180c, (=RAM_21bf6bc)
	add     r1, r0, #0x4
	ldrh    r3, [r2, #0x1c]
	str     r3, [r4, r1]
	mov     r1, r0
...
branch_21d1762: @ 21d1762 :thumb
	ldr     r0, [pc, #0xa8] @ 0x21d180c, (=RAM_21bf6bc)
	ldrh    r0, [r0, #0x22]
	cmp     r0, #0x0
	beq     branch_21d17de
...
branch_21d1796: @ 21d1796 :thumb
	...
	str     r2, [r4, r0]
	mov     r0, r1
	ldr     r2, [pc, #0x3c] @ 0x21d180c, (=RAM_21bf6bc)
	add     r0, #0x8
	ldrh    r3, [r2, #0x1c]
	add     r1, #0xc
	add     sp, #0x18
...
Function_21d1818: @ 21d1818 :thumb
	push    {r3-r7,lr}
	mov     lr, r0
	ldr     r0, [pc, #0x60] @ 0x21d1880, (=RAM_21bf6bc)
	mov     r12, r1
	ldrh    r5, [r0, #0x1c]
	mov     r1, #0x0
	mov     r7, r2
...
branch_21d1848: @ 21d1848 :thumb
	...
	and     r0, r1
	str     r0, [r6, #0x0]
	ldr     r0, [pc, #0x2c] @ 0x21d1880, (=RAM_21bf6bc)
	ldrh    r3, [r0, #0x1e]
...
branch_21d1c06: @ 21d1c06 :thumb
	cmp     r2, #0x0
	bne     branch_21d1c14
	ldr     r0, [pc, #0x28] @ 0x21d1c34, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	tst     r0, r1
	beq     branch_21d1c1c
...
Function_21d2370: @ 21d2370 :thumb
	...
	mov     r4, r1
	ldr     r1, [r4, #0x4]
	ldr     r3, [pc, #0x68] @ 0x21d23e4, (=Unknown_20f983c)
	lsl     r1, r1, #16
	lsr     r1, r1, #16
	asr     r1, r1, #4
	lsl     r2, r1, #1
	...
	bl      MTX_RotY33_
	ldr     r0, [r4, #0x0]
	ldr     r3, [pc, #0x4c] @ 0x21d23e4, (=Unknown_20f983c)
	lsl     r0, r0, #16
	lsr     r0, r0, #16
	asr     r0, r0, #4
	lsl     r2, r0, #1
	...
	blx     MTX_Concat33
	ldr     r0, [r4, #0x8]
	ldr     r3, [pc, #0x28] @ 0x21d23e4, (=Unknown_20f983c)
	lsl     r0, r0, #16
	lsr     r0, r0, #16
	asr     r0, r0, #4
	lsl     r2, r0, #1
...
.word Unknown_20f983c @ 0x21d23e4
.thumb
Function_21d23e8: @ 21d23e8 :thumb
	...
	mov     r4, r1
	ldr     r1, [r4, #0x0]
	ldr     r3, [pc, #0x68] @ 0x21d245c, (=Unknown_20f983c)
	lsl     r1, r1, #16
	lsr     r1, r1, #16
	asr     r1, r1, #4
	lsl     r2, r1, #1
	...
	bl      MTX_RotY33_
	ldr     r0, [r4, #0x4]
	ldr     r3, [pc, #0x4c] @ 0x21d245c, (=Unknown_20f983c)
	neg     r0, r0
	lsl     r0, r0, #16
	lsr     r0, r0, #16
	asr     r0, r0, #4
	...
	blx     MTX_Concat33
	ldr     r0, [r4, #0x8]
	ldr     r3, [pc, #0x24] @ 0x21d245c, (=Unknown_20f983c)
	lsl     r0, r0, #16
	lsr     r0, r0, #16
	asr     r0, r0, #4
	lsl     r2, r0, #1
...
.word Unknown_20f983c @ 0x21d245c
.thumb

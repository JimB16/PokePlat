...
.thumb
Function_223bcb0: @ 223bcb0 :thumb
	push    {r3-r7,lr}
	add     sp, #-0x10
	mov     r5, r1
	mov     r6, r0
...
.thumb
Function_223be2c: @ 223be2c :thumb
	push    {r4-r6,lr}
	mov     r5, r1
	bl      0x200682c
	mov     r4, r0
...
.thumb
Function_223bf54: @ 223bf54 :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	bl      0x200682c
	mov     r4, r0
...
Function_223e7c4: @ 223e7c4 :thumb
	mov     r1, #0x37
	lsl     r1, r1, #6
	ldr     r3, [pc, #0x4] @ 0x223e7d0, (=0x2021bd5)
	ldr     r0, [r0, r1]
	bx      r3
@ 0x223e7ce
...
Function_223ea84: @ 223ea84 :thumb
	...
	mov     r4, r0
	bl      Function_223efac
	ldr     r0, [pc, #0x120] @ 0x223ebb0, (=0x21bf67c)
	mov     r2, #0x1
	ldr     r1, [r0, #0x48]
	mov     r0, r1
	tst     r0, r2
...
Function_223efac: @ 223efac :thumb
	...
	add     sp, #-0xc
	mov     r4, r0
	ldr     r0, [pc, #0xe0] @ 0x223f094, (=0x21bf67c)
	mov     r1, #0x40
	ldr     r0, [r0, #0x48]
	tst     r1, r0
	beq     branch_223efee
...
Function_22402bc: @ 22402bc :thumb
	...
	cmp     r0, #0x5
	bne     branch_22403cc
	ldr     r0, [pc, #0x210] @ 0x22404e0, (=0x21bf67c)
	ldr     r2, [r0, #0x48]
	mov     r0, #0x2
	tst     r0, r2
	beq     branch_22402ec
...
branch_22403cc: @ 22403cc :thumb
	cmp     r0, #0x6
	bne     branch_2240432
	ldr     r0, [pc, #0x10c] @ 0x22404e0, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x2
	tst     r0, r1
	beq     branch_22403f0
...
Function_22404f0: @ 22404f0 :thumb
	push    {r4-r6,lr}
	mov     r5, r0
	ldr     r0, [pc, #0xbc] @ 0x22405b4, (=0x21bf67c)
	mov     r4, #0x0
	ldr     r0, [r0, #0x48]
	mov     r1, #0x40
	mov     r6, r4
...
Function_2241990: @ 2241990 :thumb
	push    {r3,r4,lr}
	add     sp, #-0x14
	ldr     r1, [pc, #0x70] @ 0x2241a08, (=0x21bf67c)
	mov     r4, r0
	ldr     r2, [r1, #0x48]
	mov     r1, #0x2
	tst     r1, r2
...
Function_2242d74: @ 2242d74 :thumb
	...
	ldr     r3, [pc, #0x8] @ 0x2242d80, (=0x201a8fd)
	add     r0, r0, r1
	bx      r3
@ 0x2242d7c

.word 0xefc @ 0x2242d7c
.word 0x201a8fd @ 0x2242d80
.thumb
...
Function_2242d98: @ 2242d98 :thumb
	mov     r1, #0xbb
	lsl     r1, r1, #4
	ldr     r3, [pc, #0x4] @ 0x2242da4, (=0x20237bd)
	ldr     r0, [r0, r1]
	bx      r3
@ 0x2242da2
...
Function_2243ff0: @ 2243ff0 :thumb
	...
	mov     r2, #0x7
	mul     r2, r3
	ldr     r3, [pc, #0x8] @ 0x2244008, (=0x2021d6d)
	add     r1, r1, r2
	bx      r3
@ 0x2244004

.word 0xed4 @ 0x2244004
.word 0x2021d6d @ 0x2244008
.thumb
...
Function_22443e0: @ 22443e0 :thumb
	...
	bl      0x208e9c0
	mov     r1, r4
	ldr     r0, [pc, #0x20] @ 0x224448c, (=0x20f410c)
	add     r1, #0xbc
	mov     r2, #0x3e
	bl      0x20067e8
	mov     r1, r4
...
Function_2245564: @ 2245564 :thumb
	push    {r4,lr}
	mov     r4, r0
	ldr     r0, [pc, #0x20] @ 0x224558c, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	tst     r0, r1
	bne     branch_2245578
...
Function_2245934: @ 2245934 :thumb
	ldr     r3, [pc, #0x0] @ 0x2245938, (=0x2039735)
	bx      r3
@ 0x2245938

.word 0x2039735 @ 0x2245938
.thumb

...
.thumb
.globl Function_95_2246c20
Function_95_2246c20: @ 2246c20 :thumb
	push    {r4,r5,lr}
	add     sp, #-0x14
	mov     r5, r0
	bl      Function_200f2ac
...
.align 2, 0
.thumb
.globl Function_95_2246e1c
Function_95_2246e1c: @ 2246e1c :thumb
	push    {r4-r6,lr}
	mov     r5, r0
...
.align 2, 0
.thumb
.globl Function_95_2246e7c
Function_95_2246e7c: @ 2246e7c :thumb
	push    {r4-r6,lr}
	mov     r5, r1
	bl      LoadOverlayData1c
	mov     r4, r0
...
branch_2246f9a: @ 2246f9a :thumb
	...
	mov     r0, #0x8
	str     r0, [sp, #0x0]
	ldr     r0, [pc, #0x48] @ 0x2246ff8, (=REG_BLDCNT)
	mov     r1, #0x4
	mov     r2, #0xc
	mov     r3, #0x10
...
Function_2247674: @ 2247674 :thumb
	ldr     r0, [r0, #0x0]
	ldr     r3, [pc, #0x4] @ 0x224767c, (=Function_2027b50+1)
	ldr     r0, [r0, #0x14]
	bx      r3
@ 0x224767c

.word Function_2027b50+1 @ 0x224767c
...
Function_22477b8: @ 22477b8 :thumb
	...
	add     r0, #0x80
	ldrh    r0, [r0, #0x0]
	ldr     r3, [pc, #0x98] @ 0x2247864, (=Unknown_20f983c)
	asr     r0, r0, #4
	lsl     r2, r0, #1
	lsl     r1, r2, #1
	.hword  0x1c52 @ add r2, r2, #0x1
	...
	add     r0, #0x82
	ldrh    r0, [r0, #0x0]
	ldr     r3, [pc, #0x70] @ 0x2247864, (=Unknown_20f983c)
	asr     r0, r0, #4
	lsl     r2, r0, #1
	lsl     r1, r2, #1
	.hword  0x1c52 @ add r2, r2, #0x1
	...
	add     r0, #0x84
	ldrh    r0, [r0, #0x0]
	ldr     r3, [pc, #0x4c] @ 0x2247864, (=Unknown_20f983c)
	asr     r0, r0, #4
	lsl     r2, r0, #1
	lsl     r1, r2, #1
	.hword  0x1c52 @ add r2, r2, #0x1
...
.word Unknown_20f983c @ 0x2247864
.thumb
...
Function_22479dc: @ 22479dc :thumb
	...
	add     r0, #0x80
	ldrh    r0, [r0, #0x0]
	ldr     r3, [pc, #0x9c] @ 0x2247a8c, (=Unknown_20f983c)
	asr     r0, r0, #4
	lsl     r2, r0, #1
	lsl     r1, r2, #1
	.hword  0x1c52 @ add r2, r2, #0x1
	...
	add     r0, #0x82
	ldrh    r0, [r0, #0x0]
	ldr     r3, [pc, #0x74] @ 0x2247a8c, (=Unknown_20f983c)
	asr     r0, r0, #4
	lsl     r2, r0, #1
	lsl     r1, r2, #1
	.hword  0x1c52 @ add r2, r2, #0x1
	...
	add     r0, #0x84
	ldrh    r0, [r0, #0x0]
	ldr     r3, [pc, #0x50] @ 0x2247a8c, (=Unknown_20f983c)
	asr     r0, r0, #4
	lsl     r2, r0, #1
	lsl     r1, r2, #1
	.hword  0x1c52 @ add r2, r2, #0x1
...
.word Unknown_20f983c @ 0x2247a8c
.thumb
...
Function_2247ab0: @ 2247ab0 :thumb
	ldr     r3, [pc, #0x8] @ 0x2247abc, (=Function_20209d4+1)
	mov     r2, r0
	mov     r0, r1
	ldr     r1, [r2, #0x0]
	bx      r3
...
.align 2
.word Function_20209d4+1 @ 0x2247abc



.thumb
Function_2247ac0: @ 2247ac0 :thumb
	ldr     r3, [pc, #0x8] @ 0x2247acc, (=Function_20209f8+1)
	mov     r2, r0
	mov     r0, r1
	ldr     r1, [r2, #0x0]
	bx      r3
...
.align 2
.word Function_20209f8+1 @ 0x2247acc



.thumb
Function_2247ad0: @ 2247ad0 :thumb
	ldr     r3, [pc, #0x8] @ 0x2247adc, (=Function_2020854+1)
	mov     r2, r0
	mov     r0, r1
	ldr     r1, [r2, #0x0]
	bx      r3
...
.align 2
.word Function_2020854+1 @ 0x2247adc



.thumb
Function_2247ae0: @ 2247ae0 :thumb
	ldr     r3, [pc, #0x8] @ 0x2247aec, (=Function_2020910+1)
	mov     r2, r0
	mov     r0, r1
	ldr     r1, [r2, #0x0]
	bx      r3
...
.align 2
.word Function_2020910+1 @ 0x2247aec
...
Function_2247cb4: @ 2247cb4 :thumb
	...
	mov     r1, r0
	bl      Function_201ff0c
	ldr     r2, [pc, #0x1c8] @ 0x2247ec8, (=REG_BG0CNT)
	mov     r0, #0x3
	ldrh    r3, [r2, #0x0]
	mov     r1, #0x1
	bic     r3, r0
	...
	mov     r0, r4
	bl      Function_224829c
	ldr     r0, [pc, #0x50] @ 0x2247ed4, (=REG_BLDCNT)
	mov     r1, #0x0
	strh    r1, [r0, #0x0]
	bl      Function_2039734
	mov     r0, #0x1
...
.word REG_BG0CNT @ 0x2247ec8
.word 0x73800 @ 0x2247ecc
.word 0x224befc @ 0x2247ed0
.word REG_BLDCNT @ 0x2247ed4
.thumb
...
Function_2248174: @ 2248174 :thumb
	...
	ldr     r1, [pc, #0x6c] @ 0x2248228, (=GFX_FLUSH)
	mov     r0, #0x2
	str     r0, [r1, #0x0]
...
Function_2248364: @ 2248364 :thumb
	...
	bl      AddTaskToTaskList2
	str     r0, [r5, #0x78]
	ldr     r0, [pc, #0xc] @ 0x22483b0, (=REG_BLDCNT)
	mov     r1, #0x1
	mov     r2, r6
...
Function_22483e4: @ 22483e4 :thumb
	...
	add     r2, r1, r0
	str     r2, [r4, #0x4]
	ldr     r0, [pc, #0x20] @ 0x224841c, (=REG_BLDCNT)
	mov     r1, #0x1
	asr     r2, r2, #12
	blx     G2x_SetBlendBrightness_
	pop     {r4,pc}
...
branch_2248406: @ 2248406 :thumb
	ldr     r2, [r4, #0x8]
	ldr     r0, [pc, #0x10] @ 0x224841c, (=REG_BLDCNT)
	mov     r1, #0x1
	asr     r2, r2, #12
	blx     G2x_SetBlendBrightness_
	ldr     r0, [r4, #0x0]
...
Function_2248b84: @ 2248b84 :thumb
	...
	str     r1, [sp, #0x0]
	blx     G3X_SetClearColor
	ldr     r1, [pc, #0x9c] @ 0x2248c7c, (=GFX_FLUSH)
	mov     r0, #0x2
	str     r0, [r1, #0x0]
	...
	mov     r1, r0
	bl      Function_201ff0c
	ldr     r1, [pc, #0x80] @ 0x2248c84, (=REG_BG0CNT)
	mov     r0, #0x3
	ldrh    r2, [r1, #0x0]
	bic     r2, r0
	strh    r2, [r1, #0x0]
...
.word GFX_FLUSH @ 0x2248c7c
.word 0xbfff0000 @ 0x2248c80
.word REG_BG0CNT @ 0x2248c84
...
Function_2249a80: @ 2249a80 :thumb
	...
	str     r1, [sp, #0x0]
	blx     G3X_SetClearColor
	ldr     r1, [pc, #0x90] @ 0x2249b6c, (=GFX_FLUSH)
	mov     r0, #0x2
	str     r0, [r1, #0x0]
	...
	mov     r1, r0
	bl      Function_201ff0c
	ldr     r1, [pc, #0x74] @ 0x2249b74, (=REG_BG0CNT)
	mov     r0, #0x3
	ldrh    r2, [r1, #0x0]
	bic     r2, r0
	strh    r2, [r1, #0x0]
...
.word GFX_FLUSH @ 0x2249b6c
.word 0xbfff0000 @ 0x2249b70
.word REG_BG0CNT @ 0x2249b74
...
Function_224a690: @ 224a690 :thumb
	...
	str     r1, [sp, #0x0]
	blx     G3X_SetClearColor
	ldr     r1, [pc, #0x9c] @ 0x224a788, (=GFX_FLUSH)
	mov     r0, #0x2
	str     r0, [r1, #0x0]
	...
	mov     r1, r0
	bl      Function_201ff0c
	ldr     r1, [pc, #0x80] @ 0x224a790, (=REG_BG0CNT)
	mov     r0, #0x3
	ldrh    r2, [r1, #0x0]
	bic     r2, r0
	strh    r2, [r1, #0x0]
...
.word GFX_FLUSH @ 0x224a788
.word 0xbfff0000 @ 0x224a78c
.word REG_BG0CNT @ 0x224a790
...
Function_224b084: @ 224b084 :thumb
	...
	str     r1, [sp, #0x0]
	blx     G3X_SetClearColor
	ldr     r1, [pc, #0xa0] @ 0x224b180, (=GFX_FLUSH)
	mov     r0, #0x2
	str     r0, [r1, #0x0]
	...
	mov     r1, r0
	bl      Function_201ff0c
	ldr     r1, [pc, #0x84] @ 0x224b188, (=REG_BG0CNT)
	mov     r0, #0x3
	ldrh    r2, [r1, #0x0]
	bic     r2, r0
	strh    r2, [r1, #0x0]
...
.word GFX_FLUSH @ 0x224b180
.word 0xbfff0000 @ 0x224b184
.word REG_BG0CNT @ 0x224b188
...
Function_224b520: @ 224b520 :thumb
	...
	mov     r1, r0
	bl      Function_201ff0c
	ldr     r2, [pc, #0x184] @ 0x224b6e4, (=REG_BG0CNT)
	mov     r0, #0x3
	ldrh    r3, [r2, #0x0]
	mov     r1, #0x1
	bic     r3, r0
	...
	mov     r0, #0x0
	str     r0, [sp, #0x0]
	ldr     r0, [pc, #0x40] @ 0x224b6ec, (=REG_BLDCNT)
	mov     r1, #0x1
	mov     r2, #0x4
	mov     r3, #0x10
	blx     G2x_SetBlendAlpha_
...
.word REG_BG0CNT @ 0x224b6e4
.word 0x224c21c @ 0x224b6e8
.word REG_BLDCNT @ 0x224b6ec
.thumb
...
.thumb
Call_BattleJumpTable: @ 224b990 :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	ldr     r0, [r5, #0xc]
	mov     r4, r1
...
Function_224b9c0: @ 224b9c0 :thumb
	...
	str     r0, [sp, #0x0]
	blx     G3X_SetClearColor
	ldr     r1, [pc, #0x6c] @ 0x224ba74, (=GFX_FLUSH)
	mov     r0, #0x2
	str     r0, [r1, #0x0]
...
Function_224bbb0: @ 224bbb0 :thumb
	...
	bl      AddTaskToTaskList2
	str     r0, [r5, #0x7c]
	ldr     r0, [pc, #0xc] @ 0x224bbfc, (=REG_BLDCNT)
	mov     r1, #0x1
	mov     r2, r6
	blx     G2x_SetBlendBrightness_
.thumb
...
Function_224bc30: @ 224bc30 :thumb
	...
	add     r2, r1, r0
	str     r2, [r4, #0x4]
	ldr     r0, [pc, #0x20] @ 0x224bc68, (=REG_BLDCNT)
	mov     r1, #0x1
	asr     r2, r2, #12
	blx     G2x_SetBlendBrightness_
	pop     {r4,pc}
...
branch_224bc52: @ 224bc52 :thumb
	ldr     r2, [r4, #0x8]
	ldr     r0, [pc, #0x10] @ 0x224bc68, (=REG_BLDCNT)
	mov     r1, #0x1
	asr     r2, r2, #12
	blx     G2x_SetBlendBrightness_
	ldr     r0, [r4, #0x0]

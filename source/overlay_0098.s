...
Function_2246dc0: @ 2246dc0 :thumb
	...
	mov     r0, #0x5b
	bl      Function_201807c
	ldr     r0, [pc, #0x8] @ 0x2246e00, (=OverlayNr77)
	ldr     r1, [pc, #0xc] @ 0x2246e04, (=JumpTable_TitleScreen)
	bl      SetOverlayJumpTableDataToLoad
	mov     r0, #0x1
	pop     {r3-r5,pc}
@ 0x2246e00

.word OverlayNr77 @ 0x2246e00
.word JumpTable_TitleScreen @ 0x2246e04
...
Function_2246f48: @ 2246f48 :thumb
	...
	ldr     r0, [r3, #0x4]
	ldr     r2, [r3, r2]
	ldr     r3, [pc, #0x4] @ 0x2246f58, (=Function_2030d5c+1)
	mov     r1, #0x3
	bx      r3
@ 0x2246f58

.word Function_2030d5c+1 @ 0x2246f58
...
branch_2247338: @ 2247338 :thumb
	...
	mov     r1, #0x1
	bl      Function_201ff74
	ldr     r0, [pc, #0x48] @ 0x22473d0, (=RAM_21bf6dc)
	mov     r1, #0x0
	strb    r1, [r0, #0x5]
	bl      Function_201ffe8
	mov     r0, #0x1
...
branch_22484b8: @ 22484b8 :thumb
	ldr     r1, [pc, #0x1c0] @ 0x224867c, (=RAM_21bf67c)
	add     r0, #0xac
	ldr     r2, [r1, #0x4c]
	ldr     r4, [r0, #0x0]
	mov     r0, #0x40
...
branch_2248566: @ 2248566 :thumb
	ldr     r1, [pc, #0x114] @ 0x224867c, (=RAM_21bf67c)
	mov     r2, #0x10
	ldr     r1, [r1, #0x48]
	tst     r2, r1
	bne     branch_2248576
...
Function_2249438: @ 2249438 :thumb
	push    {r4,lr}
	mov     r4, r0
	ldr     r0, [pc, #0x20] @ 0x2249460, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	tst     r0, r1
	bne     branch_224944c
...
.incbin "./baserom/overlay/overlay_0098.bin", 0x2f0a, 0x2249bac - 0x2249b2a


.globl Unknown_98_2249bac
Unknown_98_2249bac: @ 0x2249bac
.incbin "./baserom/overlay/overlay_0098.bin", 0x2f8c, 0x2249d70 - 0x2249bac

...
.thumb
.globl Function_99_21d0d80
Function_99_21d0d80: @ 21d0d80 :thumb
	push    {r3-r7,lr}
	mov     r5, r0
	mov     r0, #0x0
	mov     r1, r0
	...
	str     r0, [r4, r1]
	ldr     r0, [pc, #0x108] @ 0x21d100c, (=WIN0_X1)
	mov     r1, #0xff
	strh    r1, [r0, #0x0]
	mov     r6, r0
	strh    r2, [r0, #0x4]
	...
	orr     r6, r5
	strh    r6, [r0, #0x0]
	ldr     r0, [pc, #0xe4] @ 0x21d1010, (=SUB_WIN0_X1)
	strh    r1, [r0, #0x0]
	mov     r1, #0x18
	strh    r1, [r0, #0x4]
	mov     r1, r0
	...
	orr     r0, r1
	str     r0, [r3, #0x0]
	ldr     r0, [pc, #0xa4] @ 0x21d1014, (=RAM_21bf6dc)
	mov     r1, #0x1
	strb    r1, [r0, #0x5]
	bl      Function_201ffe8
...
.word WIN0_X1 @ 0x21d100c
.word SUB_WIN0_X1 @ 0x21d1010
.word RAM_21bf6dc @ 0x21d1014
...
.thumb
.globl Function_99_21d1028
Function_99_21d1028: @ 21d1028 :thumb
	push    {r4,r5,lr}
	add     sp, #-0xc
	mov     r5, r1
...
branch_21d1050: @ 21d1050 :thumb
	...
	cmp     r0, #0x0
	beq     branch_21d1094
	ldr     r0, [pc, #0x138] @ 0x21d1194, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x8
	tst     r0, r1
	beq     branch_21d1094
...
.thumb
.globl Function_99_21d11a8
Function_99_21d11a8: @ 21d11a8 :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	bl      LoadOverlayData1c
	mov     r4, r0
...
Function_21d19a0: @ 21d19a0 :thumb
	ldr     r3, [pc, #0x4] @ 0x21d19a8, (=Call_free5+1)
	ldr     r0, [r0, #0x28]
	bx      r3
@ 0x21d19a6

.align 2
.word Call_free5+1 @ 0x21d19a8
...
Function_21d1a4c: @ 21d1a4c :thumb
	ldr     r3, [pc, #0x0] @ 0x21d1a50, (=Function_20242c4+1)
	bx      r3
@ 0x21d1a50

.word Function_20242c4+1 @ 0x21d1a50
.thumb
...
Function_21d214c: @ 21d214c :thumb
	ldr     r3, [pc, #0x4] @ 0x21d2154, (=Function_2019120+1)
	mov     r0, #0x3
	mov     r1, #0x0
	bx      r3
@ 0x21d2154

.word Function_2019120+1 @ 0x21d2154
...
Function_21d2aac: @ 21d2aac :thumb
	...
	mov     r5, r0
	ldr     r4, [r5, #0x8]
	ldr     r0, [pc, #0xf4] @ 0x21d2bac, (=RAM_21bf6dc)
	mov     r1, #0x0
	strb    r1, [r0, #0x5]
	bl      Function_201ffe8
	mov     r1, #0x0
...
branch_21d34b4: @ 21d34b4 :thumb
	...
	cmp     r0, #0x1
	bne     branch_21d3510
	ldr     r0, [pc, #0xb8] @ 0x21d3578, (=REG_BLDCNT)
	mov     r1, #0x0
	mov     r2, #0x3f
	mov     r3, #0x1f
	str     r1, [sp, #0x0]
...
branch_21d374c: @ 21d374c :thumb
	...
	str     r0, [sp, #0x0]
	ldsb    r3, [r4, r3]
	ldr     r0, [pc, #0x28] @ 0x21d37dc, (=REG_BLDCNT)
	mov     r1, #0x0
	blx     G2x_SetBlendAlpha_
	add     sp, #0x4
	pop     {r3-r6,pc}
...
branch_21d38c0: @ 21d38c0 :thumb
	...
	lsl     r0, r0, #8
	orr     r1, r0
	ldr     r0, [pc, #0x58] @ 0x21d392c, (=REG_BLDALPHA)
	strh    r1, [r0, #0x0]
...
Function_21d3cf8: @ 21d3cf8 :thumb
	...
	str     r0, [sp, #0x0]
	ldsb    r3, [r3, r4]
	ldr     r0, [pc, #0x30] @ 0x21d3d4c, (=REG_BLDCNT)
	mov     r2, #0x28
	blx     G2x_SetBlendAlpha_
	mov     r0, #0x3
	mov     r1, #0x1
...
branch_21d3d2c: @ 21d3d2c :thumb
	...
	str     r0, [sp, #0x0]
	ldsb    r3, [r3, r4]
	ldr     r0, [pc, #0x10] @ 0x21d3d4c, (=REG_BLDCNT)
	mov     r2, #0x24
	blx     G2x_SetBlendAlpha_
	mov     r0, #0x2
	mov     r1, #0x1
...
branch_21d3d80: @ 21d3d80 :thumb
	...
	lsl     r3, r3, #8
	orr     r4, r3
	ldr     r3, [pc, #0x4c] @ 0x21d3ddc, (=REG_BLDALPHA)
	strh    r4, [r3, #0x0]
	ldsb    r2, [r0, r2]
	cmp     r2, #0x0
	bne     branch_21d3dd8
...
branch_21d3e16: @ 21d3e16 :thumb
	...
	cmp     r1, r0
	bhi     branch_21d3e38
	ldr     r0, [pc, #0x48] @ 0x21d3e74, (=RAM_21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	tst     r0, r1
	bne     branch_21d3e38

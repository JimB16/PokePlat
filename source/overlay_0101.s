...
.align 2, 0
.thumb
Function_21d0e40: @ 21d0e40 :thumb
	push    {r4,r5,lr}
	add     sp, #-0xc
	mov     r4, r1
	bl      0x200682c
...
.thumb
Function_21d0ee4: @ 21d0ee4 :thumb
	push    {r4-r6,lr}
	mov     r5, r0
	bl      0x200682c
	mov     r6, r0
...
Function_21d0f94: @ 21d0f94 :thumb
	ldr     r3, [pc, #0x0] @ 0x21d0f98, (=0x20181c5)
	bx      r3
@ 0x21d0f98

.word 0x20181c5 @ 0x21d0f98
.thumb
...
Function_21d1884: @ 21d1884 :thumb
	...
	ldr     r3, [pc, #0x8] @ 0x21d1890, (=0x207121d)
	ldr     r0, [r0, r1]
	bx      r3
@ 0x21d188c

.word 0x44c @ 0x21d188c
.word 0x207121d @ 0x21d1890
.thumb
...
Function_21d18e4: @ 21d18e4 :thumb
	...
	ldr     r3, [pc, #0x8] @ 0x21d18f0, (=0x200da59)
	ldr     r0, [r0, r1]
	bx      r3
@ 0x21d18ec

.word 0x434 @ 0x21d18ec
.word 0x200da59 @ 0x21d18f0
.thumb
...
Function_21d19d4: @ 21d19d4 :thumb
	...
	ldr     r3, [pc, #0x8] @ 0x21d19e0, (=0x2006ca9)
	ldr     r0, [r0, r1]
	bx      r3
@ 0x21d19dc

.word 0x438 @ 0x21d19dc
.word 0x2006ca9 @ 0x21d19e0
.thumb
...
Function_21d1cbc: @ 21d1cbc :thumb
	push    {r4,lr}
	ldr     r1, [pc, #0xec] @ 0x21d1dac, (=0x21bf67c)
	mov     r4, r0
	ldr     r2, [r1, #0x48]
	ldr     r1, [r4, #0x7c]
	cmp     r1, #0x1
...
Function_21d22f0: @ 21d22f0 :thumb
	push    {r4,lr}
	ldr     r1, [pc, #0xec] @ 0x21d23e0, (=0x21bf67c)
	mov     r4, r0
	ldr     r2, [r1, #0x48]
	ldr     r1, [r4, #0x7c]
	cmp     r1, #0x1
...
Function_21d2850: @ 21d2850 :thumb
	push    {r4,lr}
	ldr     r1, [pc, #0xf4] @ 0x21d2948, (=0x21bf67c)
	mov     r4, r0
	ldr     r2, [r1, #0x48]
	ldr     r1, [r4, #0x7c]
	cmp     r1, #0x1
...
Function_21d45e8: @ 21d45e8 :thumb
	mov     r1, #0x13
	lsl     r1, r1, #4
	ldr     r3, [pc, #0x4] @ 0x21d45f4, (=0x200da59)
	ldr     r0, [r0, r1]
	bx      r3
@ 0x21d45f2
...
branch_21d46c4: @ 21d46c4 :thumb
	ldr     r1, [pc, #0x44] @ 0x21d470c, (=0x21bf67c)
	mov     r0, #0x3
	ldr     r2, [r1, #0x44]
...
Function_21d4788: @ 21d4788 :thumb
	mov     r1, #0x16
	lsl     r1, r1, #4
	ldr     r3, [pc, #0x4] @ 0x21d4794, (=0x200da59)
	ldr     r0, [r0, r1]
	bx      r3
@ 0x21d4792
...
Function_21d55f8: @ 21d55f8 :thumb
	ldr     r1, [pc, #0x18] @ 0x21d5614, (=0x21bf67c)
	ldr     r1, [r1, #0x48]
	and     r1, r0
	cmp     r1, r0
	bne     branch_21d5606
...
branch_21d72c8: @ 21d72c8 :thumb
	ldr     r0, [r1, #0x8]
	mov     r1, r3
	ldr     r3, [pc, #0x0] @ 0x21d72d0, (=0x2021cad)
	bx      r3
@ 0x21d72d0

.word 0x2021cad @ 0x21d72d0
.thumb
...
branch_21d7454: @ 21d7454 :thumb
	ldr     r0, [r1, #0x8]
	mov     r1, r3
	ldr     r3, [pc, #0x0] @ 0x21d745c, (=0x2021cad)
	bx      r3
@ 0x21d745c

.word 0x2021cad @ 0x21d745c
.thumb

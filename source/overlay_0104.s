...
Function_222dcf4: @ 222dcf4 :thumb
	...
	mov     r1, r2
	mov     r2, r3
	ldr     r3, [pc, #0x4] @ 0x222dd00, (=0x2006aa5)
	bx      r3
@ 0x222dcfe
...
branch_222dea4: @ 222dea4 :thumb
	...
	mov     r0, #0x0
	strb    r0, [r4, #0x1e]
	ldr     r0, [pc, #0x8c] @ 0x222df3c, (=0x20e4c44)
	mov     r1, #0x19
	ldrb    r0, [r0, #0x0]
	strb    r0, [r4, #0x1f]
	ldrh    r0, [r4, #0x0]
...
.thumb
Function_222e63c: @ 222e63c :thumb
	push    {r3-r7,lr}
	mov     r5, r1
	mov     r7, r0
	mov     r0, r5
...
.thumb
Function_222e6a8: @ 222e6a8 :thumb
	push    {r3-r7,lr}
	mov     r1, #0x51
	str     r0, [sp, #0x0]
	ldsb    r0, [r0, r1]
...
.thumb
Function_222e710: @ 222e710 :thumb
	push    {r4,lr}
	mov     r4, r0
	mov     r0, #0x51
	ldsb    r0, [r4, r0]
...
.thumb
Function_222e748: @ 222e748 :thumb
	push    {r3-r7,lr}
	mov     r5, r0
	ldr     r0, [r5, #0x34]
	mov     r6, r1
...
.thumb
Function_222e86c: @ 222e86c :thumb
	push    {r3-r7,lr}
	mov     r5, r0
	add     r0, #0x52
	ldrh    r0, [r0, #0x0]
...
.thumb
Function_222e8c8: @ 222e8c8 :thumb
	push    {r4,lr}
	mov     r4, r0
	mov     r0, r1
	mov     r1, #0x10
...
.thumb
Function_222e8e8: @ 222e8e8 :thumb
	push    {r4,lr}
	mov     r4, r1
	add     r0, #0x24
	mov     r3, #0x8
...
Function_222e924: @ 222e924 :thumb
	ldr     r3, [pc, #0x4] @ 0x222e92c, (=0x209b975)
	ldr     r0, [r0, #0x0]
	bx      r3
@ 0x222e92a
...
Function_222ebcc: @ 222ebcc :thumb
	ldr     r3, [pc, #0x4] @ 0x222ebd4, (=0x20181c5)
	ldr     r0, [r1, #0x0]
	bx      r3
@ 0x222ebd2
...
Function_222ec20: @ 222ec20 :thumb
	...
	bl      0x2019060
	mov     r3, #0x14
	ldr     r0, [pc, #0x14] @ 0x222ec54, (=0x4000050)
	mov     r1, #0x1
	mov     r2, #0x3c
	str     r3, [sp, #0x0]
	blx 0x20bf55c
...
Function_222ec74: @ 222ec74 :thumb
	push    {r3,lr}
	ldr     r0, [pc, #0x10] @ 0x222ec88, (=0x4000050)
	mov     r3, #0x14
	mov     r1, #0x1
	mov     r2, #0x3c
	str     r3, [sp, #0x0]
...
Function_222ecac: @ 222ecac :thumb
	...
	bl      0x2019060
	mov     r3, #0x14
	ldr     r0, [pc, #0xc] @ 0x222ece0, (=0x4000050)
	mov     r1, #0x1
	mov     r2, #0x3c
	str     r3, [sp, #0x0]
	blx 0x20bf55c
...
.thumb
Function_222ece8: @ 222ece8 :thumb
	push    {r4,lr}
	mov     r4, r0
	mov     r0, #0xd9
	lsl     r0, r0, #4
...
.thumb
Function_222ed2c: @ 222ed2c :thumb
	push    {r4,lr}
	mov     r4, r0
	mov     r0, #0xd9
	lsl     r0, r0, #4
...
.thumb
Function_222ed74: @ 222ed74 :thumb
	push    {r4-r6,lr}
	mov     r6, r0
	mov     r0, #0xd9
	mov     r4, r3
...
.thumb
Function_222eddc: @ 222eddc :thumb
	push    {r4-r6,lr}
	mov     r6, r0
	mov     r0, #0xd9
	mov     r4, r3
...
.thumb
Function_222ee38: @ 222ee38 :thumb
	push    {r4-r6,lr}
	mov     r5, r0
	mov     r0, #0xd9
	mov     r4, r3
...
.thumb
Function_222eea8: @ 222eea8 :thumb
	push    {r4-r6,lr}
	mov     r5, r0
	mov     r0, #0xd9
	mov     r4, r3
...
.thumb
Function_222eed8: @ 222eed8 :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	mov     r0, #0x2
	lsl     r0, r0, #8
...
.thumb
Function_222ef30: @ 222ef30 :thumb
	push    {r4-r6,lr}
	mov     r6, r0
...
.thumb
Function_222ef94: @ 222ef94 :thumb
	push    {r4-r6,lr}
	mov     r6, r0
...
.thumb
Function_222f03c: @ 222f03c :thumb
	push    {r3-r7,lr}
	mov     r6, r0
...
.thumb
Function_222f124: @ 222f124 :thumb
	push    {r3-r7,lr}
	mov     r6, r0
...
.thumb
Function_222f1c4: @ 222f1c4 :thumb
	push    {r4-r6,lr}
	mov     r5, r0
...
.thumb
Function_222f210: @ 222f210 :thumb
	push    {r4-r6,lr}
	mov     r5, r0
...
.thumb
Function_222f31c: @ 222f31c :thumb
	push    {r3-r7,lr}
	mov     r5, r0
...
.thumb
Function_222f418: @ 222f418 :thumb
	push    {r4-r6,lr}
	mov     r6, r0
...
.thumb
Function_222f480: @ 222f480 :thumb
	push    {r4-r6,lr}
	mov     r6, r0
...
.thumb
Function_222f530: @ 222f530 :thumb
	push    {r4-r6,lr}
	mov     r6, r0
...
.thumb
Function_222f650: @ 222f650 :thumb
	push    {r3-r7,lr}
	mov     r6, r0
...
.thumb
Function_222f730: @ 222f730 :thumb
	push    {r4-r6,lr}
	mov     r5, r0
...
.thumb
Function_222f7bc: @ 222f7bc :thumb
	push    {r4-r7,lr}
	add     sp, #-0xc
...
.thumb
Function_222f84c: @ 222f84c :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	mov     r0, #0x2
	lsl     r0, r0, #8
...
.thumb
Function_222f8a0: @ 222f8a0 :thumb
	push    {r4-r6,lr}
	mov     r6, r0
...
.thumb
Function_222f908: @ 222f908 :thumb
	push    {r4-r6,lr}
	mov     r6, r0
...
.thumb
Function_222f9c0: @ 222f9c0 :thumb
	push    {r3-r7,lr}
	mov     r6, r0
...
.thumb
Function_222fa5c: @ 222fa5c :thumb
	push    {r4-r6,lr}
	mov     r5, r0
...
.thumb
Function_222faa8: @ 222faa8 :thumb
	push    {r4-r6,lr}
	mov     r5, r0
...
.thumb
Function_222fb34: @ 222fb34 :thumb
	push    {r4-r7,lr}
	add     sp, #-0xc
...
.thumb
Function_222fbc4: @ 222fbc4 :thumb
	push    {r3-r5,lr}
	mov     r5, r0
	mov     r0, #0x2
	lsl     r0, r0, #8
...
Function_2230910: @ 2230910 :thumb
	...
	ldr     r1, [pc, #0x18] @ 0x223094c, (=0x20f2dac)
	str     r0, [sp, #0x0]
	ldr     r0, [r4, #0x0]
	mov     r3, #0x0
	ldr     r0, [r0, #0x0]
...
.word 0x20f2dac @ 0x223094c
.thumb
Function_2230950: @ 2230950 :thumb
	ldr     r3, [pc, #0x0] @ 0x2230954, (=0x208716d)
	bx      r3
@ 0x2230954

.word 0x208716d @ 0x2230954
.thumb
...
Function_2230b50: @ 2230b50 :thumb
	...
	str     r0, [sp, #0x0]
	ldr     r0, [r5, #0x0]
	ldr     r1, [pc, #0x14] @ 0x2230bac, (=0x20ea358)
	ldr     r0, [r0, #0x0]
	mov     r2, r6
	mov     r3, #0x1
	bl      0x209b988
...
Function_2232960: @ 2232960 :thumb
	ldr     r3, [pc, #0x4] @ 0x2232968, (=0x2001505)
	mov     r1, #0x13
	bx      r3
@ 0x2232966
...
Function_22330f0: @ 22330f0 :thumb
	ldr     r3, [pc, #0x4] @ 0x22330f8, (=0x200d0f5)
	mov     r0, r1
	bx      r3
@ 0x22330f6
...
Function_22331e8: @ 22331e8 :thumb
	...
	cmp     r0, #0x1
	bne     branch_2233252
	ldr     r2, [pc, #0x74] @ 0x2233274, (=0x4000048)
	mov     r1, #0x3f
	ldrh    r3, [r2, #0x0]
	mov     r0, #0xf
	mov     r5, #0x20
...
Function_22333b4: @ 22333b4 :thumb
	...
	str     r3, [sp, #0x0]
	ldr     r0, [r5, #0x0]
	ldr     r1, [pc, #0x10] @ 0x22333f4, (=0x20ea358)
	ldr     r0, [r0, #0x0]
	bl      0x209b988
	mov     r0, #0x1
	add     sp, #0x4
...
Function_22349b8: @ 22349b8 :thumb
	...
	str     r3, [sp, #0x0]
	ldr     r0, [r5, #0x0]
	ldr     r1, [pc, #0x10] @ 0x2234a04, (=0x20ea358)
	ldr     r0, [r0, #0x0]
	mov     r2, r6
	bl      0x209b988
	mov     r0, #0x1
...
Function_2235aac: @ 2235aac :thumb
	...
	str     r3, [sp, #0x0]
	ldr     r0, [r5, #0x0]
	ldr     r1, [pc, #0xc] @ 0x2235ae4, (=0x20ea358)
	ldr     r0, [r0, #0x0]
	bl      0x209b988
	mov     r0, #0x1
	add     sp, #0x4
...
Function_22375f8: @ 22375f8 :thumb
	...
	str     r3, [sp, #0x0]
	ldr     r0, [r5, #0x0]
	ldr     r1, [pc, #0xc] @ 0x2237630, (=0x20ea358)
	ldr     r0, [r0, #0x0]
	bl      0x209b988
	mov     r0, #0x1
	add     sp, #0x4
...
Function_2239314: @ 2239314 :thumb
	...
	str     r3, [sp, #0x0]
	ldr     r0, [r5, #0x0]
	ldr     r1, [pc, #0x10] @ 0x2239360, (=0x20ea358)
	ldr     r0, [r0, #0x0]
	mov     r2, r6
	bl      0x209b988
	mov     r0, #0x1
...
branch_2239f20: @ 2239f20 :thumb
	...
	str     r3, [sp, #0x0]
	add     r5, #0xa8
	ldr     r1, [pc, #0xc] @ 0x2239f34, (=0x20f1e88)
	ldr     r2, [r5, #0x0]
	mov     r0, r6
	bl      0x209b988
	add     sp, #0x4
...
Function_2239fb0: @ 2239fb0 :thumb
	...
	str     r3, [sp, #0x0]
	add     r4, #0xac
	ldr     r1, [pc, #0x10] @ 0x223a08c, (=0x20f410c)
	ldr     r2, [r4, #0x0]
	mov     r0, r5
	bl      0x209b988
	pop     {r3-r5,pc}
...
branch_223a4e2: @ 223a4e2 :thumb
	...
	mov     r0, #0x0
	strb    r0, [r5, #0x1e]
	ldr     r0, [pc, #0x8c] @ 0x223a57c, (=0x20e4c44)
	mov     r1, #0x19
	ldrb    r0, [r0, #0x0]
	strb    r0, [r5, #0x1f]
	ldrh    r0, [r5, #0x0]
...
.thumb
Function_223c4cc: @ 223c4cc :thumb
	push    {r4,lr}
	mov     r4, r0
	ldr     r0, [r4, #0x8]
	bl      0x209b970
	...
	lsl     r2, r2, #8
	blx 0x20c4af0
	ldr     r0, [pc, #0x24] @ 0x223c62c, (=0x4000050)
	mov     r1, #0x0
	strh    r1, [r0, #0x0]
...
Function_223cfec: @ 223cfec :thumb
	ldr     r3, [pc, #0x0] @ 0x223cff0, (=0x20242c5)
	bx      r3
@ 0x223cff0

.word 0x20242c5 @ 0x223cff0
.thumb
...
Function_223d858: @ 223d858 :thumb
	ldr     r3, [pc, #0x0] @ 0x223d85c, (=0x200d0f5)
	bx      r3
@ 0x223d85c

.word 0x200d0f5 @ 0x223d85c
.thumb
...
Function_223d9e4: @ 223d9e4 :thumb
	...
	mov     r0, #0x9
	str     r0, [sp, #0x0]
	ldr     r0, [pc, #0x10] @ 0x223da24, (=0x4000050)
	mov     r1, #0x4
	mov     r2, #0x1f
	mov     r3, #0x8
	blx 0x20bf55c
...
Function_223dd5c: @ 223dd5c :thumb
	...
	orr     r3, r4
	orr     r5, r6
	ldr     r6, [pc, #0x2c] @ 0x223ddb0, (=0x4000040)
	strh    r5, [r6, #0x0]
	strh    r3, [r6, #0x4]
	add     r3, r1, #0x4
	ldrb    r5, [r0, r3]
...
Function_223e9cc: @ 223e9cc :thumb
	...
	cmp     r0, #0x1
	bne     branch_223e9da
	ldr     r0, [pc, #0x10] @ 0x223e9e4, (=0x400006c)
	blx 0x20bdec4
	pop     {r3,pc}
@ 0x223e9da
...
branch_223e9da: @ 223e9da :thumb
	ldr     r0, [pc, #0xc] @ 0x223e9e8, (=0x400106c)
	blx 0x20bdec4
	pop     {r3,pc}
@ 0x223e9e2
...
.word 0x400006c @ 0x223e9e4
.word 0x400106c @ 0x223e9e8
.thumb
...
Function_223ea7c: @ 223ea7c :thumb
	ldr     r3, [pc, #0x0] @ 0x223ea80, (=0x20181c5)
	bx      r3
@ 0x223ea80

.word 0x20181c5 @ 0x223ea80
.thumb
...
Function_223f05c: @ 223f05c :thumb
	ldr     r3, [pc, #0x8] @ 0x223f068, (=0x200da05)
	mov     r2, #0x1
	mov     r1, r0

...
branch_2242720: @ 2242720 :thumb
	...
	ldr     r0, [r4, r0]
	bl      Function_2246080
	ldr     r0, [pc, #0x230] @ 0x224295c, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x30
	tst     r0, r1
	beq     branch_2242758
...
branch_2242758: @ 2242758 :thumb
	ldr     r0, [pc, #0x200] @ 0x224295c, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	tst     r0, r1
	beq     branch_22427a2
...
branch_224290c: @ 224290c :thumb
	...
	mov     r1, #0x5
	lsl     r1, r1, #6
	ldr     r0, [pc, #0x40] @ 0x2242968, (=0x20f410c)
	ldr     r1, [r4, r1]
	mov     r2, #0x5d
...
.word 0x21bf67c @ 0x224295c
.word 0x5dc @ 0x2242960
.word 0x2246308 @ 0x2242964
.word 0x20f410c @ 0x2242968
.thumb
...
branch_2243502: @ 2243502 :thumb
	...
	ldr     r0, [r4, r0]
	bl      Function_2246080
	ldr     r0, [pc, #0x218] @ 0x2243728, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0xf0
	tst     r0, r1
	beq     branch_224353a
...
branch_224353a: @ 224353a :thumb
	ldr     r0, [pc, #0x1ec] @ 0x2243728, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	tst     r0, r1
	beq     branch_22435a4
...
branch_22436d8: @ 22436d8 :thumb
	...
	mov     r1, #0x5
	lsl     r1, r1, #6
	ldr     r0, [pc, #0x40] @ 0x2243734, (=0x20f410c)
	ldr     r1, [r4, r1]
	mov     r2, #0x5d
	bl      AllocAndInitOverlayData
	str     r0, [r4, #0x4]
...
.word 0x21bf67c @ 0x2243728
.word 0x5dc @ 0x224372c
.word 0x2246308 @ 0x2243730
.word 0x20f410c @ 0x2243734
.thumb
...
branch_2243b58: @ 2243b58 :thumb
	...
	ldr     r0, [r4, r0]
	bl      Function_2246080
	ldr     r0, [pc, #0x1b0] @ 0x2243d14, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0xc0
	tst     r0, r1
	beq     branch_2243b90
...
branch_2243b90: @ 2243b90 :thumb
	ldr     r0, [pc, #0x180] @ 0x2243d14, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x30
	tst     r0, r1
	beq     branch_2243bbe
...
branch_2243bbe: @ 2243bbe :thumb
	ldr     r0, [pc, #0x154] @ 0x2243d14, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	tst     r0, r1
	beq     branch_2243c50
...
Function_2244f00: @ 2244f00 :thumb
	ldr     r3, [pc, #0x4] @ 0x2244f08, (=0x200b539)
	ldr     r0, [r0, #0x20]
	bx      r3
@ 0x2244f06

.align 2
.word 0x200b539 @ 0x2244f08
...
.thumb
Function_224569c: @ 224569c :thumb
	push    {r4,lr}
	mov     r4, r0
	bl      Function_203608c
	cmp     r4, r0
...
.thumb
Function_2245744: @ 2245744 :thumb
	push    {r3-r7,lr}
	mov     r5, r3
	mov     r7, r0
	ldrb    r0, [r5, #0x9]
...
Function_22457b8: @ 22457b8 :thumb
	ldr     r3, [pc, #0x0] @ 0x22457bc, (=0x2022975)
	bx      r3
@ 0x22457bc

.word 0x2022975 @ 0x22457bc
.thumb
...
.thumb
Function_22458a4: @ 22458a4 :thumb
	push    {r4-r6,lr}
	mov     r6, r0
...
Function_2245d50: @ 2245d50 :thumb
	...
	mov     r0, r4
	bl      Function_2007768
	ldr     r0, [pc, #0x8] @ 0x2245d84, (=0x4000540)
	mov     r1, #0x1
	str     r1, [r0, #0x0]
	pop     {r4,pc}
@ 0x2245d80
...
Function_2245db8: @ 2245db8 :thumb
	ldr     r3, [pc, #0x4] @ 0x2245dc0, (=0x2007ded)
	mov     r2, r1
	mov     r1, #0x23
	bx      r3
@ 0x2245dc0

.word 0x2007ded @ 0x2245dc0
.thumb
...
Function_2245e48: @ 2245e48 :thumb
	ldr     r3, [pc, #0x4] @ 0x2245e50, (=0x2021fd1)
	ldr     r0, [r0, #0x8]
	bx      r3
@ 0x2245e4e
...
Function_2245ebc: @ 2245ebc :thumb
	ldr     r3, [pc, #0x4] @ 0x2245ec4, (=0x2021cad)
	ldr     r0, [r0, #0xc]
	bx      r3
@ 0x2245ec2
...
Function_2245f2c: @ 2245f2c :thumb
	ldr     r3, [pc, #0x4] @ 0x2245f34, (=0x2021d29)
	ldr     r0, [r0, #0xc]
	bx      r3
@ 0x2245f32
...
Function_2245fac: @ 2245fac :thumb
	ldr     r3, [pc, #0x4] @ 0x2245fb4, (=0x2021e91)
	ldr     r0, [r0, #0xc]
	bx      r3
@ 0x2245fb2
...
Function_2246074: @ 2246074 :thumb
	ldr     r3, [pc, #0x4] @ 0x224607c, (=0x2021cad)
	ldr     r0, [r0, #0xc]
	bx      r3
@ 0x224607a
...
branch_224608e: @ 224608e :thumb
	ldr     r0, [pc, #0x10c] @ 0x224619c, (=0x21bf67c)
	ldr     r0, [r0, #0x48]
	cmp     r0, #0x0
	beq     branch_2246196
	ldrb    r1, [r4, #0x1]

...
branch_22420be: @ 22420be :thumb
	...
	mov     r1, r4
	add     r1, #0xbc
	ldr     r0, [pc, #0x2c] @ 0x2242104, (=0x20f410c)
	ldr     r1, [r1, #0x0]
	mov     r2, #0x62
	bl      0x20067e8
	str     r0, [r4, #0x4]
...
.thumb
Function_2243130: @ 2243130 :thumb
	push    {r4,lr}
	mov     r4, r0
	bl      Function_203608c
	cmp     r4, r0
...
.thumb
Function_2243180: @ 2243180 :thumb
	push    {r4-r6,lr}
	mov     r4, r3
	mov     r6, r0
	ldrb    r0, [r4, #0x16]
...
.thumb
Function_22431e0: @ 22431e0 :thumb
	push    {r4-r6,lr}
	mov     r5, r0
	mov     r4, r2
	mov     r6, r3
...
Function_2243664: @ 2243664 :thumb
	ldr     r3, [pc, #0x4] @ 0x224366c, (=0x2021cad)
	ldr     r0, [r0, #0x10]
	bx      r3
@ 0x224366a

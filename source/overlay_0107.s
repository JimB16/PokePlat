...
branch_2241f66: @ 2241f66 :thumb
	ldr     r1, [pc, #0x358] @ 0x22422c0, (=0x21bf67c)
	ldr     r1, [r1, #0x48]
	bl      Function_2244bd8
	ldr     r0, [pc, #0x350] @ 0x22422c0, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	tst     r0, r1
	beq     branch_2241fa0
...
branch_2242090: @ 2242090 :thumb
	...
	add     r1, #0x16
	bl      0x20014d0
	ldr     r0, [pc, #0x220] @ 0x22422c0, (=0x21bf67c)
	mov     r1, #0x40
	ldr     r2, [r0, #0x48]
	mov     r0, r2
	tst     r0, r1
...
branch_2242592: @ 2242592 :thumb
	ldr     r0, [pc, #0xe4] @ 0x2242678, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_224262a
...
branch_22425c2: @ 22425c2 :thumb
	ldr     r0, [pc, #0xb4] @ 0x2242678, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_224262a
...
branch_2242a3a: @ 2242a3a :thumb
	ldr     r0, [pc, #0x220] @ 0x2242c5c, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_2242af2
...
branch_2242a6a: @ 2242a6a :thumb
	ldr     r0, [pc, #0x1f0] @ 0x2242c5c, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_2242af2
...
branch_2242a8e: @ 2242a8e :thumb
	ldr     r0, [pc, #0x1cc] @ 0x2242c5c, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_2242af2
...
branch_2242aaa: @ 2242aaa :thumb
	ldr     r0, [pc, #0x1b0] @ 0x2242c5c, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_2242af2
...
branch_2242bb2: @ 2242bb2 :thumb
	ldr     r0, [pc, #0xa8] @ 0x2242c5c, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_2242c54
...
branch_2242bd6: @ 2242bd6 :thumb
	ldr     r1, [pc, #0x84] @ 0x2242c5c, (=0x21bf67c)
	ldr     r2, [r1, #0x48]
	mov     r1, #0x20
	mov     r3, r2
	tst     r3, r1
...
branch_2242c16: @ 2242c16 :thumb
	ldr     r1, [pc, #0x44] @ 0x2242c5c, (=0x21bf67c)
	ldr     r2, [r1, #0x48]
	mov     r1, #0x20
	mov     r3, r2
	tst     r3, r1
...
Function_2244a8c: @ 2244a8c :thumb
	ldr     r3, [pc, #0x4] @ 0x2244a94, (=0x200b539)
	ldr     r0, [r0, #0x24]
	bx      r3
@ 0x2244a92
...
Function_2244bd8: @ 2244bd8 :thumb
	...
	mov     r4, #0x0
	bl      Function_2249c98
	ldr     r1, [pc, #0x84] @ 0x2244c6c, (=0x21bf67c)
	ldr     r2, [r1, #0x48]
	mov     r1, #0x20
	tst     r1, r2
	beq     branch_2244c0a
...
branch_2244c0a: @ 2244c0a :thumb
	ldr     r1, [pc, #0x60] @ 0x2244c6c, (=0x21bf67c)
	ldr     r2, [r1, #0x48]
	mov     r1, #0x10
	tst     r1, r2
	beq     branch_2244c2e
...
branch_2244c2e: @ 2244c2e :thumb
	ldr     r0, [pc, #0x3c] @ 0x2244c6c, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x40
	tst     r0, r1
	beq     branch_2244c46
...
branch_2244c46: @ 2244c46 :thumb
	ldr     r0, [pc, #0x24] @ 0x2244c6c, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x80
	tst     r0, r1
	beq     branch_2244c60
...
.thumb
Function_2245338: @ 2245338 :thumb
	push    {r4-r6,lr}
	mov     r4, r3
	mov     r5, r0
	ldrb    r0, [r4, #0xf]
...
.thumb
Function_22453a0: @ 22453a0 :thumb
	push    {r4-r6,lr}
	mov     r4, r3
	mov     r6, r0
	ldrb    r0, [r4, #0xf]
...
.thumb
Function_2245408: @ 2245408 :thumb
	push    {r4-r6,lr}
	mov     r5, r0
	mov     r6, r2
	mov     r4, r3
...
branch_2246366: @ 2246366 :thumb
	ldr     r1, [pc, #0x2fc] @ 0x2246664, (=0x21bf67c)
	ldr     r1, [r1, #0x48]
	bl      Function_2248358
	ldr     r0, [pc, #0x2f4] @ 0x2246664, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x1
	tst     r0, r1
	beq     branch_224639e
...
branch_2246aa2: @ 2246aa2 :thumb
	ldr     r1, [pc, #0xc] @ 0x2246ab0, (=0x21bf67c)
	b       branch_2246ab4
@ 0x2246aa6
...
branch_2246b12: @ 2246b12 :thumb
	ldr     r0, [pc, #0xc0] @ 0x2246bd4, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_2246bd0
...
branch_2246b2e: @ 2246b2e :thumb
	ldr     r0, [pc, #0xa4] @ 0x2246bd4, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_2246bd0
...
branch_2246b52: @ 2246b52 :thumb
	ldr     r1, [pc, #0x80] @ 0x2246bd4, (=0x21bf67c)
	ldr     r2, [r1, #0x48]
	mov     r1, #0x20
	mov     r3, r2
	tst     r3, r1
...
branch_2246b92: @ 2246b92 :thumb
	ldr     r1, [pc, #0x40] @ 0x2246bd4, (=0x21bf67c)
	ldr     r2, [r1, #0x48]
	mov     r1, #0x20
	mov     r3, r2
	tst     r3, r1
...
Function_2248104: @ 2248104 :thumb
	ldr     r3, [pc, #0x4] @ 0x224810c, (=0x200b539)
	ldr     r0, [r0, #0x24]
	bx      r3
@ 0x224810a
...
Function_2248358: @ 2248358 :thumb
	...
	mov     r4, #0x0
	bl      Function_2249c98
	ldr     r1, [pc, #0x84] @ 0x22483ec, (=0x21bf67c)
	ldr     r2, [r1, #0x48]
	mov     r1, #0x20
	tst     r1, r2
	beq     branch_224838a
...
branch_224838a: @ 224838a :thumb
	ldr     r1, [pc, #0x60] @ 0x22483ec, (=0x21bf67c)
	ldr     r2, [r1, #0x48]
	mov     r1, #0x10
	tst     r1, r2
	beq     branch_22483ae
...
branch_22483ae: @ 22483ae :thumb
	ldr     r0, [pc, #0x3c] @ 0x22483ec, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x40
	tst     r0, r1
	beq     branch_22483c6
...
branch_22483c6: @ 22483c6 :thumb
	ldr     r0, [pc, #0x24] @ 0x22483ec, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x80
	tst     r0, r1
	beq     branch_22483e0
...
branch_22485dc: @ 22485dc :thumb
	...
	cmp     r0, #0x0
	bne     branch_224860c
	ldr     r0, [pc, #0x84] @ 0x224866c, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_2248666
...
branch_224861a: @ 224861a :thumb
	...
	cmp     r0, #0x0
	bne     branch_224864a
	ldr     r0, [pc, #0x44] @ 0x224866c, (=0x21bf67c)
	ldr     r1, [r0, #0x48]
	mov     r0, #0x3
	tst     r0, r1
	beq     branch_2248666
...
.thumb
Function_2248910: @ 2248910 :thumb
	push    {r4-r6,lr}
	mov     r4, r3
	mov     r5, r0
	ldrb    r0, [r4, #0x17]
...
.thumb
Function_2248978: @ 2248978 :thumb
	push    {r4-r6,lr}
	mov     r4, r3
	mov     r6, r0
	ldrb    r0, [r4, #0x17]
...
.thumb
Function_22489e0: @ 22489e0 :thumb
	push    {r4-r6,lr}
	mov     r5, r0
	mov     r6, r2
	mov     r4, r3
...
.thumb
Function_2248a10: @ 2248a10 :thumb
	push    {r4-r6,lr}
	mov     r5, r0
	mov     r4, r2
	mov     r6, r3
...
Function_2249bac: @ 2249bac :thumb
	ldr     r3, [pc, #0x4] @ 0x2249bb4, (=0x2021cad)
	ldr     r0, [r0, #0x4]
	bx      r3
@ 0x2249bb2
...
Function_2249c40: @ 2249c40 :thumb
	ldr     r3, [pc, #0x4] @ 0x2249c48, (=0x2021fd1)
	ldr     r0, [r0, #0x4]
	bx      r3
@ 0x2249c46
...
.word 0x2021fd1 @ 0x2249c48
.thumb
Function_2249c4c: @ 2249c4c :thumb
	ldr     r3, [pc, #0x4] @ 0x2249c54, (=0x2021e81)
	ldr     r0, [r0, #0x4]
	bx      r3
@ 0x2249c52

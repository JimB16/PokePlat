...
branch_224207c: @ 224207c :thumb
	ldr     r1, [pc, #0x80] @ 0x2242100, (=0x21bf67c)
	ldr     r1, [r1, #0x48]
	bl      Function_2242964
	bl      0x203608c
	cmp     r0, #0x0
...
.thumb
Function_2242ab0: @ 2242ab0 :thumb
	push    {r4-r6,lr}
	mov     r4, r3
	mov     r6, r0
	ldrb    r0, [r4, #0xf]
...
Function_2242b1c: @ 2242b1c :thumb
	ldr     r3, [pc, #0x0] @ 0x2242b20, (=0x201d2e9)
	bx      r3
@ 0x2242b20

.word 0x201d2e9 @ 0x2242b20
.thumb
Function_2242b24: @ 2242b24 :thumb
	push    {r4-r6,lr}
	mov     r4, r3
	mov     r6, r0
	ldrb    r0, [r4, #0xf]
...
.thumb
Function_2242b84: @ 2242b84 :thumb
	push    {r4-r6,lr}
	mov     r5, r0
	mov     r4, r2
	mov     r6, r3
...
Function_22435a8: @ 22435a8 :thumb
	ldr     r3, [pc, #0x4] @ 0x22435b0, (=0x2021cad)
	ldr     r0, [r0, #0x10]
	bx      r3
@ 0x22435ae
...
Function_2243624: @ 2243624 :thumb
	ldr     r3, [pc, #0x4] @ 0x224362c, (=0x2021cc9)
	ldr     r0, [r0, #0x10]
	bx      r3
@ 0x224362a

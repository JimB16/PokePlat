...
Function_225ca14: @ 225ca14 :thumb
	ldr     r3, [pc, #0x4] @ 0x225ca1c, (=Function_20219f8+1)
	ldr     r0, [r0, #0x4]
	bx      r3
@ 0x225ca1a
...
.word Function_20219f8+1 @ 0x225ca1c
.thumb
...
Function_225ca34: @ 225ca34 :thumb
	...
	bl      Function_2018340
	str     r0, [r5, #0x0]
	ldr     r0, [pc, #0x108] @ 0x225cb54, (=RAM_21bf6dc)
	mov     r1, #0x0
	strb    r1, [r0, #0x5]
	bl      Function_201ffe8
	mov     r0, #0x0
...
branch_225cb68: @ 225cb68 :thumb
	...
	ldr     r0, [r6, #0x0]
	bl      free
	ldr     r0, [pc, #0x10] @ 0x225cb94, (=RAM_21bf6dc)
	mov     r1, #0x0
	strb    r1, [r0, #0x5]
	bl      Function_201ffe8
	pop     {r4-r6,pc}
...
Function_225cc84: @ 225cc84 :thumb
	ldr     r3, [pc, #0x4] @ 0x225cc8c, (=free+1)
	ldr     r0, [r0, #0x0]
	bx      r3
@ 0x225cc8a

.align 2
.word free+1 @ 0x225cc8c

...
branch_225c94a: @ 225c94a :thumb
	...
	mov     r1, #0x1
	bl      0x201ff74
	ldr     r0, [pc, #0x78] @ 0x225c9f4, (=0x21bf6dc)
	mov     r1, #0x1
	strb    r1, [r0, #0x5]
	bl      0x201ffe8
	bl      0x201ffd0
...
Function_225da9c: @ 225da9c :thumb
	ldr     r3, [pc, #0x4] @ 0x225daa4, (=0x20203b9)
	add     r0, #0xcc
	ldr     r0, [r0, #0x0]
	bx      r3
@ 0x225daa4

.word 0x20203b9 @ 0x225daa4
.thumb
...
Function_225dafc: @ 225dafc :thumb
	ldr     r3, [pc, #0x4] @ 0x225db04, (=0x2017111)
	add     r0, #0xd8
	bx      r3
@ 0x225db02
...
Function_225dd0c: @ 225dd0c :thumb
	ldr     r3, [pc, #0x0] @ 0x225dd10, (=0x20242c5)
	bx      r3
@ 0x225dd10

.word 0x20242c5 @ 0x225dd10
.thumb
...
Function_225e368: @ 225e368 :thumb
	ldr     r3, [pc, #0x4] @ 0x225e370, (=0x20c4cf4)
	mov     r1, #0x0
	ldr     r2, [pc, #0x4] @ 0x225e374, (=0x744)
	bx      r3
@ 0x225e370

.word 0x20c4cf4 @ 0x225e370

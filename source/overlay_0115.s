...
.thumb
.globl Function_115_2260440
Function_115_2260440: @ 2260440 :thumb
	push    {r3-r5,lr}
	mov     r4, r0
...
.align 2, 0
.thumb
.globl Function_115_226048c
Function_115_226048c: @ 226048c :thumb
	push    {r4-r6,lr}
	add     sp, #-0x28
	mov     r6, r0
	mov     r5, r1
...
branch_226056a: @ 226056a :thumb
	ldr     r0, [pc, #0x2cc] @ 0x2260838, (=RAM_21bf67c)
	ldr     r1, [r0, #0x44]
	mov     r0, #0x1
	tst     r0, r1
	beq     branch_2260576
...
.thumb
.globl Function_115_22608e4
Function_115_22608e4: @ 22608e4 :thumb
	push    {r3-r7,lr}
	mov     r5, r0
	mov     r4, r1
	bl      LoadOverlayData1c
...
Function_22617d8: @ 22617d8 :thumb
	ldr     r3, [pc, #0x8] @ 0x22617e4, (=Function_2021cac+1)
	lsl     r1, r1, #2
	ldr     r0, [r0, r1]
	mov     r1, #0x0
	bx      r3
...
.word Function_2021cac+1 @ 0x22617e4
.thumb
...
Function_2261a04: @ 2261a04 :thumb
	ldr     r3, [pc, #0x4] @ 0x2261a0c, (=Function_201a8fc+1)
	add     r0, #0xc
	bx      r3
@ 0x2261a0a
...
.word Function_201a8fc+1 @ 0x2261a0c
.thumb
...
Function_2261c1c: @ 2261c1c :thumb
	...
	lsl     r2, r0, #1
	lsl     r1, r2, #1
	ldr     r3, [pc, #0x10] @ 0x2261c44, (=Unknown_20f983c)
	.hword  0x1c52 @ add r2, r2, #0x1
	lsl     r2, r2, #1
	add     r4, #0xc
	ldsh    r1, [r3, r1]
...
.word Unknown_20f983c @ 0x2261c44
.thumb
Function_2261c48: @ 2261c48 :thumb
	...
	lsl     r2, r0, #1
	lsl     r1, r2, #1
	ldr     r3, [pc, #0x114] @ 0x2261d7c, (=Unknown_20f983c)
	.hword  0x1c52 @ add r2, r2, #0x1
	lsl     r2, r2, #1
	mov     r0, r5
	ldsh    r1, [r3, r1]
...
.word Unknown_20f983c @ 0x2261d7c
...
Function_2262974: @ 2262974 :thumb
	push    {r3,lr}
	ldr     r1, [pc, #0x14] @ 0x226298c, (=RAM_21bf6bc)
	ldrh    r1, [r1, #0x22]
	cmp     r1, #0x0
	bne     branch_2262984
	bl      Function_2262990
...
branch_2262c28: @ 2262c28 :thumb
	ldr     r0, [pc, #0x30] @ 0x2262c5c, (=RAM_21bf6bc)
	mov     r3, sp
	ldrh    r2, [r0, #0x1c]
	add     r1, sp, #0x0
	.hword  0x1f1b @ sub r3, r3, #0x4
...
branch_2262c6c: @ 2262c6c :thumb
	ldr     r1, [pc, #0x2c] @ 0x2262c9c, (=RAM_21bf6bc)
	mov     r0, #0x80
	ldrh    r2, [r1, #0x1c]
	ldrh    r1, [r1, #0x1e]
	sub     r3, r0, r2
...
Function_2263130: @ 2263130 :thumb
	...
	add     r2, #0x39
	strb    r3, [r2, #0x0]
	ldr     r3, [pc, #0x4] @ 0x226314c, (=Function_2021cac+1)
	ldr     r0, [r0, #0x34]
	bx      r3
@ 0x226314c

.word Function_2021cac+1 @ 0x226314c
.thumb
...
Function_2263560: @ 2263560 :thumb
	...
	mov     r1, #0x0
	strh    r1, [r0, #0x0]
	ldr     r0, [pc, #0x30] @ 0x226363c, (=REG_BLDCNT_SUB)
	strh    r1, [r0, #0x0]
	pop     {r4,pc}
@ 0x226360e
...
Function_2263cc0: @ 2263cc0 :thumb
	mov     r1, #0x19
	lsl     r1, r1, #4
	ldr     r3, [pc, #0x4] @ 0x2263ccc, (=Call_free5+1)
	ldr     r0, [r0, r1]
	bx      r3
@ 0x2263cca
...
.word Call_free5+1 @ 0x2263ccc
.thumb
Function_2263cd0: @ 2263cd0 :thumb
	ldr     r3, [pc, #0x0] @ 0x2263cd4, (=Function_20203ec+1)
	bx      r3
@ 0x2263cd4

.word Function_20203ec+1 @ 0x2263cd4
.thumb
...
Function_2264214: @ 2264214 :thumb
	...
	mul     r0, r2
	add     r0, r3, r0
	ldr     r3, [pc, #0x0] @ 0x2264228, (=Function_2017204+1)
	bx      r3
@ 0x2264228

.word Function_2017204+1 @ 0x2264228
...
Function_2264354: @ 2264354 :thumb
	...
	add     r0, r0, r2
	ldrh    r0, [r1, r0]
	ldr     r3, [pc, #0x24] @ 0x2264398, (=Unknown_20f983c)
	asr     r0, r0, #4
	lsl     r2, r0, #1
	lsl     r1, r2, #1
	.hword  0x1c52 @ add r2, r2, #0x1
...
.word Unknown_20f983c @ 0x2264398
.thumb
Function_226439c: @ 226439c :thumb
	...
	add     r0, r0, r2
	ldrh    r0, [r1, r0]
	ldr     r3, [pc, #0x2c] @ 0x22643e8, (=Unknown_20f983c)
	asr     r0, r0, #4
	lsl     r2, r0, #1
	lsl     r1, r2, #1
	.hword  0x1c52 @ add r2, r2, #0x1
...
.word Unknown_20f983c @ 0x22643e8
.thumb
...
Function_2264a54: @ 2264a54 :thumb
	...
	lsr     r6, r0, #4
	asr     r7, r6, #31
	ldr     r0, [pc, #0xa0] @ 0x2264b38, (=Unknown_20f983c)
	lsl     r1, r4, #1
	ldsh    r0, [r0, r1]
	mov     r2, r6
	mov     r3, r7
	...
	add     r0, r4, #0x1
	lsl     r1, r0, #1
	ldr     r0, [pc, #0x74] @ 0x2264b38, (=Unknown_20f983c)
	mov     r2, r6
	ldsh    r0, [r0, r1]
	mov     r3, r7
	asr     r1, r0, #31
...
.word Unknown_20f983c @ 0x2264b38
...
Function_2264ba0: @ 2264ba0 :thumb
	ldr     r3, [pc, #0x4] @ 0x2264ba8, (=Function_2021bd4+1)
	ldr     r0, [r0, #0x4]
	bx      r3
@ 0x2264ba6
...
.word Function_2021bd4+1 @ 0x2264ba8
.thumb
...
Function_2264bc0: @ 2264bc0 :thumb
	...
	cmp     r1, #0x0
	beq     branch_2264bd2
	ldr     r2, [pc, #0x8] @ 0x2264bd4, (=RAM_21bf6bc)
	ldrh    r1, [r2, #0x1c]
	ldrh    r2, [r2, #0x1e]
	bl      Function_2264bd8
.thumb
...
branch_22652fe: @ 22652fe :thumb
	...
	mov     r1, r3
	lsl     r1, r2
	ldr     r0, [pc, #0x9c] @ 0x22653c8, (=REG_BLDCNT_SUB)
	mov     r2, #0x8
	mov     r3, #0x0
...
branch_2265354: @ 2265354 :thumb
	...
	orr     r4, r2
	mov     r2, #0x8
	ldr     r0, [pc, #0x4c] @ 0x22653c8, (=REG_BLDCNT_SUB)
	orr     r2, r4
	blx     G2x_SetBlendAlpha_
	add     sp, #0x4
	pop     {r3-r6,pc}
...
branch_2265386: @ 2265386 :thumb
	...
	blt     branch_226539a
	mov     r1, #0x0
	ldr     r0, [pc, #0x34] @ 0x22653c8, (=REG_BLDCNT_SUB)
	strh    r1, [r4, #0x0]
	strh    r1, [r0, #0x0]
	add     sp, #0x4
	pop     {r3-r6,pc}
...
branch_226539a: @ 226539a :thumb
	...
	ldsh    r2, [r4, r1]
	mov     r1, r5
	ldr     r0, [pc, #0xc] @ 0x22653c8, (=REG_BLDCNT_SUB)
	lsl     r1, r2
	mov     r2, #0x8
	blx     G2x_SetBlendAlpha_
.thumb
...
Function_22658e0: @ 22658e0 :thumb
	...
	strb    r1, [r0, #0x2]
	strb    r2, [r0, #0x3]
	ldr     r3, [pc, #0x4] @ 0x22658f0, (=Function_2005748+1)
	ldr     r0, [pc, #0x4] @ 0x22658f4, (=0x56e)
	bx      r3
@ 0x22658f0

.word Function_2005748+1 @ 0x22658f0
...
Function_2265a08: @ 2265a08 :thumb
	mov     r0, #0x7
	mov     r1, r0
	ldr     r3, [pc, #0x4] @ 0x2265a14, (=Function_2004fa8+1)
	add     r1, #0xf9
	bx      r3
@ 0x2265a12

.align 2
.word Function_2004fa8+1 @ 0x2265a14
